...
func programmGDPMatchEntry(ctx context.Context, t *testing.T, client *p4rt_client.P4RTClient, delete bool) error {
	...
	return programmGDPMatchEntryWithStreamParameter(psp, client, delete)
}

// programmGDPMatchEntryWithStreamParameter programms or deletes GDP entry
func programmGDPMatchEntryWithStreamParameter(streamParameter p4rt_client.P4RTStreamParameters, client *p4rt_client.P4RTClient, delete bool) error {
