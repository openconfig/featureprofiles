...
func TestInventory(t *testing.T) {
	...
	p1StreamsStr = append(p1StreamsStr, samplestream.New(t, dut1, component1.SerialNo().State(), samplingInterval))
	p1StreamsStr = append(p1StreamsStr, samplestream.New(t, dut1, component1.PartNo().State(), samplingInterval))
	p1StreamsStr = append(p1StreamsStr, samplestream.New(t, dut1, component1.Description().State(), samplingInterval))
	p1StreamsStr = append(p1StreamsStr, samplestream.New(t, dut1, component1.MfgName().State(), samplingInterval))
	p1StreamsStr = append(p1StreamsStr, samplestream.New(t, dut1, component1.MfgDate().State(), samplingInterval))
	p1StreamsStr = append(p1StreamsStr, samplestream.New(t, dut1, component1.HardwareVersion().State(), samplingInterval))
