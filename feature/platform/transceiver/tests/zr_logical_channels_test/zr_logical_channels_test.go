...
func Test400ZRLogicalChannels(t *testing.T) {
	...
	cfgplugins.ConfigOpticalChannel(t, dut, oc1, frequency, targetOutputPower, operationalMode, cfgplugins.WithLinePort(t, dut, oc1))
	...
	cfgplugins.ConfigOpticalChannel(t, dut, oc2, frequency, targetOutputPower, operationalMode, cfgplugins.WithLinePort(t, dut, oc2))
