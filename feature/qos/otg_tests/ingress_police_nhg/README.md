...
* Configures traffic policing according to burst sizes and drop actions specified.
...
* Send traffic
  * Send traffic from ATE port 1 to DUT for dest_A and is conforming to service policy.
  * Send traffic from ATE port 1 to DUT for to dest_B and is conforming to
    service policy.
  * Validate packets are received by ATE port 2.
    * Validate qos interface scheduler counters
