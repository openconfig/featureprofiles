...
func validateIPv4NeighborPath(t *testing.T, dut *ondatra.DUTDevice, flag_bit int) {
	...
	t.Log("GetAll interfaces/interface/subinterfaces/subinterface/ipv4/neighbors/neighbor")
	...
	t.Log("Get interfaces/interface/subinterfaces/subinterface/ipv4/neighbors/neighbor/state")
	var portName string
	var neighbor string
	var idx uint32
	...
	t.Log("Get interfaces/interface/subinterfaces/subinterface/ipv4/neighbors/neighbor/state/ip")
	...
	t.Log("Get interfaces/interface/subinterfaces/subinterface/ipv4/neighbors/neighbor/state/link-layer-address")
	...
	t.Log("Get interfaces/interface/subinterfaces/subinterface/ipv4/neighbors/neighbor/state/origin")
...
func validateIPv4ProxyARPPath(t *testing.T, dut *ondatra.DUTDevice, mode oc.E_ProxyArp_Mode,
	...
	t.Log("Get interfaces/interface/subinterfaces/subinterface/ipv4/proxy-arp")
	for i := 0; i < TOTAL_INTF_COUNT; i++ {
		portName := dut1IntfAttrib[i].intfName
		idx := dut1IntfAttrib[i].attrib.Subinterface
...
func updateIPv4InterfaceDUT(t *testing.T, dut *ondatra.DUTDevice, reset bool, flag_bit int) {
	...
	t.Log("Update interfaces/interface/subinterfaces/subinterface/ipv4/neighbors/neighbor")
...
func updateStaticARPDUT(t *testing.T, dut *ondatra.DUTDevice, flag_bit int) {
	...
	t.Log("Update Static interfaces/interface/subinterfaces/subinterface/ipv4/neighbors/neighbor")
	...
	path := gnmi.OC().InterfaceAny().SubinterfaceAny().Ipv4().NeighborAny().State()
	_, ok := gnmi.WatchAll(t, gnmiOptsForOnChange(t, dut), path, 5*time.Second,
		func(v *ygnmi.Value[*oc.Interface_Subinterface_Ipv4_Neighbor]) bool {
			for i := 0; i < TOTAL_INTF_COUNT; i++ {
				portName := dutIntfAttrib[i].intfName
				attrib := dutIntfAttrib[i].attrib
...
func updateProxyARPDUT(t *testing.T, dut *ondatra.DUTDevice, mode oc.E_ProxyArp_Mode, flag_bit int) {
	...
	t.Log("Update interfaces/interface/subinterfaces/subinterface/ipv4/proxy-arp")
...
func deleteIPv4NeighborPath(t *testing.T, dut *ondatra.DUTDevice, flag_bit int, static ...bool) {
	...
	t.Log("Delete interfaces/interface/subinterfaces/subinterface/ipv4/neighbors/neighbor")
...
func deleteIPv4ProxyARPPath(t *testing.T, dut *ondatra.DUTDevice, mode oc.E_ProxyArp_Mode, flag_bit int) {
	...
	t.Log("Delete interfaces/interface/subinterfaces/subinterface/ipv4/proxy-arp")
...
func validateIPv6NeighborPath(t *testing.T, dut *ondatra.DUTDevice, flag_bit int) {
	...
	t.Log("GetAll interfaces/interface/subinterfaces/subinterface/ipv6/neighbors/neighbor")
	...
	t.Log("Get interfaces/interface/subinterfaces/subinterface/ipv6/neighbors/neighbor/state")
		...
		if flag_bit&delete_bit == delete_bit {
			...
			if flag_bit&static_bit == static_bit {
				...
				if op.GetOrigin().String() != "STATIC" || op.GetIsRouter() != true ||
					(op.GetNeighborState().String() != "REACHABLE" &&
						op.GetNeighborState().String() != "DELAY" &&
						op.GetNeighborState().String() != "PROBE") ||
					op.GetIp() != neighbor {
	...
	t.Log("Get interfaces/interface/subinterfaces/subinterface/ipv6/neighbors/neighbor/state/ip")
	...
	t.Log("Get interfaces/interface/subinterfaces/subinterface/ipv6/neighbors/neighbor/state/link-layer-address")
	...
	t.Log("Get interfaces/interface/subinterfaces/subinterface/ipv6/neighbors/neighbor/state/origin")
	...
	t.Log("Get interfaces/interface/subinterfaces/subinterface/ipv6/neighbors/neighbor/state/is-router")
	...
	t.Log("Get interfaces/interface/subinterfaces/subinterface/ipv6/neighbors/neighbor/state/neighbor-state")
	...
	for i := 0; i < TOTAL_INTF_COUNT; i++ {
		...
		if flag_bit&delete_bit == delete_bit {
			...
			if flag_bit&static_bit == static_bit {
				...
				path = gnmi.OC().Interface(portName).Subinterface(idx).Ipv6().Neighbor(neighbor).NeighborState().State()
				op := gnmi.Get(t, dut, path)
				if op.String() != "REACHABLE" && op.String() != "DELAY" && op.String() != "PROBE" {
...
func validateIPv6RouterAdvPath(t *testing.T, dut *ondatra.DUTDevice, flag_bit int) {
	...
	t.Log("Get interfaces/interface/subinterfaces/subinterface/ipv6/router-advertisement")
...
func validateNDPrefixPath(t *testing.T, dut *ondatra.DUTDevice, flag_bit int) {
	...
	t.Log("Get interfaces/interface/subinterfaces/subinterface/ipv6/router-advertisement/prefixes")
	...
	t.Log("Get interfaces/interface/subinterfaces/subinterface/ipv6/router-advertisement/prefixes/prefix")
...
func validateNDDadPath(t *testing.T, dut *ondatra.DUTDevice, flag_bit int) {
	...
	t.Log("Get interfaces/interface/subinterfaces/subinterface/ipv6/dad")
...
func updateIPv6InterfaceDUT(t *testing.T, dut *ondatra.DUTDevice, reset bool, flag_bit int) {
	...
	t.Log("Update interfaces/interface/subinterfaces/subinterface/ipv6/neighbors/neighbor")
	...
	_, ok := gnmi.WatchAll(t, gnmiOptsForOnChange(t, monitorDut), path, 5*time.Second,
		func(v *ygnmi.Value[*oc.Interface_Subinterface_Ipv6_Neighbor]) bool {
			...
			batchConfig.Set(t, dut)
			pingNeighbors(t, dut, monitorDut, false)
			time.Sleep(5 * time.Second)
...
func updateNDStaticDUT(t *testing.T, dut *ondatra.DUTDevice, flag_bit int) {
	...
	t.Log("Update Static interfaces/interface/subinterfaces/subinterface/ipv6/neighbors/neighbor")
...
func updateNDRouterAdvDUT(t *testing.T, dut *ondatra.DUTDevice, reset bool, flag_bit int) {
	...
	t.Log("Update interfaces/interface/subinterfaces/subinterface/ipv6/router-advertisement")
...
func updateNDPrefixDUT(t *testing.T, dut *ondatra.DUTDevice, reset bool, flag_bit int) {
	...
	t.Log("Update interfaces/interface/subinterfaces/subinterface/ipv6/router-advertisement/prefixes")
...
func updateNDDadDUT(t *testing.T, dut *ondatra.DUTDevice, reset bool, flag_bit int) {
	...
	t.Log("Update interfaces/interface/subinterfaces/subinterface/ipv6/dad")
...
func deleteIPv6NeighborPath(t *testing.T, dut *ondatra.DUTDevice, flag_bit int, static ...bool) {
	...
	t.Log("Delete interfaces/interface/subinterfaces/subinterface/ipv6/neighbors/neighbor")
...
func deleteIPv6RouterAdvPath(t *testing.T, dut *ondatra.DUTDevice, flag_bit int) {
	...
	t.Log("Delete interfaces/interface/subinterfaces/subinterface/ipv6/router-advertisement")
	batchConfig := &gnmi.SetBatch{}
...
func deleteNDPrefixPath(t *testing.T, dut *ondatra.DUTDevice, flag_bit int) {
	...
	t.Log("Delete interfaces/interface/subinterfaces/subinterface/ipv6/router-advertisement/prefixes")
	batchConfig := &gnmi.SetBatch{}
...
func deleteNDDadPath(t *testing.T, dut *ondatra.DUTDevice, flag_bit int) {
	...
	t.Log("Delete interfaces/interface/subinterfaces/subinterface/ipv6/dad")
	batchConfig := &gnmi.SetBatch{}
...
func validateIPv6ScaleNeighbors(t *testing.T) {
	...
	for ip := range IntfIPv6Addr {
		...
		if IntfIPv6Addr[ip].neighbor[DynamicNeighbor].GetNeighborState().String() != "REACHABLE" &&
			...
			IntfIPv6Addr[ip].neighbor[DynamicNeighbor].GetNeighborState().String() != "PROBE" {
