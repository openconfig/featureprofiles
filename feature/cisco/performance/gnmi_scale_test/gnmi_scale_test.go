...
func TestCollector(t *testing.T) {
	...
	err := perf.RunCollector(t, dut, "GNMI", "GNMIUpdateScale", time.Second)
	if err != nil {
		t.Fatal(err)
	}
	defer perf.StopCollector(t)
...
func TestGNMIBigSetRequest(t *testing.T) {
	...
	err := perf.RunCollector(t, dut, "GNMI", "GNMIBigSetRequest", time.Second)
	if err != nil {
		t.Fatal(err)
	}
	defer perf.StopCollector(t)
...
func TestEmsdRestart(t *testing.T) {
	...
	err := perf.RunCollector(t, dut, "General", "EmsdRestart", time.Second)
	if err != nil {
		t.Fatal(err)
	}
	defer perf.StopCollector(t)
...
func TestReloadLineCards(t *testing.T) {
	...
	err := perf.RunCollector(t, dut, "General", "ReloadLineCards", time.Second)
	if err != nil {
		t.Fatal(err)
	}
	defer perf.StopCollector(t)
...
func TestReloadRouter(t *testing.T) {
	...
	err := perf.RunCollector(t, dut, "General", "ReloadRouter", time.Second)
	if err != nil {
		t.Fatal(err)
	}
	defer perf.StopCollector(t)
