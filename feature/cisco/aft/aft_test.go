...
func testAFT(ctx context.Context, t *testing.T, args *testArgs) {
	...
	args.client.AddNHWithIPinIP(t, 5002, atePort8.IPv4, *ciscoFlags.DefaultNetworkInstance, *ciscoFlags.DefaultNetworkInstance, "Bundle-Ether1", 0, false, false, ciscoFlags.GRIBIChecks)
