	...
	t.Run("Testing /system/cpus/cpu/state/total/instant", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue > uint8(0) {
				...
				t.Errorf("Unexpected CPU Idle Instant value,got: %v want: greater than %v", cpuValue, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/total/avg", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue > uint8(0) {
				...
				t.Errorf("Unexpected CPU Idle Avg value,got: %v want: greater than %v", cpuValue, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/total/min", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue == uint8(0) {
				...
				t.Errorf("Unexpected CPU Idle Min value,got: %v want: %v", cpuValue, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/total/max", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue > uint8(0) {
				...
				t.Errorf("Unexpected CPU Idle Max value,got: %v want: greater than %v", cpuValue, uint8(0))
			}
		})
	})
}
...
func TestCPUTotalInterval(t *testing.T) {
	...
	t.Run("Testing /system/cpus/cpu/state/total/interval", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue > uint64(0) {
				t.Logf("Got correct CPU Idle Interval value")
			} else {
				t.Errorf("Unexpected CPU Idle Interval value,got: %v want: greater than %v", cpuValue, uint64(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/total/mintime", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue > uint64(0) {
				...
				t.Errorf("Unexpected CPU Idle MinTime value,got: %v want: greater than %v", cpuValue, uint64(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/total/maxtime", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue > uint64(0) {
				...
				t.Errorf("Unexpected CPU Idle Maxtime value,got: %v want: greater than %v", cpuValue, uint64(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/user/instant", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue > uint8(0) {
				...
				t.Errorf("Unexpected CPU User Instant value,got: %v want: greater than %v", cpuValue, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/user/avg", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue > uint8(0) {
				...
				t.Errorf("Unexpected CPU User Avg value,got: %v want: greater than %v", cpuValue, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/user/min", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue == uint8(0) {
				...
				t.Errorf("Unexpected CPU User Min value,got: %v want: %v", cpuValue, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/user/max", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue > uint8(0) {
				...
				t.Errorf("Unexpected CPU User Max value,got: %v want: greater than %v", cpuValue, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/user/interval", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue > uint64(0) {
				...
				t.Errorf("Unexpected CPU User Interval value,got: %v want: greater than %v", cpuValue, uint64(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/user/mintime", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue > uint64(0) {
				...
				t.Errorf("Unexpected CPU User MinTime value,got: %v want: greater than %v", cpuValue, uint64(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/user/maxtime", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue > uint64(0) {
				...
				t.Errorf("Unexpected CPU User Maxtime value,got: %v want: greater than %v", cpuValue, uint64(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/kernel/instant", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue > uint8(0) {
				...
				t.Errorf("Unexpected CPU Kernel Instant value,got: %v want: greater than %v", cpuValue, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/kernel/avg", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue > uint8(0) {
				...
				t.Errorf("Unexpected CPU Kernel Avg value,got: %v want: greater than %v", cpuValue, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/kernel/min", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue == uint8(0) {
				...
				t.Errorf("Unexpected CPU Kernel Min value,got: %v want: %v", cpuValue, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/kernel/max", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue > uint8(0) {
				...
				t.Errorf("Unexpected CPU Kernel Max value,got: %v want: greater than %v", cpuValue, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/kernel/interval", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue > uint64(0) {
				...
				t.Errorf("Unexpected CPU Kernel Interval value,got: %v want: greater than %v", cpuValue, uint64(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/kernel/mintime", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue > uint64(0) {
				...
				t.Errorf("Unexpected CPU Kernel MinTime value,got: %v want: greater than %v", cpuValue, uint64(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/kernel/maxtime", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue > uint64(0) {
				...
				t.Errorf("Unexpected CPU Kernel Maxtime value,got: %v want: greater than %v", cpuValue, uint64(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/nice/instant", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue >= uint8(0) {
				...
				t.Errorf("Unexpected CPU Nice Instant value,got: %v want: greater than %v", cpuValue, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/nice/avg", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue >= uint8(0) {
				...
				t.Errorf("Unexpected CPU Nice Avg value,got: %v want: greater than %v", cpuValue, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/nice/min", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue == uint8(0) {
				...
				t.Errorf("Unexpected CPU Nice Min value,got: %v want: %v", cpuValue, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/nice/max", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue >= uint8(0) {
				...
				t.Errorf("Unexpected CPU Nice Max value,got: %v want: greater than %v", cpuValue, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/nice/interval", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue > uint64(0) {
				...
				t.Errorf("Unexpected CPU Nice Interval value,got: %v want: greater than %v", cpuValue, uint64(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/nice/mintime", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue > uint64(0) {
				...
				t.Errorf("Unexpected CPU Nice MinTime value,got: %v want: greater than %v", cpuValue, uint64(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/nice/maxtime", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuValue > uint64(0) {
				...
				t.Errorf("Unexpected CPU Nice Maxtime value,got: %v want: greater than %v", cpuValue, uint64(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/idle/instant", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle > uint8(0) {
				...
				t.Errorf("Unexpected CPU Idle Instant value,got: %v want: greater than %v", cpuIdle, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/idle/avg", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle > uint8(0) {
				...
				t.Errorf("Unexpected CPU Idle Avg value,got: %v want: greater than %v", cpuIdle, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/idle/min", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle == uint8(0) {
				...
				t.Errorf("Unexpected CPU Idle Min value,got: %v want: %v", cpuIdle, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/idle/max", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle > uint8(0) {
				...
				t.Errorf("Unexpected CPU Idle Max value,got: %v want: greater than %v", cpuIdle, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/idle/interval", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle > uint64(0) {
				...
				t.Errorf("Unexpected CPU Idle Interval value,got: %v want: greater than %v", cpuIdle, uint64(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/idle/mintime", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle > uint64(0) {
				...
				t.Errorf("Unexpected CPU Idle MinTime value,got: %v want: greater than %v", cpuIdle, uint64(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/idle/maxtime", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle > uint64(0) {
				...
				t.Errorf("Unexpected CPU Idle Maxtime value,got: %v want: greater than %v", cpuIdle, uint64(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/wait/instant", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle >= uint8(0) {
				...
				t.Errorf("Unexpected CPU Wait Instant value,got: %v want: greater than %v", cpuIdle, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/wait/avg", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle >= uint8(0) {
				...
				t.Errorf("Unexpected CPU Wait Avg value,got: %v want: greater than %v", cpuIdle, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/wait/min", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle == uint8(0) {
				...
				t.Errorf("Unexpected CPU Wait Min value,got: %v want: %v", cpuIdle, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/wait/max", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle >= uint8(0) {
				...
				t.Errorf("Unexpected CPU Wait Max value,got: %v want: greater than %v", cpuIdle, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/wait/interval", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle > uint64(0) {
				...
				t.Errorf("Unexpected CPU Wait Interval value,got: %v want: greater than %v", cpuIdle, uint64(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/wait/mintime", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle > uint64(0) {
				...
				t.Errorf("Unexpected CPU Wait MinTime value,got: %v want: greater than %v", cpuIdle, uint64(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/wait/maxtime", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle > uint64(0) {
				...
				t.Errorf("Unexpected CPU Wait Maxtime value,got: %v want: greater than %v", cpuIdle, uint64(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/hardware-interrupt/instant", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle >= uint8(0) {
				...
				t.Errorf("Unexpected CPU HardwareInterrupt Instant value,got: %v want: greater than %v", cpuIdle, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/hardware-interrupt/avg", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle >= uint8(0) {
				...
				t.Errorf("Unexpected CPU HardwareInterrupt Avg value,got: %v want: greater than %v", cpuIdle, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/hardware-interrupt/min", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle == uint8(0) {
				...
				t.Errorf("Unexpected CPU HardwareInterrupt Min value,got: %v want: %v", cpuIdle, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/hardware-interrupt/max", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle >= uint8(0) {
				...
				t.Errorf("Unexpected CPU HardwareInterrupt Max value,got: %v want: greater than %v", cpuIdle, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/hardware-interrupt/interval", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle > uint64(0) {
				...
				t.Errorf("Unexpected CPU HardwareInterrupt Interval value,got: %v want: greater than %v", cpuIdle, uint64(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/hardware-interrupt/mintime", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle > uint64(0) {
				...
				t.Errorf("Unexpected CPU HardwareInterrupt MinTime value,got: %v want: greater than %v", cpuIdle, uint64(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/hardware-interrupt/maxtime", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle > uint64(0) {
				...
				t.Errorf("Unexpected CPU HardwareInterrupt Maxtime value,got: %v want: greater than %v", cpuIdle, uint64(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/software-interrupt/instant", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle >= uint8(0) {
				...
				t.Errorf("Unexpected CPU SoftwareInterrupt Instant value,got: %v want: greater than %v", cpuIdle, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/software-interrupt/avg", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle >= uint8(0) {
				...
				t.Errorf("Unexpected CPU SoftwareInterrupt Avg value,got: %v want: greater than %v", cpuIdle, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/software-interrupt/min", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle == uint8(0) {
				...
				t.Errorf("Unexpected CPU SoftwareInterrupt Min value,got: %v want: %v", cpuIdle, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/software-interrupt/max", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle >= uint8(0) {
				...
				t.Errorf("Unexpected CPU SoftwareInterrupt Max value,got: %v want: greater than %v", cpuIdle, uint8(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/software-interrupt/interval", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle > uint64(0) {
				...
				t.Errorf("Unexpected CPU SoftwareInterrupt Interval value,got: %v want: greater than %v", cpuIdle, uint64(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/software-interrupt/mintime", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle > uint64(0) {
				...
				t.Errorf("Unexpected CPU SoftwareInterrupt MinTime value,got: %v want: greater than %v", cpuIdle, uint64(0))
			}
		})
	})
}
	...
	t.Run("Testing /system/cpus/cpu/state/software-interrupt/maxtime", func(t *testing.T) {
		t.Run("Subscribe", func(t *testing.T) {
			...
			if cpuIdle > uint64(0) {
				...
				t.Errorf("Unexpected CPU SoftwareInterrupt Maxtime value,got: %v want: greater than %v", cpuIdle, uint64(0))
			}
		})
	})
}
