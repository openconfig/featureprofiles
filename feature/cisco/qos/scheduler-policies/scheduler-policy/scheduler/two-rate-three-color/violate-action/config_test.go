...
func TestSetDot1pAtContainer(t *testing.T) {
	...
	for _, input := range inputs {
		t.Run(fmt.Sprintf("Testing /qos/scheduler-policies/scheduler-policy/schedulers/scheduler/two-rate-three-color/violate-action/config/set-dot1p using value %v", input), func(t *testing.T) {
			...
			*baseConfigSchedulerPolicySchedulerTwoRateThreeColorViolateAction.SetDot1P = input
			...
			if !setup.SkipGet() {
				t.Run("Get container", func(t *testing.T) {
					...
					if *configGot.SetDot1P != input {
						t.Errorf("Config /qos/scheduler-policies/scheduler-policy/schedulers/scheduler/two-rate-three-color/violate-action/config/set-dot1p: got %v, want %v", configGot, input)
					}
				})
			}
			if !setup.SkipSubscribe() {
				t.Run("Subscribe container", func(t *testing.T) {
					...
					if *stateGot.SetDot1P != input {
						t.Errorf("State /qos/scheduler-policies/scheduler-policy/schedulers/scheduler/two-rate-three-color/violate-action/config/set-dot1p: got %v, want %v", stateGot, input)
					}
				})
			}
			t.Run("Delete container", func(t *testing.T) {
				...
				if !setup.SkipSubscribe() {
					if qs := config.Lookup(t); qs.Val(t).SetDot1P != nil {
						t.Errorf("Delete /qos/scheduler-policies/scheduler-policy/schedulers/scheduler/two-rate-three-color/violate-action/config/set-dot1p fail: got %v", qs)
					}
				}
			})
		})
...
func TestSetDot1pAtLeaf(t *testing.T) {
	...
	for _, input := range inputs {
		t.Run(fmt.Sprintf("Testing /qos/scheduler-policies/scheduler-policy/schedulers/scheduler/two-rate-three-color/violate-action/config/set-dot1p using value %v", input), func(t *testing.T) {
			...
			config := dut.Config().Qos().SchedulerPolicy(*baseConfigSchedulerPolicy.Name).Scheduler(*baseConfigSchedulerPolicyScheduler.Sequence).TwoRateThreeColor().ViolateAction().SetDot1P()
			state := dut.Telemetry().Qos().SchedulerPolicy(*baseConfigSchedulerPolicy.Name).Scheduler(*baseConfigSchedulerPolicyScheduler.Sequence).TwoRateThreeColor().ViolateAction().SetDot1P()
...
func TestSetDscpAtContainer(t *testing.T) {
	...
	for _, input := range inputs {
		t.Run(fmt.Sprintf("Testing /qos/scheduler-policies/scheduler-policy/schedulers/scheduler/two-rate-three-color/violate-action/config/set-dscp using value %v", input), func(t *testing.T) {
			...
			baseConfigSchedulerPolicySchedulerTwoRateThreeColor := baseConfigSchedulerPolicyScheduler.TwoRateThreeColor
			baseConfigSchedulerPolicySchedulerTwoRateThreeColorViolateAction := baseConfigSchedulerPolicySchedulerTwoRateThreeColor.ViolateAction
			*baseConfigSchedulerPolicySchedulerTwoRateThreeColorViolateAction.SetDscp = input
			...
			if !setup.SkipGet() {
				t.Run("Get container", func(t *testing.T) {
					...
					if *configGot.SetDscp != input {
						t.Errorf("Config /qos/scheduler-policies/scheduler-policy/schedulers/scheduler/two-rate-three-color/violate-action/config/set-dscp: got %v, want %v", configGot, input)
					}
				})
			}
			if !setup.SkipSubscribe() {
				t.Run("Subscribe container", func(t *testing.T) {
					...
					if *stateGot.SetDscp != input {
						t.Errorf("State /qos/scheduler-policies/scheduler-policy/schedulers/scheduler/two-rate-three-color/violate-action/config/set-dscp: got %v, want %v", stateGot, input)
					}
				})
			}
			t.Run("Delete container", func(t *testing.T) {
...
func TestSetDscpAtLeaf(t *testing.T) {
	...
	for _, input := range inputs {
		t.Run(fmt.Sprintf("Testing /qos/scheduler-policies/scheduler-policy/schedulers/scheduler/two-rate-three-color/violate-action/config/set-dscp using value %v", input), func(t *testing.T) {
			...
			config := dut.Config().Qos().SchedulerPolicy(*baseConfigSchedulerPolicy.Name).Scheduler(*baseConfigSchedulerPolicyScheduler.Sequence).TwoRateThreeColor().ViolateAction().SetDscp()
			state := dut.Telemetry().Qos().SchedulerPolicy(*baseConfigSchedulerPolicy.Name).Scheduler(*baseConfigSchedulerPolicyScheduler.Sequence).TwoRateThreeColor().ViolateAction().SetDscp()
