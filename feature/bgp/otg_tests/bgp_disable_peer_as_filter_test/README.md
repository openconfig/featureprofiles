...
1.  Configure eBGP sessions between ATE Port 1, DUT, and ATE Port 2.
2.  Advertise a prefix (e.g., `192.0.2.0/24`) from ATE Port 1 with an AS-PATH containing the target peer's AS (`64497`) in the middle (e.g., AS-PATH: `64496 64497 64499`).
