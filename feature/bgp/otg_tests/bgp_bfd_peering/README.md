# RT-1.110: Single-Hop BFD over Customer eBGP Interconnect

## Summary

Validate Bidirectional Forwarding Detection (BFD) integration with customer eBGP peering on Edge Routers (DUT/anPF) across 802.1Q subinterfaces. Verify sub-second failure detection, timer negotiation, dampening behavior, and immediate BGP session teardown upon BFD link state transitions.

> [!NOTE]
> Correlates with Google internal trackers [b/535482605](http://b/535482605) and [b/445378818](http://b/445378818).
> Documents test requirements for hardware BFD offload across customer interconnect attachments.
