...
import (
	...
	otgconfighelpers "github.com/openconfig/featureprofiles/internal/otg_helpers/otg_config_helpers/otgconfighelpers"
...
func TestBGPScale(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:              "RT-1.65.1.2.1 - BGP Session Scale - 15 v4/v6 IBGP sessions - 20k v4/v6 routes",
			dutSetup:          ateSetup,
			scale:             map[string]uint32{"Port2": 200, "Port3": 200, "Port4": 15, "v4ISISRoutes": 100, "v6ISISRoutes": 100, "v4IBGPRoutes": 20000, "v6IBGPRoutes": 20000, "v4Convergence": 20100, "v6Convergence": 20005},
			validate:          []func(t *testing.T, dev *ondatra.Device){verifyPortsUp},
		...
		{
			name:              "RT-1.65.1.2.2 - BGP Session Scale - 15 v4/v6 IBGP sessions - 40k v4/v6 routes",
			dutSetup:          ateSetup,
			scale:             map[string]uint32{"Port2": 200, "Port3": 200, "Port4": 15, "v4ISISRoutes": 100, "v6ISISRoutes": 100, "v4IBGPRoutes": 40000, "v6IBGPRoutes": 40000, "v4Convergence": 40100, "v6Convergence": 40005},
			validate:          []func(t *testing.T, dev *ondatra.Device){verifyPortsUp},
			verifyTelemetry:   []func(t *testing.T, dut *ondatra.DUTDevice, ate *ondatra.ATEDevice, top gosnappi.Config, nbrList []*bgpNeighbor){verifyISISTelemetry, verifyBgpTelemetry, verifyBGPCapabilities},
			verifyConvergence: measureConvergence,
			verifyTraffic:     []func(t *testing.T, ate *ondatra.ATEDevice, top gosnappi.Config){sendTraffic, verifyTraffic},
		...
		{
			name:              "RT-1.65.1.2.3 - BGP Session Scale - 15 v4/v6 IBGP sessions - 60k v4/v6 routes",
			dutSetup:          ateSetup,
			scale:             map[string]uint32{"Port2": 200, "Port3": 200, "Port4": 15, "v4ISISRoutes": 100, "v6ISISRoutes": 100, "v4IBGPRoutes": 60000, "v6IBGPRoutes": 60000, "v4Convergence": 60100, "v6Convergence": 60005},
			validate:          []func(t *testing.T, dev *ondatra.Device){verifyPortsUp},
			verifyTelemetry:   []func(t *testing.T, dut *ondatra.DUTDevice, ate *ondatra.ATEDevice, top gosnappi.Config, nbrList []*bgpNeighbor){verifyISISTelemetry, verifyBgpTelemetry, verifyBGPCapabilities},
			verifyConvergence: measureConvergence,
			verifyTraffic:     []func(t *testing.T, ate *ondatra.ATEDevice, top gosnappi.Config){sendTraffic, verifyTraffic},
		...
		{
			name:              "RT-1.65.1.2.4 - BGP Session Scale - 15 v4/v6 IBGP sessions - 80k v4/v6 routes",
			dutSetup:          ateSetup,
			scale:             map[string]uint32{"Port2": 200, "Port3": 200, "Port4": 15, "v4ISISRoutes": 100, "v6ISISRoutes": 100, "v4IBGPRoutes": 80000, "v6IBGPRoutes": 80000, "v4Convergence": 80100, "v6Convergence": 80005},
			validate:          []func(t *testing.T, dev *ondatra.Device){verifyPortsUp},
			verifyTelemetry:   []func(t *testing.T, dut *ondatra.DUTDevice, ate *ondatra.ATEDevice, top gosnappi.Config, nbrList []*bgpNeighbor){verifyISISTelemetry, verifyBgpTelemetry, verifyBGPCapabilities},
			verifyConvergence: measureConvergence,
			verifyTraffic:     []func(t *testing.T, ate *ondatra.ATEDevice, top gosnappi.Config){sendTraffic, verifyTraffic},
		...
		{
			name:              "RT-1.65.1.2.5 - BGP Session Scale - 15 v4/v6 IBGP sessions - 100k v4/v6 routes",
			dutSetup:          ateSetup,
			scale:             map[string]uint32{"Port2": 200, "Port3": 200, "Port4": 15, "v4ISISRoutes": 100, "v6ISISRoutes": 100, "v4IBGPRoutes": 100000, "v6IBGPRoutes": 100000, "v4Convergence": 100100, "v6Convergence": 100005},
			validate:          []func(t *testing.T, dev *ondatra.Device){verifyPortsUp},
			verifyTelemetry:   []func(t *testing.T, dut *ondatra.DUTDevice, ate *ondatra.ATEDevice, top gosnappi.Config, nbrList []*bgpNeighbor){verifyISISTelemetry, verifyBgpTelemetry, verifyBGPCapabilities},
			verifyConvergence: measureConvergence,
			verifyTraffic:     []func(t *testing.T, ate *ondatra.ATEDevice, top gosnappi.Config){sendTraffic, verifyTraffic},
		...
		{
			name:              "RT-1.65.1.2 - BGP Session Scale - 15 v4/v6 IBGP sessions - 120k v4/v6 routes",
			dutSetup:          ateSetup,
			scale:             map[string]uint32{"Port2": 200, "Port3": 200, "Port4": 15, "v4ISISRoutes": 100, "v6ISISRoutes": 100, "v4IBGPRoutes": 120000, "v6IBGPRoutes": 120000, "v4Convergence": 120100, "v6Convergence": 120005},
			validate:          []func(t *testing.T, dev *ondatra.Device){verifyPortsUp},
			verifyTelemetry:   []func(t *testing.T, dut *ondatra.DUTDevice, ate *ondatra.ATEDevice, top gosnappi.Config, nbrList []*bgpNeighbor){verifyISISTelemetry, verifyBgpTelemetry, verifyBGPCapabilities},
			verifyConvergence: measureConvergence,
			verifyTraffic:     []func(t *testing.T, ate *ondatra.ATEDevice, top gosnappi.Config){sendTraffic, verifyTraffic},
		},
		{
			...
			dutSetup:          ateSetup,
			scale:             map[string]uint32{"Port2": 200, "Port3": 200, "Port4": 31, "v4ISISRoutes": 100, "v6ISISRoutes": 100, "v4IBGPRoutes": 120000, "v6IBGPRoutes": 120000, "v4Convergence": 120100, "v6Convergence": 120005},
			validate:          []func(t *testing.T, dev *ondatra.Device){verifyPortsUp},
			verifyTelemetry:   []func(t *testing.T, dut *ondatra.DUTDevice, ate *ondatra.ATEDevice, top gosnappi.Config, nbrList []*bgpNeighbor){verifyISISTelemetry, verifyBgpTelemetry, verifyBGPCapabilities},
			verifyConvergence: measureConvergence,
			verifyTraffic:     []func(t *testing.T, ate *ondatra.ATEDevice, top gosnappi.Config){sendTraffic, verifyTraffic},
		},
		{
			...
			dutSetup:          ateSetup,
			scale:             map[string]uint32{"Port2": 200, "Port3": 200, "Port4": 31, "v4ISISRoutes": 200, "v6ISISRoutes": 200, "v4IBGPRoutes": 250000, "v6IBGPRoutes": 150000, "v4Convergence": 250100, "v6Convergence": 150005},
			validate:          []func(t *testing.T, dev *ondatra.Device){verifyPortsUp},
			verifyTelemetry:   []func(t *testing.T, dut *ondatra.DUTDevice, ate *ondatra.ATEDevice, top gosnappi.Config, nbrList []*bgpNeighbor){verifyISISTelemetry, verifyBgpTelemetry, verifyBGPCapabilities},
			verifyConvergence: measureConvergence,
			verifyTraffic:     []func(t *testing.T, ate *ondatra.ATEDevice, top gosnappi.Config){sendTraffic, verifyTraffic},
		...
		{
			name:              "RT-1.65.4.3 - BGP Session and Route Scale with BGP events_WithdrawRoutes",
			dutSetup:          nil,
			scale:             map[string]uint32{"Port2": 200, "Port3": 200, "Port4": 31, "v4ISISRoutes": 200, "v6ISISRoutes": 200, "v4IBGPRoutes": 250000, "v6IBGPRoutes": 150000, "v4Convergence": 250100, "v6Convergence": 150005},
			bgpEvents:         bgpEvents,
		...
		{
			name:              "RT-1.65.4.2 - BGP Session and Route Scale with BGP events_ResetBGPPeers",
			dutSetup:          nil,
			scale:             map[string]uint32{"Port2": 200, "Port3": 200, "Port4": 31, "v4ISISRoutes": 200, "v6ISISRoutes": 200, "v4IBGPRoutes": 250000, "v6IBGPRoutes": 150000, "v4Convergence": 250100, "v6Convergence": 150005},
			bgpEvents:         bgpEvents,
	...
	for index, tc := range testCases {
		if tc.dutSetup != nil {
			...
			t.Run(tc.name+" DUT Setup", func(t *testing.T) {
				...
				dutPort2.numSubIntf = 200
				dutPort3.numSubIntf = 200
	...
	for _, l := range dutData.lags {
		...
		if deviations.ExplicitInterfaceInDefaultVRF(dut) {
			for k := range agg.GetOrCreateSubinterfaceMap() {
				fptest.AssignToNetworkInstance(t, dut, l.LagName, deviations.DefaultNetworkInstance(dut), k)
			}
		}
	}
