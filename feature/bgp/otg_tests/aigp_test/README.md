...
:------|:----------
ATE    | 65535
DUT 1 Default NI        | 65534
DUT 1 test-instance NI  | 65533
DUT 2 Default NI        | 65534
DUT 2 test-instance NI  | 65533
DUT 2 test-originate NI | 65532
...
instances. The DEFAULT network instance will run BGP on ASN 65534 and 65533 will
be the ASN on the test-instance as specified on Table 5.

##### BGP Configuration - Default Network instance

*  Configure BGP with ASN 65534 as specified on Table 5
...
*  Configure peer-as on these peer-groups as specified below
      * peer-group: uplink; peer-as: 65535
      * peer-group: uplink6; peer-as: 65535
      * peer-group: downlink; peer-as: 65534
      * peer-group: downlink6; peer-as: 65534
...
*  Configure BGP with ASN 65533 as specified on Table 5
*  Create four bgp peer-groups named uplink,uplink6 and downlink and downlink6
*  Configure peer-as on these peer-groups as specified below
      * peer-group: uplink; peer-as: 65535
      * peer-group: uplink6; peer-as: 65535
      * peer-group: downlink; peer-as: 65533
      * peer-group: downlink6; peer-as: 65533
*  Configure peers in peer-group downlink and downlink6 as route-reflector clients with cluster-id 1.1.1.1
...
*  Configure peer-as on these peer-groups as specified below
      * peer-group: uplink; peer-as: 65534
      * peer-group: uplink6; peer-as: 65534
...
*  Create 2 peer-groups named uplink and uplink6
*  Configure peer-as on these peer-groups as specified below
      * peer-group: uplink; peer-as: 65533
      * peer-group: uplink6; peer-as: 65533
*  Create the following bgp peers with their respective peer-groups, these BGP
...
10. Create the following ipv4 and ipv6 BGP peers of type EBGP on the emulated Router
     * Peer address: 198.51.100.1; remote AS: 65534
     * Peer address: 198.51.100.5; remote AS: 65534
     * Peer address: 198.51.100.9; remote AS: 65533
     * Peer address: 198.51.100.13; remote AS: 65533
     * Peer address: 2001:db8::1; remote AS: 65534
     * Peer address: 2001:db8::5; remote AS: 65534
     * Peer address: 2001:db8::9; remote AS: 65533
     * Peer address: 2001:db8::13; remote AS: 65533
...
1. All BGP peers must be in Established state
2. In the default NI, routes received from the BGP peers must have a AIGP value
   of 200
3. In the default NI, IPV4 route must have a next-hop address of 198.51.100.17
   while ipv6 routes must have a next-hop address of 2001:db8::17
4. In test-instance NI, routes received from the BGP peers must have a AIGP
    value of 200
5. In test-instance NI, IPV4 route must have a next-hop address of 198.51.100.21
   while ipv6 routes must have a next-hop address of 2001:db8::21
6. Aigp propagation must be true for bgp peers 198.51.100.17 and 2001:db8::17 in
   the default NI
7. AIGP propagation must be true for the peers 198.51.100.21 and 2001:db8::17 in
   the default NI
                  ...
                  "neighbor": [
                    {
                      ...
                      "apply-policy": {
                        "config": {
                          "import-policy": "test-import-policy"
                        }
                      }
                    },
                    {
                    ...
                    },
                    {
                      ...
                      "apply-policy": {
                        "config": {
                          "export-policy": "test-export-policy"
                        }
                      }
                    },
                    {
...
*  Create a route-policy named default-ni-next-hop-export-policy-v4
    * Create a statement named test-statement
    * Create the following actions
      * set-next-hop 198.55.1.1
      * accept the route

*  Create a route-policy named default-ni-next-hop-export-policy-v6
    * Create a statement named test-statement
    * Create the following actions
      * set-next-hop 2001:db8:50::1
      * accept the route

*  Create a route-policy named non-default-ni-next-hop-export-policy-v4
    * Create a statement named test-statement
    * Create the following actions
      * set-next-hop 198.55.2.1
      * accept the route

*  Create a route-policy named non-default-ni-next-hop-export-policy-v6
    * Create a statement named test-statement
    * Create the following actions
...
* Create ISIS configuration instance named test-isis-istance
* Configure the network entity as specified on Table 6
* Configure metric-style wide
* Add subinterfaces Lag 2 vlan 10 and lag 2 vlan 30 to the isis process and circuite type of point-to-point
...
* Configure the network entity as specified on Table 6
* Configure metric-style wide
* Add subinterfaces Lag 2 vlan 20 and lag 2 vlan 40 to the isis process and circuite type of point-to-point
...
* Configure the route-policy default-ni-next-hop-export-policy-v4 in the export
  direction on 198.51.100.18
* Configure the route-policy default-ni-next-hop-export-policy-v6 in the export
...
* Configure the route-policy non-default-ni-next-hop-export-policy-v4 in the
  export direction on 198.51.100.22
* Configure the route-policy non-default-ni-next-hop-export-policy-v6 in the
...
* Configure the network entity as specified on Table 6
* Configure metric-style wide
* Add subinterfaces Lag 2 vlan 30 and lag 2 vlan 40 to the isis process and circuite type of point-to-point
...
* Create a BGP process with ASN 65532 as specified on Table 5
...
* Configure the peer-as,local-as and export-policy on these peer-groups as specified below
      * peer-group: default-peer-group; peer-as: 65534; local-as: 65534; export-policy: test-export-policy
      * peer-group: default-peer-group6; peer-as: 65534; local-as: 65534; export-policy: test-export-policy
* Create BGP peer-group called test-instance-peer-group and test-instance-peer-group6
* Configure the peer-as,local-as and export-policy on these peer-groups as specified below
      * peer-group: test-instance-peer-group; peer-as: 65533; local-as: 65533; export-policy: test-export-policy
      * peer-group: test-instance-peer-group6; peer-as: 65533; local-as: 65533; export-policy: test-export-policy
...
* Redistribute route from protocol Connected to protocol BGP
  ...
  "routing-policy": {
    "policy-definitions": {
      "policy-definition": [
        {
          "config": {
            "name": "default-ni-next-hop-export-policy-v4"
          },
          "statements": {
            "statement": [
              {
        ...
        {
          "config": {
            "name": "default-ni-next-hop-export-policy-v6"
          },
          "statements": {
            "statement": [
              {
        ...
        {
          "config": {
            "name": "non-default-ni-next-hop-export-policy-v4"
          },
          "statements": {
            "statement": [
              {
        ...
        {
          "config": {
            "name": "non-default-ni-next-hop-export-policy-v6"
          },
          "statements": {
            "statement": [
              {
                  ...
                  "neighbor": [
                    {
                      ...
                      "apply-policy": {
                        "config": {
                          "import-policy": "default-ni-next-hop-export-policy-v4"
                        }
                      }
                    },
                    {
                      ...
                      "apply-policy": {
                        "config": {
                          "import-policy": "default-ni-next-hop-export-policy-v6"
                        }
                      }
                    },
                    {
                  ...
                  "neighbor": [
                    {
                      ...
                      "apply-policy": {
                        "config": {
                          "import-policy": "non-default-ni-next-hop-export-policy-v4"
                        }
                      }
                    },
                    {
                      ...
                      "apply-policy": {
                        "config": {
                          "import-policy": "non-default-ni-next-hop-export-policy-v6"
                        }
                      }
                    },
                    {
...
* In test-instance NI:
  ...
  - Route received from peers 198.51.100.36 and 2001:db8::36 must have a AIGP metric of 200
