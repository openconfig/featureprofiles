			...
			if bgpPrefix.GetAddress() == v4Prefix {
				...
				default:
					...
					for _, ec := range bgpPrefix.ExtendedCommunity {
						...
						} else if bandwidth == "1000000" && ygot.BinaryToFloat32(lbSubType.GetBandwidth()) != 1000000 {
...
func (td *testData) advertiseRoutesWithEBGP(t *testing.T) {
	...
	nV42.PeerGroup = ygot.String(cfgplugins.BGPPeerGroup1)
	...
	nV61.PeerGroup = ygot.String(cfgplugins.BGPPeerGroup1)
