...
* DUT is configued with addpath Send capability only on its IBGP peering with ATE3:port3 and ATE4:port5
...
*  Withdraw advertisement of 500k v4 and 300k v6 prefixes from ATE2 and verify the following for the withdrawn prefixes
  ...
  * ATE3 and ATE4 now has only one route for the withdrawn prefixes.
