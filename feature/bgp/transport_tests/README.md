...
## Procedure
  ...
  - Establish BGP sessions as follows between ATE and DUT . 
    ...
    - The DUT Port2 IP has eBGP peering with ATE port 2 IP and is receiving IPv4/6 routes. Here too for EBGP, ensure that ATE is listening on different TCP port than default 179 (example: 1800).
