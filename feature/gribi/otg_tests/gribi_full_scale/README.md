...
* [Target T0 README](./gribi_full_scale_t0/README.md)
* [Target T1 README](./gribi_full_scale_t1/README.md)
* [Target T2 README](./gribi_full_scale_t2/README.md)
* [Target Down README](./gribi_full_scale_down/README.md)
...
```json
{
  "interfaces": {
    "interface": [
      ...
      {
        "config": {
          "description": "DUT port2 with N sub-interfaces",
          "name": "port2",
          "type": "ethernetCsmacd"
        },
        "name": "port2",
