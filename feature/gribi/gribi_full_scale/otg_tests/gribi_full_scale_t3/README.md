...
Validate gRIBI scaling requirements for Target T3.
...
The test is configured with the following parameters defined in `gribi_full_scale_t3_test.go`:
...
* `NumUniqueEncapNH`: `32,000`
* `NumEncapDefaultNHG`: `8,000`
* `EncapNHGLoadBalance`:
