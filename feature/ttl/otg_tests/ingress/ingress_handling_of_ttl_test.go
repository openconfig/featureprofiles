...
func TestIngressHandlingOfTTL(t *testing.T) {
	...
	testsWithTtlCheckDisabled = append(testsWithTtlCheckDisabled, tests[8], tests[9])
...
func configurePolicyRuleTTL1(t *testing.T, dut *ondatra.DUTDevice) {
				...
				EncapsulateGre: &oc.NetworkInstance_PolicyForwarding_Policy_Rule_Action_EncapsulateGre{
					Target: map[string]*oc.NetworkInstance_PolicyForwarding_Policy_Rule_Action_EncapsulateGre_Target{
						nhGroupName: {
							...
							Destination: ygot.String(GRE_IPv4_DST_NET),
						},
					},
				},
			},
	...
	cfgplugins.NewPolicyForwardingEncapGre(t, dut, trafficPolicyName, dp1.Name(), nhGroupName, ttl1PolicyRules)
}
...
func configureDUT(t *testing.T, dut *ondatra.DUTDevice) {
	...
	cfgplugins.ConfigureTcamProfile(t, dut, cfgplugins.TcamProfilePolicyForwarding)
	...
	policyRules := []cfgplugins.PolicyForwardingRule{
		{
			...
			Name:               rulev4,
			IpType:             IPv4,
			DestinationAddress: fmt.Sprintf("%s/%d", IPv4_DST_NET_SERV1, ipv4PrefixLen),
			Action: &oc.NetworkInstance_PolicyForwarding_Policy_Rule_Action{
				EncapsulateGre: &oc.NetworkInstance_PolicyForwarding_Policy_Rule_Action_EncapsulateGre{
					Target: map[string]*oc.NetworkInstance_PolicyForwarding_Policy_Rule_Action_EncapsulateGre_Target{
						nhGroupName: {
		...
		},
		{
			...
			Name:               rulev6,
			IpType:             IPv6,
			DestinationAddress: fmt.Sprintf("%s/%d", IPv6_DST_NET_SERV1, ipv6PrefixLen),
			Action: &oc.NetworkInstance_PolicyForwarding_Policy_Rule_Action{
				EncapsulateGre: &oc.NetworkInstance_PolicyForwarding_Policy_Rule_Action_EncapsulateGre{
					Target: map[string]*oc.NetworkInstance_PolicyForwarding_Policy_Rule_Action_EncapsulateGre_Target{
						nhGroupName: {
	...
	cfgplugins.NewPolicyForwardingEncapGre(t, dut, trafficPolicyName, dp1.Name(), nhGroupName, policyRules)
}
