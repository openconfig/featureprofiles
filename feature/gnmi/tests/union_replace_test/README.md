...
configuration item combinations which have overlaps between CLI and OC.  
...
For NOS with implement option 2, the configuration should
...
1. Get the CLI configuration E.1 from DUT.
...
1. For option 2 NOS, verify E.1 + E.2 == E.3 (the CLI config is updated, the OC state
