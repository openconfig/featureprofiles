...
// CreateOrDeleteTestData function to create/cleanup test data for use in TLS tests.
...
func CreateOrDeleteTestData(t *testing.T, dirPath string, timeout time.Duration, args string) error {
