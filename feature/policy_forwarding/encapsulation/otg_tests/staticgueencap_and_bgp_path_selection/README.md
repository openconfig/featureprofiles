...
| `$DUT_TE11.v4/32`                                                                                          | IPoUDP tunnel destination address on the DUT. This IP MUST receive traffic with LSB 2 bits of the DSCP field (TZ bits) marked as 11                                                                                                                                                                                                       |
| `$DUT_TE10.v4/32`                                                                                          | IPoUDP tunnel destination address on the DUT. This IP MUST receive traffic with TZ bits marked as 10                                                                                                                                                                                                                                      |
| `$ATE2_INTERNAL_TE11.v4/32`                                                                                | IPoUDP tunnel destination address on the ATE2. This IP MUST receive traffic with TZ bits marked as 11                                                                                                                                                                                                                                     |
| `$ATE2_INTERNAL_TE10.v4/32`                                                                                | IPoUDP tunnel destination address on the DUT. This IP MUST receive traffic with with TZ bits marked as 10                                                                                                                                                                                                                                 |
