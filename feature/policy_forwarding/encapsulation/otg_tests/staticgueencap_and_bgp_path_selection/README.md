...
<br>`$DUT_TE10.v6/128`<br>`$DUT_TE10.v6/128`                                                                                                                                                                                                                                                                                                   | IPoUDP tunnel destination address on the DUT. This IP MUST receive traffic meant for multiple shards on the DUT
<br>`$ATE2_INTERNAL_TE11.v6/128`<br>`$ATE2_INTERNAL_TE11.v6/128`                                                                                                                                                                                                                                                                              | IPoUDP tunnel destination address on the ATE2. This IP MUST receive traffic meant for single shard on the ATE
<br>`$ATE2_INTERNAL_TE10.v6/128`                                                                                                                                                                                                                                                                              | IPoUDP tunnel destination address on the ATE. This IP MUST receive traffic meant for mulitple shards on the ATE
