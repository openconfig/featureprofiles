...
func (a *staticATE) DialGNMI(ctx context.Context, opts ...grpc.DialOption) (gpb.GNMIClient, error) {
	conn, err := a.dialATE(ctx, introspect.GNMI, opts)
	if err != nil {
		return nil, err
	}
	return gpb.NewGNMIClient(conn), nil
...
func (a *staticATE) DialOTG(ctx context.Context, opts ...grpc.DialOption) (gosnappi.GosnappiApi, error) {
	...
	conn, err := a.dialATE(ctx, introspect.OTG, opts)
	if err != nil {
		return nil, err
	}
	api := gosnappi.NewApi()
...
func (a *staticATE) dialATE(ctx context.Context, svc introspect.Service, opts []grpc.DialOption) (*grpc.ClientConn, error) {
...
func makeDialer(name string, params *svcParams, bopts *bindpb.Options) (*introspect.Dialer, error) {
	...
	return &introspect.Dialer{
		...
		Target:   fmt.Sprintf("%s:%d", name, params.port),
		DialOpts: opts,
	}, nil
}
