...
```
go run ./exec/firex/testsuite_generator.go -files 'runlist_1.yaml,runlist_2.yaml' > firex_testsuite.yaml
```
...
```
cp exec/firex/plugins/runner.py /auto/tftpboot-ottawa/kjahed/firex/runner.py
```
