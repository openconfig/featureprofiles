...
def CollectDebugFiles(self, ws, internal_fp_repo_dir, reserved_testbed, out_dir, timestamp, 
                      core_check=False, collect_tech=False, run_cmds=False, 
                      split_files_per_dut=False, custom_tech="", custom_cmds=""):
