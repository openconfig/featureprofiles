...
type NetworkInstance_Protocol_Ospfv2_Global struct {
	...
	SummaryRouteCostMode       E_Global_SummaryRouteCostMode                                                                                                                `path:"config/summary-route-cost-mode" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/summary-route-cost-mode" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_Vlan struct {
	...
	Status E_Vlan_Status                  `path:"config/status" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/status" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
...
type Qos_Classifier struct {
	...
	Type E_Qos_Classifier_Type           `path:"config/type" module:"openconfig-qos/openconfig-qos" shadow-path:"state/type" shadow-module:"openconfig-qos/openconfig-qos"`
}
...
type Qos_Interface_Input_Classifier struct {
	...
	Type E_Input_Classifier_Type                         `path:"config/type|type" module:"openconfig-qos/openconfig-qos|openconfig-qos" shadow-path:"state/type|type" shadow-module:"openconfig-qos/openconfig-qos|openconfig-qos"`
}
