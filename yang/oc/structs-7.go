...
type NetworkInstance_Protocol_Isis_Level_RoutePreference struct {
	ExternalRoutePreference *uint8 `path:"config/external-route-preference" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/external-route-preference" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	InternalRoutePreference *uint8 `path:"config/internal-route-preference" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/internal-route-preference" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Isis_Level_TrafficEngineering struct {
	...
	Ipv4RouterId *string `path:"config/ipv4-router-id" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/ipv4-router-id" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	Ipv6RouterId *string `path:"config/ipv6-router-id" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/ipv6-router-id" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Ospfv2_Area_Interface struct {
	AuthenticationType        *string                                                             `path:"config/authentication-type" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/authentication-type" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	EnableBfd                 *NetworkInstance_Protocol_Ospfv2_Area_Interface_EnableBfd           `path:"enable-bfd" module:"openconfig-network-instance"`
	HideNetwork               *bool                                                               `path:"config/hide-network" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/hide-network" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	...
	Metric                    *uint16                                                             `path:"config/metric" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/metric" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	Mpls                      *NetworkInstance_Protocol_Ospfv2_Area_Interface_Mpls                `path:"mpls" module:"openconfig-network-instance"`
	MultiAreaAdjacencyPrimary *bool                                                               `path:"config/multi-area-adjacency-primary" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/multi-area-adjacency-primary" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	...
	NetworkType               E_OspfTypes_OSPF_NETWORK_TYPE                                       `path:"config/network-type" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/network-type" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_Protocol_Ospfv2_Area_Interface_LsaFilter struct {
	All *bool `path:"config/all" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/all" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Ospfv2_Area_Interface_Mpls struct {
	...
	TrafficEngineeringMetric *uint32                                                         `path:"config/traffic-engineering-metric" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/traffic-engineering-metric" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Ospfv2_Area_Interface_Neighbor struct {
	...
	RouterId                 *string                         `path:"config/router-id|router-id" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance" shadow-path:"state/router-id|router-id" shadow-module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
...
type NetworkInstance_Protocol_Ospfv2_Area_Interface_Timers struct {
	DeadInterval           *uint32 `path:"config/dead-interval" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/dead-interval" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	...
	RetransmissionInterval *uint32 `path:"config/retransmission-interval" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/retransmission-interval" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
