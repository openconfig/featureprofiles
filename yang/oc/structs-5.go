...
type NetworkInstance_Protocol_Igmp_Interface_StaticGroups struct {
	...
	StaticGroup *string `path:"config/static-group|static-group" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance" shadow-path:"state/static-group|static-group" shadow-module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Isis_Global struct {
	...
	AuthenticationCheck           *bool                                                                                    `path:"config/authentication-check" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/authentication-check" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	FastFlooding                  *bool                                                                                    `path:"config/fast-flooding" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/fast-flooding" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	...
	HelloPadding                  E_IsisTypes_HelloPaddingType                                                             `path:"config/hello-padding" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/hello-padding" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	IidTlv                        *bool                                                                                    `path:"config/iid-tlv" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/iid-tlv" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	Instance                      *string                                                                                  `path:"config/instance" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/instance" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	...
	LevelCapability               E_IsisTypes_LevelType                                                                    `path:"config/level-capability" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/level-capability" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	LspBit                        *NetworkInstance_Protocol_Isis_Global_LspBit                                             `path:"lsp-bit" module:"openconfig-network-instance"`
	MaxEcmpPaths                  *uint8                                                                                   `path:"config/max-ecmp-paths" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/max-ecmp-paths" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	MaximumAreaAddresses          *uint8                                                                                   `path:"config/maximum-area-addresses" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/maximum-area-addresses" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	Mpls                          *NetworkInstance_Protocol_Isis_Global_Mpls                                               `path:"mpls" module:"openconfig-network-instance"`
	Net                           []string                                                                                 `path:"config/net" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/net" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	Nsr                           *NetworkInstance_Protocol_Isis_Global_Nsr                                                `path:"nsr" module:"openconfig-network-instance"`
	PoiTlv                        *bool                                                                                    `path:"config/poi-tlv" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/poi-tlv" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_Protocol_Isis_Global_Af struct {
	AfiName       E_IsisTypes_AFI_TYPE                                   `path:"config/afi-name|afi-name" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance" shadow-path:"state/afi-name|afi-name" shadow-module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
	Enabled       *bool                                                  `path:"config/enabled" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/enabled" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	...
	SafiName      E_IsisTypes_SAFI_TYPE                                  `path:"config/safi-name|safi-name" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance" shadow-path:"state/safi-name|safi-name" shadow-module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Isis_Global_Af_MultiTopology struct {
	AfiName  E_IsisTypes_AFI_TYPE  `path:"config/afi-name" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/afi-name" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	Enabled  *bool                 `path:"state/enabled" module:"openconfig-network-instance/openconfig-network-instance"`
	SafiName E_IsisTypes_SAFI_TYPE `path:"config/safi-name" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/safi-name" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Isis_Global_Afi struct {
	AfiName E_IsisTypes_AFI_TYPE              `path:"config/afi-name|afi-name" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance" shadow-path:"state/afi-name|afi-name" shadow-module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
	NhType  []E_MplsTypes_PATH_SETUP_PROTOCOL `path:"config/nh-type" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/nh-type" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Isis_Global_LspBit_AttachedBit struct {
	IgnoreBit   *bool `path:"config/ignore-bit" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/ignore-bit" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	SuppressBit *bool `path:"config/suppress-bit" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/suppress-bit" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Isis_Global_LspBit_OverloadBit struct {
	AdvertiseHighMetric *bool                                                                                                             `path:"config/advertise-high-metric" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/advertise-high-metric" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	...
	SetBit              *bool                                                                                                             `path:"config/set-bit" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/set-bit" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	SetBitOnBoot        *bool                                                                                                             `path:"config/set-bit-on-boot" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/set-bit-on-boot" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Isis_Global_LspBit_OverloadBit_ResetTrigger struct {
	Delay        *uint16                                 `path:"config/delay" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/delay" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	ResetTrigger E_IsisTypes_OVERLOAD_RESET_TRIGGER_TYPE `path:"config/reset-trigger|reset-trigger" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance" shadow-path:"state/reset-trigger|reset-trigger" shadow-module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Isis_Global_Mpls_IgpLdpSync struct {
	Enabled            *bool   `path:"config/enabled" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/enabled" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	PostSessionUpDelay *uint16 `path:"config/post-session-up-delay" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/post-session-up-delay" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Isis_Global_ReferenceBandwidth struct {
	ReferenceBandwidth *uint32 `path:"config/reference-bandwidth" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/reference-bandwidth" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Isis_Global_SegmentRouting struct {
	Enabled *bool   `path:"config/enabled" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/enabled" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	Srgb    *string `path:"config/srgb" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/srgb" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	Srlb    *string `path:"config/srlb" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/srlb" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Isis_Global_Timers struct {
	...
	LspLifetimeInterval *uint16                                                    `path:"config/lsp-lifetime-interval" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/lsp-lifetime-interval" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	LspRefreshInterval  *uint16                                                    `path:"config/lsp-refresh-interval" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/lsp-refresh-interval" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_Protocol_Isis_Global_Timers_LspGeneration struct {
	...
	LspFirstWaitInterval  *uint64                       `path:"config/lsp-first-wait-interval" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/lsp-first-wait-interval" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	LspMaxWaitInterval    *uint64                       `path:"config/lsp-max-wait-interval" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/lsp-max-wait-interval" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	LspSecondWaitInterval *uint64                       `path:"config/lsp-second-wait-interval" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/lsp-second-wait-interval" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Isis_Global_Timers_Spf struct {
	AdaptiveTimer     E_IsisTypes_AdaptiveTimerType `path:"state/adaptive-timer" module:"openconfig-network-instance/openconfig-network-instance"`
	SpfFirstInterval  *uint64                       `path:"config/spf-first-interval" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/spf-first-interval" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	SpfHoldInterval   *uint64                       `path:"config/spf-hold-interval" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/spf-hold-interval" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	SpfSecondInterval *uint64                       `path:"config/spf-second-interval" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/spf-second-interval" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Isis_Global_Transport struct {
	LspMtuSize *uint16 `path:"config/lsp-mtu-size" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/lsp-mtu-size" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Isis_Interface struct {
	...
	CircuitType     E_IsisTypes_CircuitType                                                                        `path:"config/circuit-type" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/circuit-type" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	...
	Passive         *bool                                                                                          `path:"config/passive" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/passive" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_Protocol_Isis_Interface_Authentication struct {
	AuthMode     E_IsisTypes_AUTH_MODE     `path:"config/auth-mode" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/auth-mode" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	AuthPassword *string                   `path:"config/auth-password" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/auth-password" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	AuthType     E_KeychainTypes_AUTH_TYPE `path:"config/auth-type" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/auth-type" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	Enabled      *bool                     `path:"config/enabled" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/enabled" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_Protocol_Isis_Interface_Bfd struct {
	BfdTlv *bool `path:"config/bfd-tlv" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/bfd-tlv" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Isis_Interface_Level struct {
	...
	LevelNumber         *uint8                                                                                                     `path:"config/level-number|level-number" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance" shadow-path:"state/level-number|level-number" shadow-module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
	...
	Passive             *bool                                                                                                      `path:"config/passive" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/passive" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	Priority            *uint8                                                                                                     `path:"config/priority" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/priority" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_Protocol_Isis_Interface_Level_Af_SegmentRouting_AdjacencySid struct {
	...
	Group                 *bool                                                                                                    `path:"config/group" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/group" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	Neighbor              *string                                                                                                  `path:"config/neighbor|neighbor" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance" shadow-path:"state/neighbor|neighbor" shadow-module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
	ProtectionEligible    *bool                                                                                                    `path:"config/protection-eligible" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/protection-eligible" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	SidId                 NetworkInstance_Protocol_Isis_Interface_Level_Af_SegmentRouting_AdjacencySid_SidId_Union                 `path:"config/sid-id|sid-id" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance" shadow-path:"state/sid-id|sid-id" shadow-module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Isis_Interface_Level_Af_SegmentRouting_PrefixSid struct {
	LabelOptions E_PrefixSid_LabelOptions                                                              `path:"config/label-options" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/label-options" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	...
	SidId        NetworkInstance_Protocol_Isis_Interface_Level_Af_SegmentRouting_PrefixSid_SidId_Union `path:"config/sid-id" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/sid-id" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Isis_Interface_Level_Timers struct {
	HelloInterval   *uint32 `path:"config/hello-interval" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/hello-interval" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	HelloMultiplier *uint8  `path:"config/hello-multiplier" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/hello-multiplier" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Isis_Interface_Timers struct {
	CsnpInterval      *uint16 `path:"config/csnp-interval" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/csnp-interval" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	LspPacingInterval *uint64 `path:"config/lsp-pacing-interval" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/lsp-pacing-interval" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Isis_Level struct {
	...
	MetricStyle         E_IsisTypes_MetricStyle                                  `path:"config/metric-style" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/metric-style" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_Protocol_Isis_Level_Authentication struct {
	...
	AuthPassword *string                   `path:"config/auth-password" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/auth-password" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	AuthType     E_KeychainTypes_AUTH_TYPE `path:"config/auth-type" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/auth-type" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	DisableCsnp  *bool                     `path:"config/disable-csnp" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/disable-csnp" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	DisableLsp   *bool                     `path:"config/disable-lsp" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/disable-lsp" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	DisablePsnp  *bool                     `path:"config/disable-psnp" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/disable-psnp" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	Enabled      *bool                     `path:"config/enabled" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/enabled" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	Keychain     *string                   `path:"config/keychain" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/keychain" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
