...
type NetworkInstance_Protocol_Isis_Interface_Authentication struct {
	HelloAuthentication *bool                                                            `path:"config/hello-authentication" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/hello-authentication" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_Protocol_Isis_Level_Authentication struct {
	CsnpAuthentication *bool                                                        `path:"config/csnp-authentication" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/csnp-authentication" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	...
	LspAuthentication  *bool                                                        `path:"config/lsp-authentication" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/lsp-authentication" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	PsnpAuthentication *bool                                                        `path:"config/psnp-authentication" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/psnp-authentication" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
