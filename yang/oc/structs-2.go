...
This package was generated by /usr/local/google/home/wenbli/gocode/pkg/mod/github.com/openconfig/ygot@v0.16.2/genutil/names.go
...
type NetworkInstance_PolicyForwarding_Policy_Rule_Action struct {
	...
	DecapsulateGue       *bool                                                               `path:"config/decapsulate-gue" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/decapsulate-gue" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	DecapsulateMplsInUdp *bool                                                               `path:"config/decapsulate-mpls-in-udp" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/decapsulate-mpls-in-udp" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
