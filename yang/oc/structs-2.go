...
type NetworkInstance_Mpls_Lsps_ConstrainedPath_Tunnel_P2PTunnelAttributes_P2PSecondaryPath struct {
	...
	CspfTiebreaker            E_Mpls_CspfTieBreaking                                                                                                                            `path:"config/cspf-tiebreaker" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/cspf-tiebreaker" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	ExplicitPathName          *string                                                                                                                                           `path:"config/explicit-path-name" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/explicit-path-name" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	...
	PathComputationMethod     E_MplsTypes_PATH_COMPUTATION_METHOD                                                                                                               `path:"config/path-computation-method" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/path-computation-method" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	PathComputationServer     *string                                                                                                                                           `path:"config/path-computation-server" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/path-computation-server" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	...
	RetryTimer                *uint16                                                                                                                                           `path:"config/retry-timer" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/retry-timer" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	...
	UseCspf                   *bool                                                                                                                                             `path:"config/use-cspf" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/use-cspf" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_Lsps_ConstrainedPath_Tunnel_P2PTunnelAttributes_P2PSecondaryPath_AdminGroups struct {
	ExcludeGroup    []string `path:"config/exclude-group" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/exclude-group" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	IncludeAllGroup []string `path:"config/include-all-group" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/include-all-group" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	IncludeAnyGroup []string `path:"config/include-any-group" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/include-any-group" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_Lsps_ConstrainedPath_Tunnel_P2PTunnelAttributes_P2PSecondaryPath_PathMetricBoundConstraint struct {
	MetricUpperBound *uint64                      `path:"config/metric-upper-bound" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/metric-upper-bound" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	Type             E_MplsTypes_PATH_METRIC_TYPE `path:"config/type|type" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance" shadow-path:"state/type|type" shadow-module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_Lsps_StaticLsp_Egress struct {
	IncomingLabel NetworkInstance_Mpls_Lsps_StaticLsp_Egress_IncomingLabel_Union `path:"config/incoming-label" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/incoming-label" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	NextHop       *string                                                        `path:"config/next-hop" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/next-hop" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	PushLabel     NetworkInstance_Mpls_Lsps_StaticLsp_Egress_PushLabel_Union     `path:"config/push-label" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/push-label" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_Lsps_StaticLsp_Ingress struct {
	IncomingLabel NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_IncomingLabel_Union `path:"config/incoming-label" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/incoming-label" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	NextHop       *string                                                         `path:"config/next-hop" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/next-hop" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	PushLabel     NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_PushLabel_Union     `path:"config/push-label" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/push-label" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_Lsps_StaticLsp_Transit struct {
	IncomingLabel NetworkInstance_Mpls_Lsps_StaticLsp_Transit_IncomingLabel_Union `path:"config/incoming-label" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/incoming-label" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	NextHop       *string                                                         `path:"config/next-hop" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/next-hop" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	PushLabel     NetworkInstance_Mpls_Lsps_StaticLsp_Transit_PushLabel_Union     `path:"config/push-label" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/push-label" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_SignalingProtocols_Ldp_Global struct {
	...
	LsrId           *string                                                             `path:"config/lsr-id" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/lsr-id" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_SignalingProtocols_Ldp_Global_GracefulRestart struct {
	...
	ForwardingHoldtime *uint16 `path:"config/forwarding-holdtime" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/forwarding-holdtime" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	HelperEnable       *bool   `path:"config/helper-enable" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/helper-enable" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	ReconnectTime      *uint16 `path:"config/reconnect-time" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/reconnect-time" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	RecoveryTime       *uint16 `path:"config/recovery-time" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/recovery-time" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_SignalingProtocols_Ldp_InterfaceAttributes struct {
	HelloHoldtime *uint16                                                                               `path:"config/hello-holdtime" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/hello-holdtime" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	HelloInterval *uint16                                                                               `path:"config/hello-interval" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/hello-interval" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_Mpls_SignalingProtocols_Ldp_InterfaceAttributes_Interface_AddressFamily struct {
	AfiName E_MplsLdp_MplsLdpAfi `path:"config/afi-name|afi-name" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance" shadow-path:"state/afi-name|afi-name" shadow-module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
	Enabled *bool                `path:"config/enabled" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/enabled" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_SignalingProtocols_Ldp_Neighbor struct {
	...
	LabelSpaceId   *uint16                                                                                                                                          `path:"config/label-space-id|label-space-id" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance" shadow-path:"state/label-space-id|label-space-id" shadow-module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
	LsrId          *string                                                                                                                                          `path:"config/lsr-id|lsr-id" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance" shadow-path:"state/lsr-id|lsr-id" shadow-module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
...
type NetworkInstance_Mpls_SignalingProtocols_Ldp_Targeted struct {
	...
	HelloAccept   *bool                                                                                        `path:"config/hello-accept" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/hello-accept" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	HelloHoldtime *uint16                                                                                      `path:"config/hello-holdtime" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/hello-holdtime" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	HelloInterval *uint16                                                                                      `path:"config/hello-interval" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/hello-interval" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_SignalingProtocols_Ldp_Targeted_AddressFamily_Target struct {
	...
	RemoteAddress *string `path:"config/remote-address|remote-address" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance" shadow-path:"state/remote-address|remote-address" shadow-module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Global_GracefulRestart struct {
	Enable       *bool   `path:"config/enable" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/enable" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	RecoveryTime *uint32 `path:"config/recovery-time" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/recovery-time" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	RestartTime  *uint32 `path:"config/restart-time" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/restart-time" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Global_Hellos struct {
	HelloInterval    *uint16 `path:"config/hello-interval" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/hello-interval" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	RefreshReduction *bool   `path:"config/refresh-reduction" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/refresh-reduction" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Global_SoftPreemption struct {
	Enable                *bool   `path:"config/enable" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/enable" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	SoftPreemptionTimeout *uint16 `path:"config/soft-preemption-timeout" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/soft-preemption-timeout" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Interface_Protection struct {
	BypassOptimizeInterval       *uint16                     `path:"config/bypass-optimize-interval" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/bypass-optimize-interval" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	LinkProtectionStyleRequested E_MplsTypes_PROTECTION_TYPE `path:"config/link-protection-style-requested" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/link-protection-style-requested" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Interface_Subscription struct {
	...
	Subscription                     *uint8  `path:"config/subscription" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/subscription" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_TeGlobalAttributes_AdminGroup struct {
	AdminGroupName *string `path:"config/admin-group-name|admin-group-name" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance" shadow-path:"state/admin-group-name|admin-group-name" shadow-module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
	BitPosition    *uint32 `path:"config/bit-position" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/bit-position" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_TeGlobalAttributes_Srlg struct {
	Cost         *uint32                                                              `path:"config/cost" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/cost" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	FloodingType E_Mpls_MplsSrlgFloodingType                                          `path:"config/flooding-type" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/flooding-type" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	...
	Name         *string                                                              `path:"config/name|name" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance" shadow-path:"state/name|name" shadow-module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
	Value        *uint32                                                              `path:"config/value" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/value" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_TeGlobalAttributes_Srlg_MembersList struct {
	FromAddress *string `path:"config/from-address|from-address" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance" shadow-path:"state/from-address|from-address" shadow-module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
	ToAddress   *string `path:"config/to-address" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/to-address" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_TeGlobalAttributes_TeLspTimers struct {
	CleanupDelay    *uint16 `path:"config/cleanup-delay" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/cleanup-delay" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	InstallDelay    *uint16 `path:"config/install-delay" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/install-delay" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_PolicyForwarding_Interface struct {
	ApplyForwardingPolicy   *string                                                  `path:"config/apply-forwarding-policy" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/apply-forwarding-policy" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	ApplyVrfSelectionPolicy *string                                                  `path:"config/apply-vrf-selection-policy" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/apply-vrf-selection-policy" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	InterfaceId             *string                                                  `path:"config/interface-id|interface-id" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance" shadow-path:"state/interface-id|interface-id" shadow-module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
...
type NetworkInstance_PolicyForwarding_PathSelectionGroup struct {
	GroupId *string  `path:"config/group-id|group-id" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance" shadow-path:"state/group-id|group-id" shadow-module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
	MplsLsp []string `path:"config/mpls-lsp" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/mpls-lsp" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_PolicyForwarding_Policy struct {
	PolicyId *string                                                  `path:"config/policy-id|policy-id" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance" shadow-path:"state/policy-id|policy-id" shadow-module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
	...
	Type     E_Policy_Type                                            `path:"config/type" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/type" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_PolicyForwarding_Policy_Rule struct {
	...
	SequenceId    *uint32                                                 `path:"config/sequence-id|sequence-id" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance" shadow-path:"state/sequence-id|sequence-id" shadow-module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
...
type NetworkInstance_PolicyForwarding_Policy_Rule_Action struct {
	DecapsulateGre     *bool                                                               `path:"config/decapsulate-gre" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/decapsulate-gre" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	Discard            *bool                                                               `path:"config/discard" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/discard" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	...
	NetworkInstance    *string                                                             `path:"config/network-instance" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/network-instance" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	NextHop            *string                                                             `path:"config/next-hop" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/next-hop" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	PathSelectionGroup *string                                                             `path:"config/path-selection-group" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/path-selection-group" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_PolicyForwarding_Policy_Rule_Action_EncapsulateGre struct {
	IdentifyingPrefix *string                                                                               `path:"config/identifying-prefix" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/identifying-prefix" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_PolicyForwarding_Policy_Rule_Action_EncapsulateGre_Target struct {
	Destination *string `path:"config/destination" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/destination" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	...
	IpTtl       *uint8  `path:"config/ip-ttl" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/ip-ttl" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_PolicyForwarding_Policy_Rule_Ipv4 struct {
	DestinationAddress *string                                                          `path:"config/destination-address" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/destination-address" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	Dscp               *uint8                                                           `path:"config/dscp" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/dscp" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	DscpSet            []uint8                                                          `path:"config/dscp-set" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/dscp-set" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	HopLimit           *uint8                                                           `path:"config/hop-limit" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/hop-limit" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	Protocol           NetworkInstance_PolicyForwarding_Policy_Rule_Ipv4_Protocol_Union `path:"config/protocol" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/protocol" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_PolicyForwarding_Policy_Rule_Ipv6 struct {
	DestinationAddress   *string                                                          `path:"config/destination-address" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/destination-address" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	DestinationFlowLabel *uint32                                                          `path:"config/destination-flow-label" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/destination-flow-label" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	Dscp                 *uint8                                                           `path:"config/dscp" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/dscp" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	DscpSet              []uint8                                                          `path:"config/dscp-set" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/dscp-set" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	HopLimit             *uint8                                                           `path:"config/hop-limit" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/hop-limit" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	Protocol             NetworkInstance_PolicyForwarding_Policy_Rule_Ipv6_Protocol_Union `path:"config/protocol" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/protocol" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	SourceAddress        *string                                                          `path:"config/source-address" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/source-address" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	SourceFlowLabel      *uint32                                                          `path:"config/source-flow-label" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/source-flow-label" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_PolicyForwarding_Policy_Rule_L2 struct {
	DestinationMac     *string                                                         `path:"config/destination-mac" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/destination-mac" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	DestinationMacMask *string                                                         `path:"config/destination-mac-mask" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/destination-mac-mask" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	Ethertype          NetworkInstance_PolicyForwarding_Policy_Rule_L2_Ethertype_Union `path:"config/ethertype" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/ethertype" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	SourceMac          *string                                                         `path:"config/source-mac" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/source-mac" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	SourceMacMask      *string                                                         `path:"config/source-mac-mask" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/source-mac-mask" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_PolicyForwarding_Policy_Rule_Transport struct {
	DestinationPort NetworkInstance_PolicyForwarding_Policy_Rule_Transport_DestinationPort_Union `path:"config/destination-port" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/destination-port" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	SourcePort      NetworkInstance_PolicyForwarding_Policy_Rule_Transport_SourcePort_Union      `path:"config/source-port" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/source-port" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	TcpFlags        []E_PacketMatchTypes_TCP_FLAGS                                               `path:"config/tcp-flags" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/tcp-flags" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol struct {
	...
	DefaultMetric *uint32                                        `path:"config/default-metric" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/default-metric" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	Enabled       *bool                                          `path:"config/enabled" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/enabled" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	Identifier    E_PolicyTypes_INSTALL_PROTOCOL_TYPE            `path:"config/identifier|identifier" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance" shadow-path:"state/identifier|identifier" shadow-module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
...
type NetworkInstance_Protocol_Aggregate struct {
	...
	SetTag      NetworkInstance_Protocol_Aggregate_SetTag_Union `path:"config/set-tag" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/set-tag" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Bgp_Global struct {
	...
	As                    *uint32                                                                   `path:"config/as" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/as" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_Protocol_Bgp_Global_AfiSafi struct {
	...
	AfiSafiName           E_BgpTypes_AFI_SAFI_TYPE                                           `path:"config/afi-safi-name|afi-safi-name" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance" shadow-path:"state/afi-safi-name|afi-safi-name" shadow-module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
	Enabled               *bool                                                              `path:"config/enabled" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/enabled" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_Protocol_Bgp_Global_AfiSafi_AddPaths struct {
	EligiblePrefixPolicy *string `path:"config/eligible-prefix-policy" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/eligible-prefix-policy" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	Receive              *bool   `path:"config/receive" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/receive" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	Send                 *bool   `path:"config/send" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/send" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	SendMax              *uint8  `path:"config/send-max" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/send-max" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Bgp_Global_AfiSafi_Ipv4LabeledUnicast_PrefixLimit struct {
	MaxPrefixes         *uint32  `path:"config/max-prefixes" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/max-prefixes" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	PreventTeardown     *bool    `path:"config/prevent-teardown" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/prevent-teardown" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	RestartTimer        *float64 `path:"config/restart-timer" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/restart-timer" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	WarningThresholdPct *uint8   `path:"config/warning-threshold-pct" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/warning-threshold-pct" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Bgp_Global_AfiSafi_Ipv4Unicast struct {
	...
	SendDefaultRoute *bool                                                                `path:"config/send-default-route" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/send-default-route" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Bgp_Global_AfiSafi_RouteSelectionOptions struct {
	AdvertiseInactiveRoutes *bool `path:"config/advertise-inactive-routes" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/advertise-inactive-routes" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	AlwaysCompareMed        *bool `path:"config/always-compare-med" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/always-compare-med" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	EnableAigp              *bool `path:"config/enable-aigp" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/enable-aigp" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	ExternalCompareRouterId *bool `path:"config/external-compare-router-id" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/external-compare-router-id" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	IgnoreAsPathLength      *bool `path:"config/ignore-as-path-length" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/ignore-as-path-length" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	IgnoreNextHopIgpMetric  *bool `path:"config/ignore-next-hop-igp-metric" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/ignore-next-hop-igp-metric" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
