...
type LocalRoutes_Aggregate struct {
	Description *string                            `path:"config/description" module:"openconfig-local-routing/openconfig-local-routing" shadow-path:"state/description" shadow-module:"openconfig-local-routing/openconfig-local-routing"`
	Discard     *bool                              `path:"config/discard" module:"openconfig-local-routing/openconfig-local-routing" shadow-path:"state/discard" shadow-module:"openconfig-local-routing/openconfig-local-routing"`
	Prefix      *string                            `path:"config/prefix|prefix" module:"openconfig-local-routing/openconfig-local-routing|openconfig-local-routing" shadow-path:"state/prefix|prefix" shadow-module:"openconfig-local-routing/openconfig-local-routing|openconfig-local-routing"`
	SetTag      LocalRoutes_Aggregate_SetTag_Union `path:"config/set-tag" module:"openconfig-local-routing/openconfig-local-routing" shadow-path:"state/set-tag" shadow-module:"openconfig-local-routing/openconfig-local-routing"`
}
...
type LocalRoutes_Static struct {
	...
	Prefix      *string                                `path:"config/prefix|prefix" module:"openconfig-local-routing/openconfig-local-routing|openconfig-local-routing" shadow-path:"state/prefix|prefix" shadow-module:"openconfig-local-routing/openconfig-local-routing|openconfig-local-routing"`
	SetTag      LocalRoutes_Static_SetTag_Union        `path:"config/set-tag" module:"openconfig-local-routing/openconfig-local-routing" shadow-path:"state/set-tag" shadow-module:"openconfig-local-routing/openconfig-local-routing"`
}
...
type LocalRoutes_Static_NextHop struct {
	...
	Index        *string                                  `path:"config/index|index" module:"openconfig-local-routing/openconfig-local-routing|openconfig-local-routing" shadow-path:"state/index|index" shadow-module:"openconfig-local-routing/openconfig-local-routing|openconfig-local-routing"`
	InterfaceRef *LocalRoutes_Static_NextHop_InterfaceRef `path:"interface-ref" module:"openconfig-local-routing"`
	Metric       *uint32                                  `path:"config/metric" module:"openconfig-local-routing/openconfig-local-routing" shadow-path:"state/metric" shadow-module:"openconfig-local-routing/openconfig-local-routing"`
	NextHop      LocalRoutes_Static_NextHop_NextHop_Union `path:"config/next-hop" module:"openconfig-local-routing/openconfig-local-routing" shadow-path:"state/next-hop" shadow-module:"openconfig-local-routing/openconfig-local-routing"`
	Recurse      *bool                                    `path:"config/recurse" module:"openconfig-local-routing/openconfig-local-routing" shadow-path:"state/recurse" shadow-module:"openconfig-local-routing/openconfig-local-routing"`
}
...
type LocalRoutes_Static_NextHop_EnableBfd struct {
	Enabled *bool `path:"config/enabled" module:"openconfig-local-routing/openconfig-local-routing" shadow-path:"state/enabled" shadow-module:"openconfig-local-routing/openconfig-local-routing"`
}
...
type LocalRoutes_Static_NextHop_InterfaceRef struct {
	Interface    *string `path:"config/interface" module:"openconfig-local-routing/openconfig-local-routing" shadow-path:"state/interface" shadow-module:"openconfig-local-routing/openconfig-local-routing"`
	Subinterface *uint32 `path:"config/subinterface" module:"openconfig-local-routing/openconfig-local-routing" shadow-path:"state/subinterface" shadow-module:"openconfig-local-routing/openconfig-local-routing"`
}
...
type NetworkInstance_Evpn_EthernetSegment_DfElection struct {
	DfElectionMethod E_DfElection_DfElectionMethod `path:"config/df-election-method" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/df-election-method" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_Evpn_EvpnInstance struct {
	...
	ReplicationMode    E_EvpnInstance_ReplicationMode                             `path:"config/replication-mode" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/replication-mode" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_Interface struct {
	...
	Interface                 *string                       `path:"config/interface" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/interface" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	IrbAnycastGateway         E_Interface_IrbAnycastGateway `path:"config/irb-anycast-gateway" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/irb-anycast-gateway" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_Mpls_Interface_IgpFloodingBandwidth struct {
	...
	ThresholdSpecification E_IgpFloodingBandwidth_ThresholdSpecification `path:"config/threshold-specification" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/threshold-specification" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
	ThresholdType          E_IgpFloodingBandwidth_ThresholdType          `path:"config/threshold-type" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/threshold-type" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_Mpls_Lsps_ConstrainedPath_NamedExplicitPath struct {
	...
	SidSelectionMode      E_NamedExplicitPath_SidSelectionMode                                                       `path:"config/sid-selection-mode" module:"openconfig-network-instance/openconfig-network-instance" shadow-path:"state/sid-selection-mode" shadow-module:"openconfig-network-instance/openconfig-network-instance"`
}
