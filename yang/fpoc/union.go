...
// Union type can be one of [E_Keychain_Keychain_Tolerance_Enum, UnionUint32].
type Keychain_Tolerance_Union interface {
	// Union type can be one of [E_Keychain_Keychain_Tolerance_Enum, UnionUint32]
	Documentation_for_Keychain_Tolerance_Union()
}

// Documentation_for_Keychain_Tolerance_Union ensures that E_Keychain_Keychain_Tolerance_Enum
// implements the Keychain_Tolerance_Union interface.
func (E_Keychain_Keychain_Tolerance_Enum) Documentation_for_Keychain_Tolerance_Union() {}
...
func (t *Keychain) To_Keychain_Tolerance_Union(i interface{}) (Keychain_Tolerance_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to Keychain_Tolerance_Union, unknown union type, got: %T, want any of [E_Keychain_Keychain_Tolerance_Enum, uint32]", i, i)
}
...
// Macsec_Mka_KeyChain_MkaKey_ExpirationDateTime_Union is an interface that is implemented by valid types for the union
// for the leaf /openconfig-macsec/macsec/mka/key-chains/key-chain/mka-keys/mka-key/config/expiration-date-time within the YANG schema.
// Union type can be one of [E_Macsec_MkaKey_ExpirationDateTime_Enum, UnionString].
type Macsec_Mka_KeyChain_MkaKey_ExpirationDateTime_Union interface {
	// Union type can be one of [E_Macsec_MkaKey_ExpirationDateTime_Enum, UnionString]
	Documentation_for_Macsec_Mka_KeyChain_MkaKey_ExpirationDateTime_Union()
}

// Documentation_for_Macsec_Mka_KeyChain_MkaKey_ExpirationDateTime_Union ensures that E_Macsec_MkaKey_ExpirationDateTime_Enum
// implements the Macsec_Mka_KeyChain_MkaKey_ExpirationDateTime_Union interface.
func (E_Macsec_MkaKey_ExpirationDateTime_Enum) Documentation_for_Macsec_Mka_KeyChain_MkaKey_ExpirationDateTime_Union() {
}

// Documentation_for_Macsec_Mka_KeyChain_MkaKey_ExpirationDateTime_Union ensures that UnionString
// implements the Macsec_Mka_KeyChain_MkaKey_ExpirationDateTime_Union interface.
func (UnionString) Documentation_for_Macsec_Mka_KeyChain_MkaKey_ExpirationDateTime_Union() {}

// To_Macsec_Mka_KeyChain_MkaKey_ExpirationDateTime_Union takes an input interface{} and attempts to convert it to a struct
// which implements the Macsec_Mka_KeyChain_MkaKey_ExpirationDateTime_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *Macsec_Mka_KeyChain_MkaKey) To_Macsec_Mka_KeyChain_MkaKey_ExpirationDateTime_Union(i interface{}) (Macsec_Mka_KeyChain_MkaKey_ExpirationDateTime_Union, error) {
	if v, ok := i.(Macsec_Mka_KeyChain_MkaKey_ExpirationDateTime_Union); ok {
		return v, nil
	}
	switch v := i.(type) {
	case string:
	...
	return nil, fmt.Errorf("cannot convert %v to Macsec_Mka_KeyChain_MkaKey_ExpirationDateTime_Union, unknown union type, got: %T, want any of [E_Macsec_MkaKey_ExpirationDateTime_Enum, string]", i, i)
}

// Macsec_Mka_KeyChain_MkaKey_ValidDateTime_Union is an interface that is implemented by valid types for the union
// for the leaf /openconfig-macsec/macsec/mka/key-chains/key-chain/mka-keys/mka-key/config/valid-date-time within the YANG schema.
// Union type can be one of [E_Macsec_MkaKey_ValidDateTime_Enum, UnionString].
type Macsec_Mka_KeyChain_MkaKey_ValidDateTime_Union interface {
	// Union type can be one of [E_Macsec_MkaKey_ValidDateTime_Enum, UnionString]
	Documentation_for_Macsec_Mka_KeyChain_MkaKey_ValidDateTime_Union()
}

// Documentation_for_Macsec_Mka_KeyChain_MkaKey_ValidDateTime_Union ensures that E_Macsec_MkaKey_ValidDateTime_Enum
// implements the Macsec_Mka_KeyChain_MkaKey_ValidDateTime_Union interface.
func (E_Macsec_MkaKey_ValidDateTime_Enum) Documentation_for_Macsec_Mka_KeyChain_MkaKey_ValidDateTime_Union() {
}

// Documentation_for_Macsec_Mka_KeyChain_MkaKey_ValidDateTime_Union ensures that UnionString
// implements the Macsec_Mka_KeyChain_MkaKey_ValidDateTime_Union interface.
func (UnionString) Documentation_for_Macsec_Mka_KeyChain_MkaKey_ValidDateTime_Union() {}

// To_Macsec_Mka_KeyChain_MkaKey_ValidDateTime_Union takes an input interface{} and attempts to convert it to a struct
// which implements the Macsec_Mka_KeyChain_MkaKey_ValidDateTime_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *Macsec_Mka_KeyChain_MkaKey) To_Macsec_Mka_KeyChain_MkaKey_ValidDateTime_Union(i interface{}) (Macsec_Mka_KeyChain_MkaKey_ValidDateTime_Union, error) {
	if v, ok := i.(Macsec_Mka_KeyChain_MkaKey_ValidDateTime_Union); ok {
		return v, nil
	}
	switch v := i.(type) {
	case string:
	...
	return nil, fmt.Errorf("cannot convert %v to Macsec_Mka_KeyChain_MkaKey_ValidDateTime_Union, unknown union type, got: %T, want any of [E_Macsec_MkaKey_ValidDateTime_Enum, string]", i, i)
}
...
// Union type can be one of [E_Evpn_EndpointVni_MultidestinationTraffic_Enum, UnionString].
...
// Documentation_for_NetworkInstance_ConnectionPoint_Endpoint_Vxlan_EndpointVni_MultidestinationTraffic_Union ensures that E_Evpn_EndpointVni_MultidestinationTraffic_Enum
// implements the NetworkInstance_ConnectionPoint_Endpoint_Vxlan_EndpointVni_MultidestinationTraffic_Union interface.
func (E_Evpn_EndpointVni_MultidestinationTraffic_Enum) Documentation_for_NetworkInstance_ConnectionPoint_Endpoint_Vxlan_EndpointVni_MultidestinationTraffic_Union() {
}
...
func (t *NetworkInstance_ConnectionPoint_Endpoint_Vxlan_EndpointVni) To_NetworkInstance_ConnectionPoint_Endpoint_Vxlan_EndpointVni_MultidestinationTraffic_Union(i interface{}) (NetworkInstance_ConnectionPoint_Endpoint_Vxlan_EndpointVni_MultidestinationTraffic_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to NetworkInstance_ConnectionPoint_Endpoint_Vxlan_EndpointVni_MultidestinationTraffic_Union, unknown union type, got: %T, want any of [E_Evpn_EndpointVni_MultidestinationTraffic_Enum, string]", i, i)
}
...
// Union type can be one of [E_Evpn_EthernetSegment_Esi_Enum, UnionString].
...
// Documentation_for_NetworkInstance_Evpn_EthernetSegment_Esi_Union ensures that E_Evpn_EthernetSegment_Esi_Enum
// implements the NetworkInstance_Evpn_EthernetSegment_Esi_Union interface.
func (E_Evpn_EthernetSegment_Esi_Enum) Documentation_for_NetworkInstance_Evpn_EthernetSegment_Esi_Union() {
}
...
func (t *NetworkInstance_Evpn_EthernetSegment) To_NetworkInstance_Evpn_EthernetSegment_Esi_Union(i interface{}) (NetworkInstance_Evpn_EthernetSegment_Esi_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to NetworkInstance_Evpn_EthernetSegment_Esi_Union, unknown union type, got: %T, want any of [E_Evpn_EthernetSegment_Esi_Enum, string]", i, i)
}
...
// Union type can be one of [E_Evpn_EvpnInstance_RouteDistinguisher_Enum, UnionString].
...
// Documentation_for_NetworkInstance_Evpn_EvpnInstance_RouteDistinguisher_Union ensures that E_Evpn_EvpnInstance_RouteDistinguisher_Enum
// implements the NetworkInstance_Evpn_EvpnInstance_RouteDistinguisher_Union interface.
func (E_Evpn_EvpnInstance_RouteDistinguisher_Enum) Documentation_for_NetworkInstance_Evpn_EvpnInstance_RouteDistinguisher_Union() {
}
...
func (t *NetworkInstance_Evpn_EvpnInstance) To_NetworkInstance_Evpn_EvpnInstance_RouteDistinguisher_Union(i interface{}) (NetworkInstance_Evpn_EvpnInstance_RouteDistinguisher_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to NetworkInstance_Evpn_EvpnInstance_RouteDistinguisher_Union, unknown union type, got: %T, want any of [E_Evpn_EvpnInstance_RouteDistinguisher_Enum, string]", i, i)
}
...
// Union type can be one of [E_Evpn_ImportExportPolicy_ExportRouteTarget_Enum, UnionString].
...
// Documentation_for_NetworkInstance_Evpn_EvpnInstance_ImportExportPolicy_ExportRouteTarget_Union ensures that E_Evpn_ImportExportPolicy_ExportRouteTarget_Enum
// implements the NetworkInstance_Evpn_EvpnInstance_ImportExportPolicy_ExportRouteTarget_Union interface.
func (E_Evpn_ImportExportPolicy_ExportRouteTarget_Enum) Documentation_for_NetworkInstance_Evpn_EvpnInstance_ImportExportPolicy_ExportRouteTarget_Union() {
}
...
func (t *NetworkInstance_Evpn_EvpnInstance_ImportExportPolicy) To_NetworkInstance_Evpn_EvpnInstance_ImportExportPolicy_ExportRouteTarget_Union(i interface{}) (NetworkInstance_Evpn_EvpnInstance_ImportExportPolicy_ExportRouteTarget_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to NetworkInstance_Evpn_EvpnInstance_ImportExportPolicy_ExportRouteTarget_Union, unknown union type, got: %T, want any of [E_Evpn_ImportExportPolicy_ExportRouteTarget_Enum, string]", i, i)
}
...
// Union type can be one of [E_Evpn_ImportExportPolicy_ImportRouteTarget_Enum, UnionString].
...
// Documentation_for_NetworkInstance_Evpn_EvpnInstance_ImportExportPolicy_ImportRouteTarget_Union ensures that E_Evpn_ImportExportPolicy_ImportRouteTarget_Enum
// implements the NetworkInstance_Evpn_EvpnInstance_ImportExportPolicy_ImportRouteTarget_Union interface.
func (E_Evpn_ImportExportPolicy_ImportRouteTarget_Enum) Documentation_for_NetworkInstance_Evpn_EvpnInstance_ImportExportPolicy_ImportRouteTarget_Union() {
}
...
func (t *NetworkInstance_Evpn_EvpnInstance_ImportExportPolicy) To_NetworkInstance_Evpn_EvpnInstance_ImportExportPolicy_ImportRouteTarget_Union(i interface{}) (NetworkInstance_Evpn_EvpnInstance_ImportExportPolicy_ImportRouteTarget_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to NetworkInstance_Evpn_EvpnInstance_ImportExportPolicy_ImportRouteTarget_Union, unknown union type, got: %T, want any of [E_Evpn_ImportExportPolicy_ImportRouteTarget_Enum, string]", i, i)
}
...
// Documentation_for_NetworkInstance_InterInstancePolicies_ImportExportPolicy_ExportRouteTarget_Union ensures that E_Evpn_ImportExportPolicy_ExportRouteTarget_Enum
// implements the NetworkInstance_InterInstancePolicies_ImportExportPolicy_ExportRouteTarget_Union interface.
func (E_Evpn_ImportExportPolicy_ExportRouteTarget_Enum) Documentation_for_NetworkInstance_InterInstancePolicies_ImportExportPolicy_ExportRouteTarget_Union() {
}
...
func (t *NetworkInstance_InterInstancePolicies_ImportExportPolicy) To_NetworkInstance_InterInstancePolicies_ImportExportPolicy_ExportRouteTarget_Union(i interface{}) (NetworkInstance_InterInstancePolicies_ImportExportPolicy_ExportRouteTarget_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to NetworkInstance_InterInstancePolicies_ImportExportPolicy_ExportRouteTarget_Union, unknown union type, got: %T, want any of [E_Evpn_ImportExportPolicy_ExportRouteTarget_Enum, string]", i, i)
}
...
// Documentation_for_NetworkInstance_InterInstancePolicies_ImportExportPolicy_ImportRouteTarget_Union ensures that E_Evpn_ImportExportPolicy_ImportRouteTarget_Enum
// implements the NetworkInstance_InterInstancePolicies_ImportExportPolicy_ImportRouteTarget_Union interface.
func (E_Evpn_ImportExportPolicy_ImportRouteTarget_Enum) Documentation_for_NetworkInstance_InterInstancePolicies_ImportExportPolicy_ImportRouteTarget_Union() {
}
...
func (t *NetworkInstance_InterInstancePolicies_ImportExportPolicy) To_NetworkInstance_InterInstancePolicies_ImportExportPolicy_ImportRouteTarget_Union(i interface{}) (NetworkInstance_InterInstancePolicies_ImportExportPolicy_ImportRouteTarget_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to NetworkInstance_InterInstancePolicies_ImportExportPolicy_ImportRouteTarget_Union, unknown union type, got: %T, want any of [E_Evpn_ImportExportPolicy_ImportRouteTarget_Enum, string]", i, i)
}
...
// Union type can be one of [E_MplsRsvp_BandwidthReservation_Priority_Enum, UnionUint8].
...
// Documentation_for_NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Interface_BandwidthReservation_Priority_Union ensures that E_MplsRsvp_BandwidthReservation_Priority_Enum
// implements the NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Interface_BandwidthReservation_Priority_Union interface.
func (E_MplsRsvp_BandwidthReservation_Priority_Enum) Documentation_for_NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Interface_BandwidthReservation_Priority_Union() {
}
...
func (t *NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Interface_BandwidthReservation) To_NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Interface_BandwidthReservation_Priority_Union(i interface{}) (NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Interface_BandwidthReservation_Priority_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Interface_BandwidthReservation_Priority_Union, unknown union type, got: %T, want any of [E_MplsRsvp_BandwidthReservation_Priority_Enum, uint8]", i, i)
}
...
// Union type can be one of [E_MplsTypes_MplsLabel_Enum, E_SegmentRouting_AdjacencySid_SidId_Enum, UnionString, UnionUint32].
...
// Documentation_for_NetworkInstance_Protocol_Isis_Interface_Level_Af_SegmentRouting_AdjacencySid_SidId_Union ensures that E_SegmentRouting_AdjacencySid_SidId_Enum
// implements the NetworkInstance_Protocol_Isis_Interface_Level_Af_SegmentRouting_AdjacencySid_SidId_Union interface.
func (E_SegmentRouting_AdjacencySid_SidId_Enum) Documentation_for_NetworkInstance_Protocol_Isis_Interface_Level_Af_SegmentRouting_AdjacencySid_SidId_Union() {
}
...
func (t *NetworkInstance_Protocol_Isis_Interface_Level_Af_SegmentRouting_AdjacencySid) To_NetworkInstance_Protocol_Isis_Interface_Level_Af_SegmentRouting_AdjacencySid_SidId_Union(i interface{}) (NetworkInstance_Protocol_Isis_Interface_Level_Af_SegmentRouting_AdjacencySid_SidId_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to NetworkInstance_Protocol_Isis_Interface_Level_Af_SegmentRouting_AdjacencySid_SidId_Union, unknown union type, got: %T, want any of [E_MplsTypes_MplsLabel_Enum, E_SegmentRouting_AdjacencySid_SidId_Enum, string, uint32]", i, i)
}
...
// Union type can be one of [E_OspfTypes_RI_LSA_TLV_TYPES, E_Ospfv2_RouterInformation_Tlv_Type_Enum].
...
// Documentation_for_NetworkInstance_Protocol_Ospfv2_Area_Lsdb_LsaType_Lsa_OpaqueLsa_RouterInformation_Tlv_Type_Union ensures that E_Ospfv2_RouterInformation_Tlv_Type_Enum
// implements the NetworkInstance_Protocol_Ospfv2_Area_Lsdb_LsaType_Lsa_OpaqueLsa_RouterInformation_Tlv_Type_Union interface.
func (E_Ospfv2_RouterInformation_Tlv_Type_Enum) Documentation_for_NetworkInstance_Protocol_Ospfv2_Area_Lsdb_LsaType_Lsa_OpaqueLsa_RouterInformation_Tlv_Type_Union() {
}
...
func (t *NetworkInstance_Protocol_Ospfv2_Area_Lsdb_LsaType_Lsa_OpaqueLsa_RouterInformation_Tlv) To_NetworkInstance_Protocol_Ospfv2_Area_Lsdb_LsaType_Lsa_OpaqueLsa_RouterInformation_Tlv_Type_Union(i interface{}) (NetworkInstance_Protocol_Ospfv2_Area_Lsdb_LsaType_Lsa_OpaqueLsa_RouterInformation_Tlv_Type_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to NetworkInstance_Protocol_Ospfv2_Area_Lsdb_LsaType_Lsa_OpaqueLsa_RouterInformation_Tlv_Type_Union, unknown union type, got: %T, want any of [E_OspfTypes_RI_LSA_TLV_TYPES, E_Ospfv2_RouterInformation_Tlv_Type_Enum]", i, i)
}
...
// Union type can be one of [E_OspfTypes_OSPF_RI_SR_SID_LABEL_TLV_TYPES, E_Ospfv2_SegmentRoutingSidLabelRange_Tlv_Type_Enum].
...
// Documentation_for_NetworkInstance_Protocol_Ospfv2_Area_Lsdb_LsaType_Lsa_OpaqueLsa_RouterInformation_Tlv_SegmentRoutingSidLabelRange_Tlv_Type_Union ensures that E_Ospfv2_SegmentRoutingSidLabelRange_Tlv_Type_Enum
// implements the NetworkInstance_Protocol_Ospfv2_Area_Lsdb_LsaType_Lsa_OpaqueLsa_RouterInformation_Tlv_SegmentRoutingSidLabelRange_Tlv_Type_Union interface.
func (E_Ospfv2_SegmentRoutingSidLabelRange_Tlv_Type_Enum) Documentation_for_NetworkInstance_Protocol_Ospfv2_Area_Lsdb_LsaType_Lsa_OpaqueLsa_RouterInformation_Tlv_SegmentRoutingSidLabelRange_Tlv_Type_Union() {
}
...
// Union type can be one of [E_OspfTypes_OSPF_TE_LINK_TLV_TYPE, E_Ospfv2_Link_SubTlv_Type_Enum].
...
// Documentation_for_NetworkInstance_Protocol_Ospfv2_Area_Lsdb_LsaType_Lsa_OpaqueLsa_TrafficEngineering_Tlv_Link_SubTlv_Type_Union ensures that E_Ospfv2_Link_SubTlv_Type_Enum
// implements the NetworkInstance_Protocol_Ospfv2_Area_Lsdb_LsaType_Lsa_OpaqueLsa_TrafficEngineering_Tlv_Link_SubTlv_Type_Union interface.
func (E_Ospfv2_Link_SubTlv_Type_Enum) Documentation_for_NetworkInstance_Protocol_Ospfv2_Area_Lsdb_LsaType_Lsa_OpaqueLsa_TrafficEngineering_Tlv_Link_SubTlv_Type_Union() {
}
...
func (t *NetworkInstance_Protocol_Ospfv2_Area_Lsdb_LsaType_Lsa_OpaqueLsa_TrafficEngineering_Tlv_Link_SubTlv) To_NetworkInstance_Protocol_Ospfv2_Area_Lsdb_LsaType_Lsa_OpaqueLsa_TrafficEngineering_Tlv_Link_SubTlv_Type_Union(i interface{}) (NetworkInstance_Protocol_Ospfv2_Area_Lsdb_LsaType_Lsa_OpaqueLsa_TrafficEngineering_Tlv_Link_SubTlv_Type_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to NetworkInstance_Protocol_Ospfv2_Area_Lsdb_LsaType_Lsa_OpaqueLsa_TrafficEngineering_Tlv_Link_SubTlv_Type_Union, unknown union type, got: %T, want any of [E_OspfTypes_OSPF_TE_LINK_TLV_TYPE, E_Ospfv2_Link_SubTlv_Type_Enum]", i, i)
}
...
// Union type can be one of [E_OspfTypes_TE_NODE_ATTRIBUTE_TLV_TYPE, E_Ospfv2_NodeAttribute_SubTlv_Type_Enum].
...
// Documentation_for_NetworkInstance_Protocol_Ospfv2_Area_Lsdb_LsaType_Lsa_OpaqueLsa_TrafficEngineering_Tlv_NodeAttribute_SubTlv_Type_Union ensures that E_Ospfv2_NodeAttribute_SubTlv_Type_Enum
// implements the NetworkInstance_Protocol_Ospfv2_Area_Lsdb_LsaType_Lsa_OpaqueLsa_TrafficEngineering_Tlv_NodeAttribute_SubTlv_Type_Union interface.
func (E_Ospfv2_NodeAttribute_SubTlv_Type_Enum) Documentation_for_NetworkInstance_Protocol_Ospfv2_Area_Lsdb_LsaType_Lsa_OpaqueLsa_TrafficEngineering_Tlv_NodeAttribute_SubTlv_Type_Union() {
}
...
func (t *NetworkInstance_Protocol_Ospfv2_Area_Lsdb_LsaType_Lsa_OpaqueLsa_TrafficEngineering_Tlv_NodeAttribute_SubTlv) To_NetworkInstance_Protocol_Ospfv2_Area_Lsdb_LsaType_Lsa_OpaqueLsa_TrafficEngineering_Tlv_NodeAttribute_SubTlv_Type_Union(i interface{}) (NetworkInstance_Protocol_Ospfv2_Area_Lsdb_LsaType_Lsa_OpaqueLsa_TrafficEngineering_Tlv_NodeAttribute_SubTlv_Type_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to NetworkInstance_Protocol_Ospfv2_Area_Lsdb_LsaType_Lsa_OpaqueLsa_TrafficEngineering_Tlv_NodeAttribute_SubTlv_Type_Union, unknown union type, got: %T, want any of [E_OspfTypes_TE_NODE_ATTRIBUTE_TLV_TYPE, E_Ospfv2_NodeAttribute_SubTlv_Type_Enum]", i, i)
}
...
// Union type can be one of [E_System_Cpu_Index_Enum, UnionUint32].
type System_Cpu_Index_Union interface {
	// Union type can be one of [E_System_Cpu_Index_Enum, UnionUint32]
	Documentation_for_System_Cpu_Index_Union()
}

// Documentation_for_System_Cpu_Index_Union ensures that E_System_Cpu_Index_Enum
// implements the System_Cpu_Index_Union interface.
func (E_System_Cpu_Index_Enum) Documentation_for_System_Cpu_Index_Union() {}
...
func (t *System_Cpu) To_System_Cpu_Index_Union(i interface{}) (System_Cpu_Index_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to System_Cpu_Index_Union, unknown union type, got: %T, want any of [E_System_Cpu_Index_Enum, uint32]", i, i)
}
...
// Union type can be one of [E_SystemGrpc_GrpcServer_ListenAddresses_Enum, UnionString].
type System_GrpcServer_ListenAddresses_Union interface {
	// Union type can be one of [E_SystemGrpc_GrpcServer_ListenAddresses_Enum, UnionString]
	Documentation_for_System_GrpcServer_ListenAddresses_Union()
}

// Documentation_for_System_GrpcServer_ListenAddresses_Union ensures that E_SystemGrpc_GrpcServer_ListenAddresses_Enum
// implements the System_GrpcServer_ListenAddresses_Union interface.
func (E_SystemGrpc_GrpcServer_ListenAddresses_Enum) Documentation_for_System_GrpcServer_ListenAddresses_Union() {
}
...
func (t *System_GrpcServer) To_System_GrpcServer_ListenAddresses_Union(i interface{}) (System_GrpcServer_ListenAddresses_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to System_GrpcServer_ListenAddresses_Union, unknown union type, got: %T, want any of [E_SystemGrpc_GrpcServer_ListenAddresses_Enum, string]", i, i)
}
