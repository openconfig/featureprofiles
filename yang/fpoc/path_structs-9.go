...
// HelperAddress (leaf): List of IPv6 addresses of DHCP servers to which the
...
// SamplingPath represents the /openconfig-sampling-sflow/sampling YANG schema element.
type SamplingPath struct {
	*ygot.NodePath
}

// SamplingPathAny represents the wildcard version of the /openconfig-sampling-sflow/sampling YANG schema element.
...
// Sampling_SflowPath represents the /openconfig-sampling-sflow/sampling/sflow YANG schema element.
type Sampling_SflowPath struct {
	*ygot.NodePath
}

// Sampling_SflowPathAny represents the wildcard version of the /openconfig-sampling-sflow/sampling/sflow YANG schema element.
type Sampling_SflowPathAny struct {
	*ygot.NodePath
}

// Sampling_Sflow_EnabledPath represents the /openconfig-sampling-sflow/sampling/sflow/config/enabled YANG schema element.
type Sampling_Sflow_EnabledPath struct {
	*ygot.NodePath
}

// Sampling_Sflow_EnabledPathAny represents the wildcard version of the /openconfig-sampling-sflow/sampling/sflow/config/enabled YANG schema element.
type Sampling_Sflow_EnabledPathAny struct {
	*ygot.NodePath
}

// Sampling_Sflow_SampleSizePath represents the /openconfig-sampling-sflow/sampling/sflow/config/sample-size YANG schema element.
type Sampling_Sflow_SampleSizePath struct {
	*ygot.NodePath
}

// Sampling_Sflow_SampleSizePathAny represents the wildcard version of the /openconfig-sampling-sflow/sampling/sflow/config/sample-size YANG schema element.
type Sampling_Sflow_SampleSizePathAny struct {
	*ygot.NodePath
}

// Sampling_Sflow_SamplingRatePath represents the /openconfig-sampling-sflow/sampling/sflow/config/sampling-rate YANG schema element.
type Sampling_Sflow_SamplingRatePath struct {
	*ygot.NodePath
}

// Sampling_Sflow_SamplingRatePathAny represents the wildcard version of the /openconfig-sampling-sflow/sampling/sflow/config/sampling-rate YANG schema element.
type Sampling_Sflow_SamplingRatePathAny struct {
	*ygot.NodePath
}

// Sampling_Sflow_SourceAddressPath represents the /openconfig-sampling-sflow/sampling/sflow/config/source-address YANG schema element.
type Sampling_Sflow_SourceAddressPath struct {
	*ygot.NodePath
}

// Sampling_Sflow_SourceAddressPathAny represents the wildcard version of the /openconfig-sampling-sflow/sampling/sflow/config/source-address YANG schema element.
type Sampling_Sflow_SourceAddressPathAny struct {
	*ygot.NodePath
}
...
// SamplingRate (leaf): Sets the global packet sampling rate.  The rate is
...
// Defining module: "openconfig-sampling-sflow"
// Instantiating module: "openconfig-sampling-sflow"
// Path from parent: "config/sampling-rate"
// Path from root: "/sampling/sflow/config/sampling-rate"
func (n *Sampling_SflowPath) SamplingRate() *Sampling_Sflow_SamplingRatePath {
	return &Sampling_Sflow_SamplingRatePath{
		NodePath: ygot.NewNodePath(
			[]string{"config", "sampling-rate"},
			map[string]interface{}{},
			n,
		),
	}
...
// Path from parent: "config/sampling-rate"
// Path from root: "/sampling/sflow/config/sampling-rate"
func (n *Sampling_SflowPathAny) SamplingRate() *Sampling_Sflow_SamplingRatePathAny {
	return &Sampling_Sflow_SamplingRatePathAny{
		NodePath: ygot.NewNodePath(
			[]string{"config", "sampling-rate"},
			map[string]interface{}{},
			n,
...
// SourceAddress (leaf): Sets the source IP address for sFlow datagrams sent to
// sFlow collectors.
// ----------------------------------------
// Defining module: "openconfig-sampling-sflow"
// Instantiating module: "openconfig-sampling-sflow"
// Path from parent: "config/source-address"
// Path from root: "/sampling/sflow/config/source-address"
func (n *Sampling_SflowPath) SourceAddress() *Sampling_Sflow_SourceAddressPath {
	return &Sampling_Sflow_SourceAddressPath{
		NodePath: ygot.NewNodePath(
...
// Path from parent: "config/source-address"
// Path from root: "/sampling/sflow/config/source-address"
func (n *Sampling_SflowPathAny) SourceAddress() *Sampling_Sflow_SourceAddressPathAny {
	return &Sampling_Sflow_SourceAddressPathAny{
		NodePath: ygot.NewNodePath(
			[]string{"config", "source-address"},
			map[string]interface{}{},
			n,
...
// Sampling_Sflow_CollectorPath represents the /openconfig-sampling-sflow/sampling/sflow/collectors/collector YANG schema element.
type Sampling_Sflow_CollectorPath struct {
	*ygot.NodePath
}

// Sampling_Sflow_CollectorPathAny represents the wildcard version of the /openconfig-sampling-sflow/sampling/sflow/collectors/collector YANG schema element.
type Sampling_Sflow_CollectorPathAny struct {
	*ygot.NodePath
}

// Sampling_Sflow_Collector_AddressPath represents the /openconfig-sampling-sflow/sampling/sflow/collectors/collector/config/address YANG schema element.
type Sampling_Sflow_Collector_AddressPath struct {
	*ygot.NodePath
}

// Sampling_Sflow_Collector_AddressPathAny represents the wildcard version of the /openconfig-sampling-sflow/sampling/sflow/collectors/collector/config/address YANG schema element.
type Sampling_Sflow_Collector_AddressPathAny struct {
	*ygot.NodePath
}

// Sampling_Sflow_Collector_NetworkInstancePath represents the /openconfig-sampling-sflow/sampling/sflow/collectors/collector/config/network-instance YANG schema element.
type Sampling_Sflow_Collector_NetworkInstancePath struct {
	*ygot.NodePath
}

// Sampling_Sflow_Collector_NetworkInstancePathAny represents the wildcard version of the /openconfig-sampling-sflow/sampling/sflow/collectors/collector/config/network-instance YANG schema element.
type Sampling_Sflow_Collector_NetworkInstancePathAny struct {
	*ygot.NodePath
}

// Sampling_Sflow_Collector_PacketsSentPath represents the /openconfig-sampling-sflow/sampling/sflow/collectors/collector/state/packets-sent YANG schema element.
type Sampling_Sflow_Collector_PacketsSentPath struct {
	*ygot.NodePath
}

// Sampling_Sflow_Collector_PacketsSentPathAny represents the wildcard version of the /openconfig-sampling-sflow/sampling/sflow/collectors/collector/state/packets-sent YANG schema element.
type Sampling_Sflow_Collector_PacketsSentPathAny struct {
	*ygot.NodePath
}

// Sampling_Sflow_Collector_PortPath represents the /openconfig-sampling-sflow/sampling/sflow/collectors/collector/config/port YANG schema element.
type Sampling_Sflow_Collector_PortPath struct {
	*ygot.NodePath
}

// Sampling_Sflow_Collector_PortPathAny represents the wildcard version of the /openconfig-sampling-sflow/sampling/sflow/collectors/collector/config/port YANG schema element.
type Sampling_Sflow_Collector_PortPathAny struct {
	*ygot.NodePath
}

// Address (leaf): IP address of the sFlow collector.
// ----------------------------------------
// Defining module: "openconfig-sampling-sflow"
// Instantiating module: "openconfig-sampling-sflow"
// Path from parent: "config/address"
...
// Sampling_Sflow_InterfacePath represents the /openconfig-sampling-sflow/sampling/sflow/interfaces/interface YANG schema element.
type Sampling_Sflow_InterfacePath struct {
	*ygot.NodePath
}

// Sampling_Sflow_InterfacePathAny represents the wildcard version of the /openconfig-sampling-sflow/sampling/sflow/interfaces/interface YANG schema element.
type Sampling_Sflow_InterfacePathAny struct {
	*ygot.NodePath
}

// Sampling_Sflow_Interface_EnabledPath represents the /openconfig-sampling-sflow/sampling/sflow/interfaces/interface/config/enabled YANG schema element.
type Sampling_Sflow_Interface_EnabledPath struct {
	*ygot.NodePath
}

// Sampling_Sflow_Interface_EnabledPathAny represents the wildcard version of the /openconfig-sampling-sflow/sampling/sflow/interfaces/interface/config/enabled YANG schema element.
type Sampling_Sflow_Interface_EnabledPathAny struct {
	*ygot.NodePath
}

// Sampling_Sflow_Interface_NamePath represents the /openconfig-sampling-sflow/sampling/sflow/interfaces/interface/config/name YANG schema element.
type Sampling_Sflow_Interface_NamePath struct {
	*ygot.NodePath
}

// Sampling_Sflow_Interface_NamePathAny represents the wildcard version of the /openconfig-sampling-sflow/sampling/sflow/interfaces/interface/config/name YANG schema element.
type Sampling_Sflow_Interface_NamePathAny struct {
	*ygot.NodePath
}

// Sampling_Sflow_Interface_PacketsSampledPath represents the /openconfig-sampling-sflow/sampling/sflow/interfaces/interface/state/packets-sampled YANG schema element.
type Sampling_Sflow_Interface_PacketsSampledPath struct {
	*ygot.NodePath
}

// Sampling_Sflow_Interface_PacketsSampledPathAny represents the wildcard version of the /openconfig-sampling-sflow/sampling/sflow/interfaces/interface/state/packets-sampled YANG schema element.
type Sampling_Sflow_Interface_PacketsSampledPathAny struct {
	*ygot.NodePath
}

// Sampling_Sflow_Interface_SamplingRatePath represents the /openconfig-sampling-sflow/sampling/sflow/interfaces/interface/config/sampling-rate YANG schema element.
type Sampling_Sflow_Interface_SamplingRatePath struct {
	*ygot.NodePath
}

// Sampling_Sflow_Interface_SamplingRatePathAny represents the wildcard version of the /openconfig-sampling-sflow/sampling/sflow/interfaces/interface/config/sampling-rate YANG schema element.
type Sampling_Sflow_Interface_SamplingRatePathAny struct {
	*ygot.NodePath
}
...
// SamplingRate (leaf): If sFlow is enabled on the interface, this leaf may be
...
// Instantiating module: "openconfig-sampling-sflow"
// Path from parent: "config/sampling-rate"
// Path from root: "/sampling/sflow/interfaces/interface/config/sampling-rate"
func (n *Sampling_Sflow_InterfacePath) SamplingRate() *Sampling_Sflow_Interface_SamplingRatePath {
	return &Sampling_Sflow_Interface_SamplingRatePath{
		NodePath: ygot.NewNodePath(
			[]string{"config", "sampling-rate"},
			map[string]interface{}{},
			n,
...
// Path from parent: "config/sampling-rate"
// Path from root: "/sampling/sflow/interfaces/interface/config/sampling-rate"
func (n *Sampling_Sflow_InterfacePathAny) SamplingRate() *Sampling_Sflow_Interface_SamplingRatePathAny {
	return &Sampling_Sflow_Interface_SamplingRatePathAny{
		NodePath: ygot.NewNodePath(
			[]string{"config", "sampling-rate"},
			map[string]interface{}{},
			n,
...
// EnabledProtocol (leaf): List of the spanning tree protocols enabled on the
// device
// ----------------------------------------
// Defining module: "openconfig-spanning-tree"
// Instantiating module: "openconfig-spanning-tree"
...
// Vlan (leaf): list of vlans mapped to the MST instance
// ----------------------------------------
// Defining module: "openconfig-spanning-tree"
// Instantiating module: "openconfig-spanning-tree"
...
// Index (wildcarded): [E_System_Cpu_Index_Enum, UnionUint32]
...
// Path from parent: "cpus/cpu"
// Path from root: "/system/cpus/cpu"
// Index: [E_System_Cpu_Index_Enum, UnionUint32]
