...
This package was generated by /usr/local/google/home/wenbli/gocode/pkg/mod/github.com/openconfig/ygot@v0.20.2/genutil/names.go
...
const (
	...
	Interfaces_Interface_OperStatus_LOWER_LAYER_DOWN E_Interfaces_Interface_OperStatus = 7
)
...
// E_NetworkInstance_Producer_MobilityState is a derived int64 type which is used to represent
// the enumerated node NetworkInstance_Producer_MobilityState. An additional value named
// NetworkInstance_Producer_MobilityState_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_NetworkInstance_Producer_MobilityState int64

// IsYANGGoEnum ensures that NetworkInstance_Producer_MobilityState implements the yang.GoEnum
// interface. This ensures that NetworkInstance_Producer_MobilityState can be identified as a
// mapped type for a YANG enumeration.
func (E_NetworkInstance_Producer_MobilityState) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  NetworkInstance_Producer_MobilityState.
func (E_NetworkInstance_Producer_MobilityState) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_NetworkInstance_Producer_MobilityState.
func (e E_NetworkInstance_Producer_MobilityState) String() string {
	return ygot.EnumLogString(e, int64(e), "E_NetworkInstance_Producer_MobilityState")
}

const (
	// NetworkInstance_Producer_MobilityState_UNSET corresponds to the value UNSET of NetworkInstance_Producer_MobilityState
	NetworkInstance_Producer_MobilityState_UNSET E_NetworkInstance_Producer_MobilityState = 0
	// NetworkInstance_Producer_MobilityState_FROZEN corresponds to the value FROZEN of NetworkInstance_Producer_MobilityState
	NetworkInstance_Producer_MobilityState_FROZEN E_NetworkInstance_Producer_MobilityState = 1
	// NetworkInstance_Producer_MobilityState_DUPLICATE corresponds to the value DUPLICATE of NetworkInstance_Producer_MobilityState
	NetworkInstance_Producer_MobilityState_DUPLICATE E_NetworkInstance_Producer_MobilityState = 2
)

// E_NetworkInstance_Producer_Producer is a derived int64 type which is used to represent
// the enumerated node NetworkInstance_Producer_Producer. An additional value named
// NetworkInstance_Producer_Producer_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_NetworkInstance_Producer_Producer int64

// IsYANGGoEnum ensures that NetworkInstance_Producer_Producer implements the yang.GoEnum
// interface. This ensures that NetworkInstance_Producer_Producer can be identified as a
// mapped type for a YANG enumeration.
func (E_NetworkInstance_Producer_Producer) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  NetworkInstance_Producer_Producer.
func (E_NetworkInstance_Producer_Producer) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_NetworkInstance_Producer_Producer.
func (e E_NetworkInstance_Producer_Producer) String() string {
	return ygot.EnumLogString(e, int64(e), "E_NetworkInstance_Producer_Producer")
}

const (
	// NetworkInstance_Producer_Producer_UNSET corresponds to the value UNSET of NetworkInstance_Producer_Producer
	NetworkInstance_Producer_Producer_UNSET E_NetworkInstance_Producer_Producer = 0
	// NetworkInstance_Producer_Producer_LOCAL corresponds to the value LOCAL of NetworkInstance_Producer_Producer
	NetworkInstance_Producer_Producer_LOCAL E_NetworkInstance_Producer_Producer = 1
	// NetworkInstance_Producer_Producer_STATIC corresponds to the value STATIC of NetworkInstance_Producer_Producer
	NetworkInstance_Producer_Producer_STATIC E_NetworkInstance_Producer_Producer = 2
	// NetworkInstance_Producer_Producer_BGP corresponds to the value BGP of NetworkInstance_Producer_Producer
	NetworkInstance_Producer_Producer_BGP E_NetworkInstance_Producer_Producer = 3
)
...
const (
	...
	Ospfv2_ExtendedPrefix_RouteType_INTER_AREA E_Ospfv2_ExtendedPrefix_RouteType = 3
	// Ospfv2_ExtendedPrefix_RouteType_AS_EXTERNAL corresponds to the value AS_EXTERNAL of Ospfv2_ExtendedPrefix_RouteType
	Ospfv2_ExtendedPrefix_RouteType_AS_EXTERNAL E_Ospfv2_ExtendedPrefix_RouteType = 4
	// Ospfv2_ExtendedPrefix_RouteType_NSSA_EXTERNAL corresponds to the value NSSA_EXTERNAL of Ospfv2_ExtendedPrefix_RouteType
	Ospfv2_ExtendedPrefix_RouteType_NSSA_EXTERNAL E_Ospfv2_ExtendedPrefix_RouteType = 5
)
