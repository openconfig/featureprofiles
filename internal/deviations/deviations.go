...
var (
	NTPAssociationType = flag.Bool("deviation_ntp_association_type", false,
		"Device requires association-type to be explicitly set.  OpenConfig defaults the association-type to SERVER if not set.")
