...
// Load balance policy not supported 
func LoadBalancePolicyNotSupported(dut *ondatra.DUTDevice) bool {
	return lookupDUTDeviations(dut).GetLoadBalancePolicyNotSupported()
}