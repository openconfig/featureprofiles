...
var (
	...
	hierarchicalWeightResolutionTolerance = flag.Float64("deviation_hierarchical_weight_resolution_tolerance", 0.35, "Set it to expected ucmp traffic tolerance, default is 0.35")
)
