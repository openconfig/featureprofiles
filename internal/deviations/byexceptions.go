...
// GNOISwitchControlProcessorSystemInitiated returns true for devices that report
// last-switchover-reason as SYSTEM_INITIATED for gNOI.SwitchControlProcessor.
func GNOISwitchControlProcessorSystemInitiated(*ondatra.DUTDevice) bool {
	return *gnoiSwitchControlProcessorSystemInitiated
}
...
var (
	...
	gnoiSwitchControlProcessorSystemInitiated = flag.Bool("deviation_gnoi_switch_control_processor_system_initiated", false, "Set to true for devices that report last-switchover-reason as SYSTEM_INITIATED for gNOI.SwitchControlProcessor.")
)
