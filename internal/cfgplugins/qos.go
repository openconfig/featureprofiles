...
func ConfigureQosClassifierDscpRemark(t *testing.T, dut *ondatra.DUTDevice, classifierName string, interfaceName string, ipv4DscpValues []uint8, ipv6DscpValues []uint8) {
	if deviations.QosRemarkOCUnsupported(dut) {
		...
		configureQosClassifierDscpRemarkFromOc(t, dut, classifierName, interfaceName, ipv4DscpValues, ipv6DscpValues)
	}
}

func configureQosClassifierDscpRemarkFromOc(t *testing.T, dut *ondatra.DUTDevice, classifierName string, interfaceName string, ipv4DscpValues []uint8, ipv6DscpValues []uint8) {
	qos := &oc.Qos{}
