...
func NewConfigureGRETunnel(t *testing.T, dut *ondatra.DUTDevice, decapIp string, policyName string, portName string) {
	d := &oc.Root{}
...
func DeviationGREDecapsulation(t *testing.T, dut *ondatra.DUTDevice, decapIp string, decapGrpName string) {
