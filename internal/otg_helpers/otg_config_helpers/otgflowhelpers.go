...
func (f *Flow) AddIPv4Header() {
	...
	// IPv4 Source
	switch {
	case f.IPv4Flow.IPv4SrcCount != 0:
	...
	// IPv4 Destination
	switch {
	case f.IPv4Flow.IPv4DstCount != 0:
