...
var (
	...
	OpticChannelOperationalMode = flag.Int("arg_optic_channel_operational_mode", 1, "Vendor-specific operational mode identifier for the terminal-optical-channel")
)
