...
type AFTFilterBGPPrefixParams struct {
	V4Prefix        string
	V6Prefix        string
	NetworkInstance *oc.NetworkInstance
}

// AFTFilterApplyBGPMaxPrefixes applies the Arista max-prefixes deviation to the DEFAULT-instance eBGP neighbors.
func AFTFilterApplyBGPMaxPrefixes(t *testing.T, dut *ondatra.DUTDevice, cfg AFTFilterBGPPrefixParams) {
	t.Helper()
