...
type Metadata_Deviations struct {
	...
	// Juniper: b/308990185
	SkipPlqInterfaceOperStatusCheck bool `protobuf:"varint,119,opt,name=skip_plq_interface_oper_status_check,json=skipPlqInterfaceOperStatusCheck,proto3" json:"skip_plq_interface_oper_status_check,omitempty"`
}
