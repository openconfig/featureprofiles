...
type Metadata_Deviations struct {
	...
	GnpsiOcUnsupported bool `protobuf:"varint,340,opt,name=gnpsi_oc_unsupported,json=gnpsiOcUnsupported,proto3" json:"gnpsi_oc_unsupported,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"Ѻ\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1aڰ\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"!isis_adjacency_stream_unsupported\x18\xd3\x02 \x01(\bR\x1eisisAdjacencyStreamUnsupported\x121\n" +
	"\x14gnpsi_oc_unsupported\x18\xd4\x02 \x01(\bR\x12gnpsiOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
