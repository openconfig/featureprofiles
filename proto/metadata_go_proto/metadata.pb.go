...
type Metadata_Deviations struct {
	...
	SkipSubInterfaceIndex bool `protobuf:"varint,123,opt,name=skip_sub_interface_index,json=skipSubInterfaceIndex,proto3" json:"skip_sub_interface_index,omitempty"`
	// Devices has issue with nexthop index
	// Juniper: b/304729237
	SkipStaticNexthopCheck bool `protobuf:"varint,124,opt,name=skip_static_nexthop_check,json=skipStaticNexthopCheck,proto3" json:"skip_static_nexthop_check,omitempty"`
}
