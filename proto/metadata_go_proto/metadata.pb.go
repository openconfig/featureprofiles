...
type Metadata_Deviations struct {
	...
	// Juniper b/450154047
	WecmpSetWeightUnsupported bool `protobuf:"varint,335,opt,name=wecmp_set_weight_unsupported,json=wecmpSetWeightUnsupported,proto3" json:"wecmp_set_weight_unsupported,omitempty"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"ڷ\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xe3\xad\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x15syslog_oc_unsupported\x18\xce\x02 \x01(\bR\x13syslogOcUnsupported\x12@\n" +
	"\x1cwecmp_set_weight_unsupported\x18\xcf\x02 \x01(\bR\x19wecmpSetWeightUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
