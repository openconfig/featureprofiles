...
type Metadata_Deviations struct {
	...
	// Devices that do not load balance policy
	LoadBalancePolicyNotSupported bool `protobuf:"varint,316,opt,name=load_balance_policy_not_supported,json=loadBalancePolicyNotSupported,proto3" json:"load_balance_policy_not_supported,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
func (x *Metadata_Deviations) GetLoadBalancePolicyNotSupported() bool {
	if x != nil {
		return x.LoadBalancePolicyNotSupported
	}
	return false
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\x9e\xad\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xf2\xa3\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"2policy_forwarding_gre_encapsulation_oc_unsupported\x18\xbb\x02 \x01(\bR-policyForwardingGreEncapsulationOcUnsupported\x12I\n" +
	"!load_balance_policy_not_supported\x18\xbc\x02 \x01(\bR\x1dloadBalancePolicyNotSupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
