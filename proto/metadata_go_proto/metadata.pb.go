...
type Metadata_Deviations struct {
	...
	MplsExpIngressClassifierUnsupported bool `protobuf:"varint,275,opt,name=mpls_exp_ingress_classifier_unsupported,json=mplsExpIngressClassifierUnsupported,proto3" json:"mpls_exp_ingress_classifier_unsupported,omitempty"`
	unknownFields                       protoimpl.UnknownFields
	sizeCache                           protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\x95\x97\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xe9\x8d\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"(interface_output_queue_non_standard_name\x18\x92\x02 \x01(\bR#interfaceOutputQueueNonStandardName\x12U\n" +
	"'mpls_exp_ingress_classifier_unsupported\x18\x93\x02 \x01(\bR#mplsExpIngressClassifierUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
