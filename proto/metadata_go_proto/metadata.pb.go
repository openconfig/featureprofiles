...
type Metadata_Deviations struct {
	...
	FabricFt      string `protobuf:"bytes,410,opt,name=fabric_ft,json=fabricFt,proto3" json:"fabric_ft,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xeb\xe4\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xb7\xda\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	",default_subinterface_packet_counters_missing\x18\x99\x03 \x01(\bR(defaultSubinterfacePacketCountersMissing\x12\x1c\n" +
	"\tfabric_ft\x18\x9a\x03 \x01(\tR\bfabricFtJ\x04\bT\x10UJ\x04\b\t\x10\n" +
