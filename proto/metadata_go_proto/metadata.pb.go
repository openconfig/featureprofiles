...
type Metadata_Deviations struct {
	...
	OcAaaUserRoleLeafStringTypeUnsupported bool `protobuf:"varint,392,opt,name=oc_aaa_user_role_leaf_string_type_unsupported,json=ocAaaUserRoleLeafStringTypeUnsupported,proto3" json:"oc_aaa_user_role_leaf_string_type_unsupported,omitempty"`
	// Devices that do not support AcctZ shell CMD records accounting.
	AcctzShellCmdAccountingUnsupported bool `protobuf:"varint,393,opt,name=acctz_shell_cmd_accounting_unsupported,json=acctzShellCmdAccountingUnsupported,proto3" json:"acctz_shell_cmd_accounting_unsupported,omitempty"`
	// Devices that do not support AuthZ status field with deny in CMD service in AcctZ records.
	AcctzRecordsAuthzStatusDenyUnsupported bool `protobuf:"varint,394,opt,name=acctz_records_authz_status_deny_unsupported,json=acctzRecordsAuthzStatusDenyUnsupported,proto3" json:"acctz_records_authz_status_deny_unsupported,omitempty"`
	unknownFields                          protoimpl.UnknownFields
	sizeCache                              protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xc9\xdc\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x95\xd2\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"-oc_aaa_user_role_leaf_string_type_unsupported\x18\x88\x03 \x01(\bR&ocAaaUserRoleLeafStringTypeUnsupported\x12S\n" +
	"&acctz_shell_cmd_accounting_unsupported\x18\x89\x03 \x01(\bR\"acctzShellCmdAccountingUnsupported\x12\\\n" +
	"+acctz_records_authz_status_deny_unsupported\x18\x8a\x03 \x01(\bR&acctzRecordsAuthzStatusDenyUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
