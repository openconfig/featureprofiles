...
type Metadata_Deviations struct {
	...
	ExcludeDisabledComponents bool `protobuf:"varint,433,opt,name=exclude_disabled_components,json=excludeDisabledComponents,proto3" json:"exclude_disabled_components,omitempty"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
func (x *Metadata_Deviations) GetExcludeDisabledComponents() bool {
	if x != nil {
		return x.ExcludeDisabledComponents
	}
	return false
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xd6\xf2\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xa2\xe8\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"(p4rt_explicit_table_entry_per_controller\x18\xb0\x03 \x01(\bR#p4rtExplicitTableEntryPerController\x12?\n" +
	"\x1bexclude_disabled_components\x18\xb1\x03 \x01(\bR\x19excludeDisabledComponentsJ\x04\bT\x10UJ\x04\b\t\x10\n" +
