...
type Metadata_Deviations struct {
	...
	RetainGnmiCfgAfterReboot bool `protobuf:"varint,365,opt,name=retain_gnmi_cfg_after_reboot,json=retainGnmiCfgAfterReboot,proto3" json:"retain_gnmi_cfg_after_reboot,omitempty"`
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xb1\xca\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xba\xc0\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x1cretain_gnmi_cfg_after_reboot\x18\xed\x02 \x01(\bR\x18retainGnmiCfgAfterRebootJ\x04\bT\x10UJ\x04\b\t\x10\n" +
	...
	"\x16non_standard_grpc_port\x18\xee\x02 \x01(\bR\x13nonStandardGrpcPortJ\x04\bT\x10UJ\x04\b\t\x10\n" +
