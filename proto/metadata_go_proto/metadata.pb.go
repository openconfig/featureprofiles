...
type Metadata_Deviations struct {
	...
	SkipContainerOp bool `protobuf:"varint,134,opt,name=skip_container_op,json=skipContainerOp,proto3" json:"skip_container_op,omitempty"`
	// Set ethernet from state.
	DontSetEthernetFromState bool `protobuf:"varint,135,opt,name=dont_set_ethernet_from_state,json=dontSetEthernetFromState,proto3" json:"dont_set_ethernet_from_state,omitempty"`
	// Set subinterface to nil.
	SetSubinterfaceNil bool `protobuf:"varint,136,opt,name=set_subinterface_nil,json=setSubinterfaceNil,proto3" json:"set_subinterface_nil,omitempty"`
	// Reorder calls for vendor compatibility.
	ReorderCallsForVendorCompatibilty bool `protobuf:"varint,137,opt,name=reorder_calls_for_vendor_compatibilty,json=reorderCallsForVendorCompatibilty,proto3" json:"reorder_calls_for_vendor_compatibilty,omitempty"`
	// Add missing base config using cli.
	AddMissingBaseConfigViaCli bool `protobuf:"varint,138,opt,name=add_missing_base_config_via_cli,json=addMissingBaseConfigViaCli,proto3" json:"add_missing_base_config_via_cli,omitempty"`
	// skip_macaddress_check returns true if mac address for an interface via gNMI needs to be skipped.
	SkipMacaddressCheck bool `protobuf:"varint,139,opt,name=skip_macaddress_check,json=skipMacaddressCheck,proto3" json:"skip_macaddress_check,omitempty"`
	// skip_breakout returns true if breakout via gNMI needs to be skipped.
	SkipBreakout bool `protobuf:"varint,140,opt,name=skip_breakout,json=skipBreakout,proto3" json:"skip_breakout,omitempty"`
}
...
var file_metadata_proto_rawDesc = []byte{
	...
	0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xcf, 0x4c, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x61,
	...
	0x65, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x1a, 0x83, 0x45, 0x0a, 0x0a, 0x44, 0x65, 0x76, 0x69,
	...
	,
	...
	0x67, 0x5f, 0x76, 0x69, 0x61, 0x5f, 0x63, 0x6c, 0x69, 0x18, 0x8a, 0x01, 0x20, 0x01, 0x28, 0x08,
	...
	0x63, 0x68, 0x65, 0x63, 0x6b, 0x18, 0x8b, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x13, 0x73, 0x6b,
	0x69, 0x70, 0x4d, 0x61, 0x63, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x43, 0x68, 0x65, 0x63,
	0x6b, 0x12, 0x24, 0x0a, 0x0d, 0x73, 0x6b, 0x69, 0x70, 0x5f, 0x62, 0x72, 0x65, 0x61, 0x6b, 0x6f,
	0x75, 0x74, 0x18, 0x8c, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0c, 0x73, 0x6b, 0x69, 0x70, 0x42,
	0x72, 0x65, 0x61, 0x6b, 0x6f, 0x75, 0x74, 0x4a, 0x04, 0x08, 0x54, 0x10, 0x55, 0x4a, 0x04, 0x08,
	...
	0x38, 0x4a, 0x04, 0x08, 0x59, 0x10, 0x5a, 0x4a, 0x04, 0x08, 0x13, 0x10, 0x14, 0x1a, 0xa0, 0x01,
