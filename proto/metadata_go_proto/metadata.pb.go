...
type Metadata_Deviations struct {
	...
	LacpInterfaceFallbackOcUnsupported bool `protobuf:"varint,409,opt,name=lacp_interface_fallback_oc_unsupported,json=lacpInterfaceFallbackOcUnsupported,proto3" json:"lacp_interface_fallback_oc_unsupported,omitempty"`
	// Device does not support configuring VLAN subinterfaces
	VlanSubinterfaceOcUnsupported bool `protobuf:"varint,410,opt,name=vlan_subinterface_oc_unsupported,json=vlanSubinterfaceOcUnsupported,proto3" json:"vlan_subinterface_oc_unsupported,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	...
	"\x10fragment_punt_ft\x18\x98\x03 \x01(\tR\x0efragmentPuntFt\x12S\n" +
	"&lacp_interface_fallback_oc_unsupported\x18\x99\x03 \x01(\bR\"lacpInterfaceFallbackOcUnsupported\x12H\n" +
	" vlan_subinterface_oc_unsupported\x18\x9a\x03 \x01(\bR\x1dvlanSubinterfaceOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
