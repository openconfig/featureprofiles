...
type Metadata_Deviations struct {
	...
	DefaultPeerAsFilterOcUnsupported bool `protobuf:"varint,437,opt,name=default_peer_as_filter_oc_unsupported,json=defaultPeerAsFilterOcUnsupported,proto3" json:"default_peer_as_filter_oc_unsupported,omitempty"`
	unknownFields                    protoimpl.UnknownFields
	sizeCache                        protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	...
	"%default_peer_as_filter_oc_unsupported\x18\xb5\x03 \x01(\bR defaultPeerAsFilterOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
