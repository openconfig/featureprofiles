...
type Metadata_Deviations struct {
	...
	FragmentPuntUnsupported bool `protobuf:"varint,405,opt,name=fragment_punt_unsupported,json=fragmentPuntUnsupported,proto3" json:"fragment_punt_unsupported,omitempty"`
	// Device does not support fragment punt pkts.
	// Arista: https://partnerissuetracker.corp.google.com/issues/502413665
	// Juniper: https://partnerissuetracker.corp.google.com/issues/502415318
	// Nokia: https://partnerissuetracker.corp.google.com/issues/502415071
	FragmentPuntPktsUnsupported bool `protobuf:"varint,406,opt,name=fragment_punt_pkts_unsupported,json=fragmentPuntPktsUnsupported,proto3" json:"fragment_punt_pkts_unsupported,omitempty"`
	...
	FragmentPuntFt string `protobuf:"bytes,407,opt,name=fragment_punt_ft,json=fragmentPuntFt,proto3" json:"fragment_punt_ft,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xa2\xe3\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xee\xd8\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\"static_route_to_nhg_oc_unsupported\x18\x92\x03 \x01(\bR\x1dstaticRouteToNhgOcUnsupported\x12;\n" +
	"\x19fragment_punt_unsupported\x18\x95\x03 \x01(\bR\x17fragmentPuntUnsupported\x12D\n" +
	"\x1efragment_punt_pkts_unsupported\x18\x96\x03 \x01(\bR\x1bfragmentPuntPktsUnsupported\x12)\n" +
	"\x10fragment_punt_ft\x18\x97\x03 \x01(\tR\x0efragmentPuntFtJ\x04\bT\x10UJ\x04\b\t\x10\n" +
