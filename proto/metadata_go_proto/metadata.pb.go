...
type Metadata_Deviations struct {
	...
	// MplsExpIngressClassifierOcUnsupported for devices that do not support ingress mpls exp field classification
	MplsExpIngressClassifierOcUnsupported bool `protobuf:"varint,271,opt,name=mpls_exp_ingress_classifier_oc_unsupported,json=mplsExpIngressClassifierOcUnsupported,proto3" json:"mpls_exp_ingress_classifier_oc_unsupported,omitempty"`
	unknownFields                         protoimpl.UnknownFields
	sizeCache                             protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xe9\x95\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xbd\x8c\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"(interface_output_queue_non_standard_name\x18\x8e\x02 \x01(\bR#interfaceOutputQueueNonStandardName\x12Z\n" +
	"*mpls_exp_ingress_classifier_oc_unsupported\x18\x8f\x02 \x01(\bR%mplsExpIngressClassifierOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
