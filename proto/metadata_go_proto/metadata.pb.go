...
type Metadata_Deviations struct {
	...
	FrBreakoutFix bool `protobuf:"varint,292,opt,name=fr_breakout_fix,json=frBreakoutFix,proto3" json:"fr_breakout_fix,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xe6\x9e\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xba\x95\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x0ffr_breakout_fix\x18\xa4\x02 \x01(\bR\rfrBreakoutFixJ\x04\bT\x10UJ\x04\b\t\x10\n" +
