...
type Metadata_Deviations struct {
	...
	DisableHardwareNexthopProxy bool `protobuf:"varint,302,opt,name=disable_hardware_nexthop_proxy,json=disableHardwareNexthopProxy,proto3" json:"disable_hardware_nexthop_proxy,omitempty"`
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	...
	"\x1edisable_hardware_nexthop_proxy\x18\xae\x02 \x01(\bR\x1bdisableHardwareNexthopProxyJ\x04\bT\x10UJ\x04\b\t\x10\n" +
