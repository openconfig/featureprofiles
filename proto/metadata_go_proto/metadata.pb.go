...
type Metadata_Deviations struct {
	...
	// Nokia: b/445494680
	P4RtExplicitTableEntryPerController bool `protobuf:"varint,327,opt,name=p4rt_explicit_table_entry_per_controller,json=p4rtExplicitTableEntryPerController,proto3" json:"p4rt_explicit_table_entry_per_controller,omitempty"`
	unknownFields                       protoimpl.UnknownFields
	sizeCache                           protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xba\xb3\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\"load_balance_policy_oc_unsupported\x18\xc6\x02 \x01(\bR\x1eloadBalancePolicyOcUnsupported\x12V\n" +
	"(p4rt_explicit_table_entry_per_controller\x18\xc7\x02 \x01(\bR#p4rtExplicitTableEntryPerControllerJ\x04\bT\x10UJ\x04\b\t\x10\n" +
