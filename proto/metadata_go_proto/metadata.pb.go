...
type Metadata_Deviations struct {
	...
	DefaultNoIgpMetricPropagation bool `protobuf:"varint,269,opt,name=default_no_igp_metric_propagation,json=defaultNoIgpMetricPropagation,proto3" json:"default_no_igp_metric_propagation,omitempty"`
	// Skip setting send-community-type in bgp peer-group config
	SkipBgpPeerGroupSendCommunityType bool `protobuf:"varint,270,opt,name=skip_bgp_peer_group_send_community_type,json=skipBgpPeerGroupSendCommunityType,proto3" json:"skip_bgp_peer_group_send_community_type,omitempty"`
	unknownFields                     protoimpl.UnknownFields
	sizeCache                         protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\x82\x95\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x15isis_mpls_unsupported\x18\x8c\x02 \x01(\bR\x13isisMplsUnsupported\x12I\n" +
	"!default_no_igp_metric_propagation\x18\x8d\x02 \x01(\bR\x1ddefaultNoIgpMetricPropagation\x12S\n" +
	"'skip_bgp_peer_group_send_community_type\x18\x8e\x02 \x01(\bR!skipBgpPeerGroupSendCommunityTypeJ\x04\bT\x10UJ\x04\b\t\x10\n" +
