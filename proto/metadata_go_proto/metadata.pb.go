...
type Metadata_Deviations struct {
	...
	StaticRouteToNhgOcUnsupported bool `protobuf:"varint,361,opt,name=static_route_to_nhg_oc_unsupported,json=staticRouteToNhgOcUnsupported,proto3" json:"static_route_to_nhg_oc_unsupported,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xb8\xc7\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xc1\xbd\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x17isis_sr_no_php_required\x18\xe8\x02 \x01(\bR\x13isisSrNoPhpRequired\x12J\n" +
	"\"static_route_to_nhg_oc_unsupported\x18\xe9\x02 \x01(\bR\x1dstaticRouteToNhgOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
