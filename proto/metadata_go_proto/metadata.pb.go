...
type Metadata_Deviations struct {
	...
	PolicyForwardingGreEncapsulationUnsupported bool `protobuf:"varint,313,opt,name=policy_forwarding_gre_encapsulation_unsupported,json=policyForwardingGreEncapsulationUnsupported,proto3" json:"policy_forwarding_gre_encapsulation_unsupported,omitempty"`
	// Devices that do not support qos classifier dscp remark action
	QosClassifierDscpRemarkUnsupported bool `protobuf:"varint,314,opt,name=qos_classifier_dscp_remark_unsupported,json=qosClassifierDscpRemarkUnsupported,proto3" json:"qos_classifier_dscp_remark_unsupported,omitempty"`
	unknownFields                      protoimpl.UnknownFields
	sizeCache                          protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xa0\xac\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xf4\xa2\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"/policy_forwarding_gre_encapsulation_unsupported\x18\xb9\x02 \x01(\bR+policyForwardingGreEncapsulationUnsupported\x12S\n" +
	"&qos_classifier_dscp_remark_unsupported\x18\xba\x02 \x01(\bR\"qosClassifierDscpRemarkUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
