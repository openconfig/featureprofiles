...
type Metadata_Deviations struct {
	...
	DisableHardwareNexthopProxy bool `protobuf:"varint,319,opt,name=disable_hardware_nexthop_proxy,json=disableHardwareNexthopProxy,proto3" json:"disable_hardware_nexthop_proxy,omitempty"`
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xbc\xaf\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1aݥ\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"3network_instance_import_export_policy_oc_unsuppored\x18\xbe\x02 \x01(\bR-networkInstanceImportExportPolicyOcUnsuppored\x12D\n" +
	"\x1edisable_hardware_nexthop_proxy\x18\xbf\x02 \x01(\bR\x1bdisableHardwareNexthopProxyJ\x04\bT\x10UJ\x04\b\t\x10\n" +
