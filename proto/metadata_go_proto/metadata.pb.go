...
type Metadata_Deviations struct {
	...
	EnableMplsStaticOnInterface bool `protobuf:"varint,409,opt,name=enable_mpls_static_on_interface,json=enableMplsStaticOnInterface,proto3" json:"enable_mpls_static_on_interface,omitempty"`
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xb3\xe4\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xff\xd9\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x10fragment_punt_ft\x18\x98\x03 \x01(\tR\x0efragmentPuntFt\x12E\n" +
	"\x1fenable_mpls_static_on_interface\x18\x99\x03 \x01(\bR\x1benableMplsStaticOnInterfaceJ\x04\bT\x10UJ\x04\b\t\x10\n" +
