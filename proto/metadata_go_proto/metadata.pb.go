...
type Metadata_Deviations struct {
	...
	// Devices which require policy-forwarding interface keys to use interface
	// name + .subinterface index.
	InterfaceIdFormatRequiredForPolicyForwarding bool `protobuf:"varint,433,opt,name=interface_id_format_required_for_policy_forwarding,json=interfaceIdFormatRequiredForPolicyForwarding,proto3" json:"interface_id_format_required_for_policy_forwarding,omitempty"`
	unknownFields                                protoimpl.UnknownFields
	sizeCache                                    protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\x80\xf3\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xcc\xe8\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"(p4rt_explicit_table_entry_per_controller\x18\xb0\x03 \x01(\bR#p4rtExplicitTableEntryPerController\x12i\n" +
	"2interface_id_format_required_for_policy_forwarding\x18\xb1\x03 \x01(\bR,interfaceIdFormatRequiredForPolicyForwardingJ\x04\bT\x10UJ\x04\b\t\x10\n" +
