...
type Metadata_Deviations struct {
	...
	MaxOutFibRouteCount uint32 `protobuf:"varint,436,opt,name=max_out_fib_route_count,json=maxOutFibRouteCount,proto3" json:"max_out_fib_route_count,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\x8a\xf5\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xd6\xea\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"!use_chassis_aggregate_utilization\x18\xb3\x03 \x01(\bR\x1euseChassisAggregateUtilization\x125\n" +
	"\x17max_out_fib_route_count\x18\xb4\x03 \x01(\rR\x13maxOutFibRouteCountJ\x04\bT\x10UJ\x04\b\t\x10\n" +
