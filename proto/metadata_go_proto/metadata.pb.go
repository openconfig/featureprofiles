...
type Metadata_Deviations struct {
	...
	SkipSamplingQosCounters bool `protobuf:"varint,353,opt,name=skip_sampling_qos_counters,json=skipSamplingQosCounters,proto3" json:"skip_sampling_qos_counters,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xd3\xc2\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1aܸ\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\"syslog_non_default_vrf_unsupported\x18\xdf\x02 \x01(\bR\x1esyslogNonDefaultVrfUnsupported\x12F\n" +
	"\x1fbgp_local_aggregate_unsupported\x18\xe0\x02 \x01(\bR\x1cbgpLocalAggregateUnsupported\x12<\n" +
	"\x1askip_sampling_qos_counters\x18\xe1\x02 \x01(\bR\x17skipSamplingQosCountersJ\x04\bT\x10UJ\x04\b\t\x10\n" +
