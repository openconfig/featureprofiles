...
type Metadata_Deviations struct {
	...
	StaticRouteToNhgOcUnsupported bool `protobuf:"varint,392,opt,name=static_route_to_nhg_oc_unsupported,json=staticRouteToNhgOcUnsupported,proto3" json:"static_route_to_nhg_oc_unsupported,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
