...
type Metadata_Deviations struct {
	...
	// Juniper b/422688435
	PredefinedMaxEcmpPaths bool `protobuf:"varint,273,opt,name=predefined_max_ecmp_paths,json=predefinedMaxEcmpPaths,proto3" json:"predefined_max_ecmp_paths,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"ϕ\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xa3\x8c\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x19predefined_max_ecmp_paths\x18\x91\x02 \x01(\bR\x16predefinedMaxEcmpPathsJ\x04\bT\x10UJ\x04\b\t\x10\n" +
