...
type Metadata_Deviations struct {
	...
	AggregateSidCounterOutPktsUnsupported bool `protobuf:"varint,358,opt,name=aggregate_sid_counter_out_pkts_unsupported,json=aggregateSidCounterOutPktsUnsupported,proto3" json:"aggregate_sid_counter_out_pkts_unsupported,omitempty"`
	...
	IsisSrNoPhpRequired bool `protobuf:"varint,359,opt,name=isis_sr_no_php_required,json=isisSrNoPhpRequired,proto3" json:"isis_sr_no_php_required,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\x84\xc6\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x8d\xbc\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x19config_acl_oc_unsupported\x18\xe5\x02 \x01(\bR\x16configAclOcUnsupported\x12Z\n" +
	"*aggregate_sid_counter_out_pkts_unsupported\x18\xe6\x02 \x01(\bR%aggregateSidCounterOutPktsUnsupported\x125\n" +
	"\x17isis_sr_no_php_required\x18\xe7\x02 \x01(\bR\x13isisSrNoPhpRequiredJ\x04\bT\x10UJ\x04\b\t\x10\n" +
