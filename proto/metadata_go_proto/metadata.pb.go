...
type Metadata_Deviations struct {
	...
	FpdFt         string `protobuf:"bytes,394,opt,name=fpd_ft,json=fpdFt,proto3" json:"fpd_ft,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Metadata_Deviations) GetFpdFt() string {
	if x != nil {
		return x.FpdFt
	}
	return ""
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xae\xdb\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xfa\xd0\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x1fprefix_limit_config_unsupported\x18\x89\x03 \x01(\bR\x1cprefixLimitConfigUnsupported\x12\x16\n" +
	"\x06fpd_ft\x18\x8a\x03 \x01(\tR\x05fpdFtJ\x04\bT\x10UJ\x04\b\t\x10\n" +
