...
type Metadata_Deviations struct {
	...
	CpuUtilizationQueryAgainstBaseControllerCardComponent bool `protobuf:"varint,366,opt,name=cpu_utilization_query_against_base_controller_card_component,json=cpuUtilizationQueryAgainstBaseControllerCardComponent,proto3" json:"cpu_utilization_query_against_base_controller_card_component,omitempty"`
	// Cisco https://partnerissuetracker.corp.google.com/issues/475101800
	// Devices that report linecard CPU utilization against base linecard component
	CpuUtilizationQueryAgainstBaseLinecardComponent bool `protobuf:"varint,367,opt,name=cpu_utilization_query_against_base_linecard_component,json=cpuUtilizationQueryAgainstBaseLinecardComponent,proto3" json:"cpu_utilization_query_against_base_linecard_component,omitempty"`
	// Device does not support no-queue drops
	// Cisco: https://partnerissuetracker.corp.google.com/issues/475777158
	NoQueueDropUnsupported bool `protobuf:"varint,368,opt,name=no_queue_drop_unsupported,json=noQueueDropUnsupported,proto3" json:"no_queue_drop_unsupported,omitempty"`
	...
	InterfaceEthernetInblockErrorsUnsupported bool `protobuf:"varint,369,opt,name=interface_ethernet_inblock_errors_unsupported,json=interfaceEthernetInblockErrorsUnsupported,proto3" json:"interface_ethernet_inblock_errors_unsupported,omitempty"`
	unknownFields                             protoimpl.UnknownFields
	sizeCache                                 protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\x89\xcd\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x92\xc3\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"!containerz_plugin_rpc_unsupported\x18\xed\x02 \x01(\bR\x1econtainerzPluginRpcUnsupported\x12|\n" +
	"<cpu_utilization_query_against_base_controller_card_component\x18\xee\x02 \x01(\bR5cpuUtilizationQueryAgainstBaseControllerCardComponent\x12o\n" +
	"5cpu_utilization_query_against_base_linecard_component\x18\xef\x02 \x01(\bR/cpuUtilizationQueryAgainstBaseLinecardComponent\x12:\n" +
	"\x19no_queue_drop_unsupported\x18\xf0\x02 \x01(\bR\x16noQueueDropUnsupported\x12a\n" +
	"-interface_ethernet_inblock_errors_unsupported\x18\xf1\x02 \x01(\bR)interfaceEthernetInblockErrorsUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
