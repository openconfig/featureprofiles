...
type Metadata_Deviations struct {
	...
	// Device does not support default import policy
	DefaultImportPolicyUnsupported bool `protobuf:"varint,375,opt,name=default_import_policy_unsupported,json=defaultImportPolicyUnsupported,proto3" json:"default_import_policy_unsupported,omitempty"`
	unknownFields                  protoimpl.UnknownFields
	sizeCache                      protoimpl.SizeCache
}
...
func (x *Metadata_Deviations) GetDefaultImportPolicyUnsupported() bool {
	if x != nil {
		return x.DefaultImportPolicyUnsupported
	}
	return false
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xa0\xd0\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x8c\xc6\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x1dtransceiver_state_unsupported\x18\xf6\x02 \x01(\bR\x1btransceiverStateUnsupported\x12J\n" +
	"!default_import_policy_unsupported\x18\xf7\x02 \x01(\bR\x1edefaultImportPolicyUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
