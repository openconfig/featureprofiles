...
type Metadata_Deviations struct {
	...
	// Arista https://partnerissuetracker.corp.google.com/issues/489304077
	KillProcessDifferentYangName bool `protobuf:"varint,411,opt,name=kill_process_different_yang_name,json=killProcessDifferentYangName,proto3" json:"kill_process_different_yang_name,omitempty"`
	unknownFields                protoimpl.UnknownFields
	sizeCache                    protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xf4\xe5\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xc0\xdb\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	",default_subinterface_packet_counters_missing\x18\x99\x03 \x01(\bR(defaultSubinterfacePacketCountersMissing\x12G\n" +
	" kill_process_different_yang_name\x18\x9b\x03 \x01(\bR\x1ckillProcessDifferentYangNameJ\x04\bT\x10UJ\x04\b\t\x10\n" +
