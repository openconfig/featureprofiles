...
type Metadata_Deviations struct {
	...
	// Device that do not support soft loopback mode
	SoftLoopbackOcUnsupported bool `protobuf:"varint,447,opt,name=soft_loopback_oc_unsupported,json=softLoopbackOcUnsupported,proto3" json:"soft_loopback_oc_unsupported,omitempty"`
...
func (x *Metadata_Deviations) GetSoftLoopbackOcUnsupported() bool {
	if x != nil {
		return x.SoftLoopbackOcUnsupported
  }
  return false
}
