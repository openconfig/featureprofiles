...
type Metadata_Deviations struct {
	...
	// grpc-server config.
	GrpcTransportSecurityFalseUnsupported bool `protobuf:"varint,427,opt,name=grpc_transport_security_false_unsupported,json=grpcTransportSecurityFalseUnsupported,proto3" json:"grpc_transport_security_false_unsupported,omitempty"`
	unknownFields                         protoimpl.UnknownFields
	sizeCache                             protoimpl.SizeCache
}
...
func (x *Metadata_Deviations) GetGrpcTransportSecurityFalseUnsupported() bool {
	if x != nil {
		return x.GrpcTransportSecurityFalseUnsupported
	}
	return false
}
