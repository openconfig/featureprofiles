...
type Metadata_Deviations struct {
	...
	// Set to true if the device does not support BGP add-path send-max configuration.
	// Cisco: b/498283710
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xe0\xde\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xac\xd4\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"-oc_aaa_user_role_leaf_string_type_unsupported\x18\x8f\x03 \x01(\bR&ocAaaUserRoleLeafStringTypeUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
