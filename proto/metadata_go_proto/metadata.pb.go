...
type Metadata_Deviations struct {
	...
	// Devices where the CPU components do not map to a FRU parent component
	// in the OC tree.
	CpuMissingAncestor bool `protobuf:"varint,44,opt,name=cpu_missing_ancestor,json=cpuMissingAncestor,proto3" json:"cpu_missing_ancestor,omitempty"`
}
...
var file_metadata_proto_rawDesc = []byte{
	...
	0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa4, 0x1d, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x61,
	...
	0x61, 0x72, 0x65, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x1a, 0xf6, 0x17, 0x0a, 0x0a, 0x44, 0x65, 0x76,
	...
	0x6e, 0x63, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x18, 0x2c, 0x20, 0x01, 0x28, 0x08, 0x52, 0x12, 0x63,
