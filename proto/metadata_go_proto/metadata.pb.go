...
type Metadata_Deviations struct {
	...
	// Use the deviation if GNPSI SFlow export is not configured by default
	// Cisco: https://partnerissuetracker.corp.google.com/issues/517961843
	MissingSflowGnpsiExport bool `protobuf:"varint,436,opt,name=missing_sflow_gnpsi_export,json=missingSflowGnpsiExport,proto3" json:"missing_sflow_gnpsi_export,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *Metadata_Deviations) GetMissingSflowGnpsiExport() bool {
	if x != nil {
		return x.MissingSflowGnpsiExport
	}
	return false
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\x91\xf5\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xdd\xea\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"!use_chassis_aggregate_utilization\x18\xb3\x03 \x01(\bR\x1euseChassisAggregateUtilization\x12<\n" +
	"\x1amissing_sflow_gnpsi_export\x18\xb4\x03 \x01(\bR\x17missingSflowGnpsiExportJ\x04\bT\x10UJ\x04\b\t\x10\n" +
