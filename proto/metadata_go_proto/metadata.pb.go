...
type Metadata_Deviations struct {
	...
	UrpfConfigOcUnsupported bool `protobuf:"varint,332,opt,name=urpf_config_oc_unsupported,json=urpfConfigOcUnsupported,proto3" json:"urpf_config_oc_unsupported,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\x81\xb6\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x8a\xac\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x1aurpf_config_oc_unsupported\x18\xcc\x02 \x01(\bR\x17urpfConfigOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
