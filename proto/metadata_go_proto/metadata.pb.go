...
type Metadata_Deviations struct {
	...
	// Arista: b/335739231
	MatchCommunitySetMatchSetOptionsAllUnsupported bool `protobuf:"varint,354,opt,name=match_community_set_match_set_options_all_unsupported,json=matchCommunitySetMatchSetOptionsAllUnsupported,proto3" json:"match_community_set_match_set_options_all_unsupported,omitempty"`
	unknownFields                                  protoimpl.UnknownFields
	sizeCache                                      protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xba\xc3\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1aù\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x1bdefault_ni_gnmi_server_name\x18\xe1\x02 \x01(\tR\x17defaultNiGnmiServerName\x12n\n" +
	"5match_community_set_match_set_options_all_unsupported\x18\xe2\x02 \x01(\bR.matchCommunitySetMatchSetOptionsAllUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
