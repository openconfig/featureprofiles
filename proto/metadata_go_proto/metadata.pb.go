...
type Metadata_Deviations struct {
	...
	PowerSupplyTelemetryUnsupported bool `protobuf:"varint,451,opt,name=power_supply_telemetry_unsupported,json=powerSupplyTelemetryUnsupported,proto3" json:"power_supply_telemetry_unsupported,omitempty"`
	unknownFields                   protoimpl.UnknownFields
	sizeCache                       protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xff\xfe\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x87\xf4\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"/vrf_selection_policy_non_default_ni_unsupported\x18\xc2\x03 \x01(\bR)vrfSelectionPolicyNonDefaultNiUnsupported\x12L\n" +
	"\"power_supply_telemetry_unsupported\x18\xc3\x03 \x01(\bR\x1fpowerSupplyTelemetryUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
