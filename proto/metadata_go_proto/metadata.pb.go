...
type Metadata_Deviations struct {
	...
	PolicyForwardingCountersUnsupported bool `protobuf:"varint,368,opt,name=policy_forwarding_counters_unsupported,json=policyForwardingCountersUnsupported,proto3" json:"policy_forwarding_counters_unsupported,omitempty"`
	unknownFields                       protoimpl.UnknownFields
	sizeCache                           protoimpl.SizeCache
}
...
func (x *Metadata_Deviations) GetPolicyForwardingCountersUnsupported() bool {
	if x != nil {
		return x.PolicyForwardingCountersUnsupported
	}
	return false
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xdf\xcb\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xcb\xc1\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x18temperature_sensor_check\x18\xef\x02 \x01(\bR\x16temperatureSensorCheck\x12T\n" +
	"&policy_forwarding_counters_unsupported\x18\xf0\x02 \x01(\bR#policyForwardingCountersUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
