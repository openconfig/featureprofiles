...
type Metadata_Deviations struct {
	...
	UseChassisAggregateUtilization bool `protobuf:"varint,433,opt,name=use_chassis_aggregate_utilization,json=useChassisAggregateUtilization,proto3" json:"use_chassis_aggregate_utilization,omitempty"`
	unknownFields                  protoimpl.UnknownFields
	sizeCache                      protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xe1\xf2\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xad\xe8\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"(p4rt_explicit_table_entry_per_controller\x18\xb0\x03 \x01(\bR#p4rtExplicitTableEntryPerController\x12J\n" +
	"!use_chassis_aggregate_utilization\x18\xb1\x03 \x01(\bR\x1euseChassisAggregateUtilizationJ\x04\bT\x10UJ\x04\b\t\x10\n" +
