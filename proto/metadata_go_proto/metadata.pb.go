...
type Metadata_Deviations struct {
	...
	BmpOcUnsupported bool `protobuf:"varint,342,opt,name=bmp_oc_unsupported,json=bmpOcUnsupported,proto3" json:"bmp_oc_unsupported,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"ۻ\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xe4\xb1\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x18localhost_for_containerz\x18\xd5\x02 \x01(\bR\x16localhostForContainerz\x12-\n" +
	"\x12bmp_oc_unsupported\x18\xd6\x02 \x01(\bR\x10bmpOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
