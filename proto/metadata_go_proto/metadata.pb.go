...
type Metadata_Deviations struct {
	...
	LowScaleAft   bool `protobuf:"varint,301,opt,name=low_scale_aft,json=lowScaleAft,proto3" json:"low_scale_aft,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xf3\xa3\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1aǚ\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"'skip_bgp_peer_group_send_community_type\x18\xab\x02 \x01(\bR!skipBgpPeerGroupSendCommunityType\x127\n" +
	"\x18link_local_instead_of_nh\x18\xac\x02 \x01(\bR\x14linkLocalInsteadOfNh\x12#\n" +
	"\rlow_scale_aft\x18\xad\x02 \x01(\bR\vlowScaleAftJ\x04\bT\x10UJ\x04\b\t\x10\n" +
