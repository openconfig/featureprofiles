...
type Metadata_Deviations struct {
	...
	NetworkInstanceImportExportPolicyOcUnsuppored bool `protobuf:"varint,316,opt,name=network_instance_import_export_policy_oc_unsuppored,json=networkInstanceImportExportPolicyOcUnsuppored,proto3" json:"network_instance_import_export_policy_oc_unsuppored,omitempty"`
	unknownFields                                 protoimpl.UnknownFields
	sizeCache                                     protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xc0\xad\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x94\xa4\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"2policy_forwarding_gre_encapsulation_oc_unsupported\x18\xbb\x02 \x01(\bR-policyForwardingGreEncapsulationOcUnsupported\x12k\n" +
	"3network_instance_import_export_policy_oc_unsuppored\x18\xbc\x02 \x01(\bR-networkInstanceImportExportPolicyOcUnsupporedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
