...
type Metadata_Deviations struct {
	...
	DefaultNoIgpMetricPropagation bool `protobuf:"varint,272,opt,name=default_no_igp_metric_propagation,json=defaultNoIgpMetricPropagation,proto3" json:"default_no_igp_metric_propagation,omitempty"`
	// Skip setting send-community-type in bgp peer-group config
	SkipBgpPeerGroupSendCommunityType bool `protobuf:"varint,273,opt,name=skip_bgp_peer_group_send_community_type,json=skipBgpPeerGroupSendCommunityType,proto3" json:"skip_bgp_peer_group_send_community_type,omitempty"`
	unknownFields                     protoimpl.UnknownFields
	sizeCache                         protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xb1\x96\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x85\x8d\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x16port_speed_unsupported\x18\x8f\x02 \x01(\bR\x14portSpeedUnsupported\x12I\n" +
	"!default_no_igp_metric_propagation\x18\x90\x02 \x01(\bR\x1ddefaultNoIgpMetricPropagation\x12S\n" +
	"'skip_bgp_peer_group_send_community_type\x18\x91\x02 \x01(\bR!skipBgpPeerGroupSendCommunityTypeJ\x04\bT\x10UJ\x04\b\t\x10\n" +
