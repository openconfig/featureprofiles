...
type Metadata_Deviations struct {
	...
	UnreferencedAftFibAckUnsupported bool `protobuf:"varint,269,opt,name=unreferenced_aft_fib_ack_unsupported,json=unreferencedAftFibAckUnsupported,proto3" json:"unreferenced_aft_fib_ack_unsupported,omitempty"`
	unknownFields                    protoimpl.UnknownFields
	sizeCache                        protoimpl.SizeCache
}
