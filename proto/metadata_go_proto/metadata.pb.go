...
type Metadata_Deviations struct {
	...
	DefaultPeerAsFilterOcUnsupported bool `protobuf:"varint,411,opt,name=default_peer_as_filter_oc_unsupported,json=defaultPeerAsFilterOcUnsupported,proto3" json:"default_peer_as_filter_oc_unsupported,omitempty"`
	unknownFields                    protoimpl.UnknownFields
	sizeCache                        protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xfd\xe5\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xc9\xdb\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	",default_subinterface_packet_counters_missing\x18\x99\x03 \x01(\bR(defaultSubinterfacePacketCountersMissing\x12P\n" +
	"%default_peer_as_filter_oc_unsupported\x18\x9b\x03 \x01(\bR defaultPeerAsFilterOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
