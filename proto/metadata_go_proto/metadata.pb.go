...
type Metadata_Deviations struct {
	...
	StaticMplsLspOcUnsupported bool `protobuf:"varint,269,opt,name=static_mpls_lsp_oc_unsupported,json=staticMplsLspOcUnsupported,proto3" json:"static_mpls_lsp_oc_unsupported,omitempty"`
	// Device doesnot support gre enacapsulation
	GreDecapsulationOcUnsupported bool `protobuf:"varint,270,opt,name=gre_decapsulation_oc_unsupported,json=greDecapsulationOcUnsupported,proto3" json:"gre_decapsulation_oc_unsupported,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\x8c\x9f\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xe0\x95\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x1duse_old_oc_path_static_lsp_nh\x18\xa2\x02 \x01(\bR\x17useOldOcPathStaticLspNh\x12C\n" +
	"\x1estatic_mpls_lsp_oc_unsupported\x18\xa3\x02 \x01(\bR\x1astaticMplsLspOcUnsupported\x12H\n" +
	" gre_decapsulation_oc_unsupported\x18\xa4\x02 \x01(\bR\x1dgreDecapsulationOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
