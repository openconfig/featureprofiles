...
type Metadata_Deviations struct {
	...
	MatchLinkBandwidthRegexDiffPrefix bool `protobuf:"varint,272,opt,name=match_link_bandwidth_regex_diff_prefix,json=matchLinkBandwidthRegexDiffPrefix,proto3" json:"match_link_bandwidth_regex_diff_prefix,omitempty"`
	unknownFields                     protoimpl.UnknownFields
	sizeCache                         protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xe5\x95\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xb9\x8c\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x16port_speed_unsupported\x18\x8f\x02 \x01(\bR\x14portSpeedUnsupported\x12R\n" +
	"&match_link_bandwidth_regex_diff_prefix\x18\x90\x02 \x01(\bR!matchLinkBandwidthRegexDiffPrefixJ\x04\bT\x10UJ\x04\b\t\x10\n" +
