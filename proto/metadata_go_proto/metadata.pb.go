...
type Metadata_Deviations struct {
	...
	// use_old_oc_path_static_lsp_nh is set to true for devices that do not support the new OC path for static LSP next-hops.
	// yang path "/network-instances/network-instance/mpls/lsps/static-lsps/static-lsp/egress/lsp-next-hops/
	// issues/417176906
	bool use_old_oc_path_static_lsp_nh = 269;
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
