...
type Metadata_Deviations struct {
	...
	BgpCommunityTypeSliceInputUnsupported bool `protobuf:"varint,362,opt,name=bgp_community_type_slice_input_unsupported,json=bgpCommunityTypeSliceInputUnsupported,proto3" json:"bgp_community_type_slice_input_unsupported,omitempty"`
	unknownFields                         protoimpl.UnknownFields
	sizeCache                             protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xb8\xc8\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xc1\xbe\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"5match_community_set_match_set_options_all_unsupported\x18\xe9\x02 \x01(\bR.matchCommunitySetMatchSetOptionsAllUnsupported\x12Z\n" +
	"*bgp_community_type_slice_input_unsupported\x18\xea\x02 \x01(\bR%bgpCommunityTypeSliceInputUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
