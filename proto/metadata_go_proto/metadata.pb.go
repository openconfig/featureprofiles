...
type Metadata_Deviations struct {
	...
	// TODO: Cisco  https://partnerissuetracker.corp.google.com/issues/
	// Devices that report controller CPU utilization against base controller card component
	CpuUtilizationQueryAgainstBaseControllerCardComponent bool `protobuf:"varint,363,opt,name=cpu_utilization_query_against_base_controller_card_component,json=cpuUtilizationQueryAgainstBaseControllerCardComponent,proto3" json:"cpu_utilization_query_against_base_controller_card_component,omitempty"`
	// TODO: Cisco  https://partnerissuetracker.corp.google.com/issues/
	// Devices that report linecard CPU utilization against base linecard component
	CpuUtilizationQueryAgainstBaseLinecardComponent bool `protobuf:"varint,364,opt,name=cpu_utilization_query_against_base_linecard_component,json=cpuUtilizationQueryAgainstBaseLinecardComponent,proto3" json:"cpu_utilization_query_against_base_linecard_component,omitempty"`
	unknownFields                                   protoimpl.UnknownFields
	sizeCache                                       protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xfa\xc9\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x83\xc0\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x12bmp_oc_unsupported\x18\xea\x02 \x01(\bR\x10bmpOcUnsupported\x12|\n" +
	"<cpu_utilization_query_against_base_controller_card_component\x18\xeb\x02 \x01(\bR5cpuUtilizationQueryAgainstBaseControllerCardComponent\x12o\n" +
	"5cpu_utilization_query_against_base_linecard_component\x18\xec\x02 \x01(\bR/cpuUtilizationQueryAgainstBaseLinecardComponentJ\x04\bT\x10UJ\x04\b\t\x10\n" +
