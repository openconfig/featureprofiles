...
type Metadata_Deviations struct {
	...
	// b/479957749
	BgpDefaultPolicyBehaviorAcceptRoute bool `protobuf:"varint,376,opt,name=bgp_default_policy_behavior_accept_route,json=bgpDefaultPolicyBehaviorAcceptRoute,proto3" json:"bgp_default_policy_behavior_accept_route,omitempty"`
	unknownFields                       protoimpl.UnknownFields
	sizeCache                           protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xec\xd0\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xd8\xc6\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x1bsubnet_mask_change_required\x18\xf7\x02 \x01(\bR\x18subnetMaskChangeRequired\x12V\n" +
	"(bgp_default_policy_behavior_accept_route\x18\xf8\x02 \x01(\bR#bgpDefaultPolicyBehaviorAcceptRouteJ\x04\bT\x10UJ\x04\b\t\x10\n" +
