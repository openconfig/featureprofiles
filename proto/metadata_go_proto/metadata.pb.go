...
// source: third_party/openconfig/featureprofiles/proto/metadata.proto

// Package metadata_go_proto is a generated protocol buffer package.
//
// For documentation on the generated Go API, see:
//
//   - http://go/proto-generated-go
//
// This package includes generated code for the following source files:
//
//   - http://google3/third_party/openconfig/featureprofiles/proto/metadata.proto
package metadata_go_proto

import (
	protodeps "google3/net/proto2/go/protodeps"
	ondatra_go_proto "google3/third_party/openconfig/ondatra/proto/ondatra_go_proto"
	reflect "reflect"
	sync "sync"
	unsafe "unsafe"
)
...
func (x Metadata_Testbed) String() string {
	return protodeps.ProtoImpl_X.EnumStringOf(x.Descriptor(), protodeps.ProtoReflect_EnumNumber(x))
}

func (Metadata_Testbed) Descriptor() protodeps.ProtoReflect_EnumDescriptor {
	return file_third_party_openconfig_featureprofiles_proto_metadata_proto_enumTypes[0].Descriptor()
}

func (Metadata_Testbed) Type() protodeps.ProtoReflect_EnumType {
	return &file_third_party_openconfig_featureprofiles_proto_metadata_proto_enumTypes[0]
}

func (x Metadata_Testbed) Number() protodeps.ProtoReflect_EnumNumber {
	return protodeps.ProtoReflect_EnumNumber(x)
}

// Deprecated: Use Metadata_Testbed.Descriptor instead.
func (Metadata_Testbed) EnumDescriptor() ([]byte, []int) {
	return file_third_party_openconfig_featureprofiles_proto_metadata_proto_rawDescGZIP(), []int{0, 0}
}
...
func (Metadata_Tags) Descriptor() protodeps.ProtoReflect_EnumDescriptor {
	return file_third_party_openconfig_featureprofiles_proto_metadata_proto_enumTypes[1].Descriptor()
}

func (Metadata_Tags) Type() protodeps.ProtoReflect_EnumType {
	return &file_third_party_openconfig_featureprofiles_proto_metadata_proto_enumTypes[1]
}

func (x Metadata_Tags) Number() protodeps.ProtoReflect_EnumNumber {
	return protodeps.ProtoReflect_EnumNumber(x)
}

// Deprecated: Use Metadata_Tags.Descriptor instead.
func (Metadata_Tags) EnumDescriptor() ([]byte, []int) {
	return file_third_party_openconfig_featureprofiles_proto_metadata_proto_rawDescGZIP(), []int{0, 1}
}

// Metadata about a Feature Profiles test.
type Metadata struct {
	state protodeps.ProtoImpl_MessageState `protogen:"open.v1"`
	// UUID of the test.
	...
	unknownFields    protodeps.ProtoImpl_UnknownFields
	sizeCache        protodeps.ProtoImpl_SizeCache
}

func (x *Metadata) Reset() {
	*x = Metadata{}
	mi := &file_third_party_openconfig_featureprofiles_proto_metadata_proto_msgTypes[0]
	ms := protodeps.ProtoImpl_X.MessageStateOf(protodeps.ProtoImpl_Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Metadata) String() string {
	return protodeps.ProtoImpl_X.MessageStringOf(x)
}

func (*Metadata) ProtoMessage() {}

func (x *Metadata) ProtoReflect() protodeps.ProtoReflect_Message {
	mi := &file_third_party_openconfig_featureprofiles_proto_metadata_proto_msgTypes[0]
	if x != nil {
		ms := protodeps.ProtoImpl_X.MessageStateOf(protodeps.ProtoImpl_Pointer(x))
...
func (*Metadata) Descriptor() ([]byte, []int) {
	return file_third_party_openconfig_featureprofiles_proto_metadata_proto_rawDescGZIP(), []int{0}
}
...
type Metadata_Platform struct {
	...
	Vendor ondatra_go_proto.Device_Vendor `protobuf:"varint,1,opt,name=vendor,proto3,enum=ondatra.Device_Vendor" json:"vendor,omitempty"`
...
func (x *Metadata_Platform) Reset() {
	*x = Metadata_Platform{}
	mi := &file_third_party_openconfig_featureprofiles_proto_metadata_proto_msgTypes[1]
	ms := protodeps.ProtoImpl_X.MessageStateOf(protodeps.ProtoImpl_Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Metadata_Platform) ProtoReflect() protodeps.ProtoReflect_Message {
	mi := &file_third_party_openconfig_featureprofiles_proto_metadata_proto_msgTypes[1]
	if x != nil {
		ms := protodeps.ProtoImpl_X.MessageStateOf(protodeps.ProtoImpl_Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *Metadata_Platform) GetVendor() ondatra_go_proto.Device_Vendor {
	if x != nil {
		return x.Vendor
	}
	return ondatra_go_proto.Device_Vendor(0)
}
...
type Metadata_Deviations struct {
	...
	// community_match_with_redistribution_unsupported is set to true for
	// devices that do not support matching community at the redistribution
	// attach point.
	...
	// wecmp_auto_unsupported is set to true for devices that do not support
	// auto wecmp
	...
	// policy chaining, ie. more than one policy at an attachement point is not
	// supported
	...
	// qos_inqueue_drop_counter_Unsupported is set to true for devices that do
	// not support qos ingress queue drop counters. Juniper: b/341130490
	...
	// peer_group_def_bgp_vrf_unsupported is set to true for devices that do not
	// support peer group definition under bgp vrf configuration.
	...
	// redis_uconnected_under_ebgp_vrf_unsupported is set to true for devices
	// that do not support redistribution of connected routes under ebgp vrf
	// configuration.
	...
	// bgp_afisafi_in_default_ni_before_other_ni is set to true for devices that
	// require certain afi/safis to be enabled in default network instance (ni)
	// before enabling afi/safis for neighbors in default or non-default ni.
	...
	// ipv6_router_advertisement_interval_unsupported is set to true for devices
	// that do not support ipv6 router advertisement interval configuration.
	...
	// device does not support a Healthz GET RPC against Chassis level component
	// like "CHASSIS" or "Rack 0"
	...
	// Leaf-ref validation for list keys which is enforced for Cisco and hence
	// deviation b/373581140
	...
	// EnableMultipathUnderAfiSafi returns true for devices that do not support
	// multipath under /global path and instead support under global/afi/safi
	// path CISCO: b/376241033 CISCO: b/340859662
	...
	// Nokia; b/304493065 comment#7 SRL native admin_enable for
	// table-connections
	...
	// Cisco: b/388980373
	// default import policy for table connection unsupported is set to true for
	// devices that do not support default import policy.
	...
	// Cisco: b/388955361
	// table connection metric propagation unsupported is set to true for
	// devices that do not support metric propagation.
	...
	// Cisco: b/388980376
	// table connection attribute propagation unsupported is set to true for
	// devices that do not support attribute propagation.
	...
	// Cisco: b/388955364
	// table connection subscription unsupported is set to true for devices that
	// do not support subscription for table connection leaves.
	...
	// Cisco: b/388983709
	// default bgp instance name is used to set bgp instance name value other
	// than DEFAULT
	...
	// Devices that do not support oper-status for Integrated Circuits telemetry
	// path Juniper b/395551640
	...
	// Nokia: b/383075189
	// ExplicitDcoConfig returns true if explicit configurations are required in
	// module-functional-type for the transceiver
	...
	// verify_expected_breakout_supported_config is used to verify on Cisco
	// devices if optic supports a given breakout mode Cisco:
	...
	// bgp_aspathset_unsupported is set to true for devices that do not support
	// as-path-set for bgp-defined-sets. Juniper: b/330173167
	...
	// Cisco: b/404301960
	// Devices that block one IS-IS level specific authentication config
	// attribute for P2P links. The same leafs can be set directly under ISIS
	...
	// SkipOpticalChannelOutputPowerInterval for devices that do not support
	// optical-channel/output-power/interval leaf Nokia b/394622454
	...
	// SkipTransceiverDescription for devices that do not support
	// transceiver/description leaf Nokia b/394622453
	...
	// UseOldOCPathStaticLspNh for devices that do not support the new OC path
	// for static lsp next-hops issues/404301960
	...
	// UnsupportedQoSOutputServicePolicy for devices that do not support qos
	...
	// InterfaceOutputQueueNonStandardName for devices with non-standard output
	// queue names
	...
	// MplsExpIngressClassifierUnsupported for devices that do not support
	// ingress mpls exp field classification
	...
	// Juniper  b/428613305
	// FEC uncorrectable errors accumulate over time and are not cleared unless
	// the component is reset on target
	...
	// Cisco: b/402672689
	// Devices that support sflow ingress min sampling rate of 1/N with
	// N<1,000,000 can use this deviation to set specific value of N. Returns
	// N=1,000,000 by default.
	...
	// Devices that do not support import export policies configured in network
	// instance
	...
	// Devices that do not support configuring a two rate three color policer
	// through OC Arista:
	// https://partnerissuetracker.corp.google.com/issues/442749011
	...
	// Cisco bug:
	// https://partnerissuetracker.corp.google.com/u/0/issues/463279843 Cisco
	// Feature Request:
	// https://partnerissuetracker.corp.google.com/u/0/issues/463295774
	...
	// Arista b/434815087
	// Device doesnot support configuring source/destination address as ANY
	// inside ACL
	...
	// Arista: b/462580165 requires no-php for receiving packet with self
	// advertised label
	...
	// Device does not support match-set-options leaf with ALL for
	// match-community-set Arista: b/335739231
	...
	// Devices that report controller CPU utilization against base controller
	// card component
	...
	// Cisco https://partnerissuetracker.corp.google.com/issues/475101800
	// Devices that report linecard CPU utilization against base linecard
	// component
	...
	// The BGP routes are accepted by default when no policy or default policy
	// is configured. b/479957749
	...
	// Nokia: b/459893133
	// reducedEcmpSetOnMixedEncapDecapNh returns true if mixed encap and decap
	// next hops are not supported over ecmp.
	...
	// Device does not support default import policy so we need to explicitly
	// apply "allow-all" import policy Cisco:
	// https://partnerissuetracker.corp.google.com/issues/479056256
	...
	// Functional Translator name for devices with mount point state paths
	// unsupported.
	...
	// Functional Translator name for devices with neighbor link-layer-address
	// paths unsupported.
	ArpFt string `protobuf:"bytes,392,opt,name=arp_ft,json=arpFt,proto3" json:"arp_ft,omitempty"`
	// Device does not support configuring prefix limit received paths through
	// OC Cisco: https://partnerissuetracker.corp.google.com/issues/447509237
	...
	// SSHServerHostCertificateTelemetryUnsupported returns true if
	// /system/ssh-server/state/active-host-certificate-version is not
	// supported. Nokia:
	// https://partnerissuetracker.corp.google.com/issues/494777653
	...
	// SendMaxUnsupported Sets to true if the device does not support BGP
	// add-path send-max configuration. Cisco: b/498283710
	...
	// Partner issue:
	// https://partnerissuetracker.corp.google.com/issues/456362593 Devices that
	// do not support oc path for static route to nexthop
	...
	// Partner issue:
	// https://partnerissuetracker.corp.google.com/issues/489348278 Devices that
	// do not support nexthp-group counters OC
	...
	// Use the deviation if BGP Extension Route Retention configuration is not
	// available via OC
	...
	// Device requires p4rt table entries to be configured for each new primary
	// controller Nokia: b/445494680
	...
	// Device needs a LocalAddress that points to an interface name instead of
	// an IPv4 address for establishing BGP neighborship. Cisco:
	// https://partnerissuetracker.corp.google.com/u/0/issues/500609711
	...
	// Devices which require to use interface-id format of interface name +
	// .subinterface index with Interface-ref container specifically for policy
	// forwarding usecase Cisco:
	// https://partnerissuetracker.corp.google.com/u/0/issues/523054650
	...
	// Juniper : For devices which has different max route count based on
	// platform, this deviation can be used to set the max route count for the
	// device. This will be used in scale test cases to set the max route count
	// for the device.
	...
	// path via gNMI but silently ignores it — the corresponding "bgp listen
	// range" is never programmed. Arista:
	// https://partnerissuetracker.corp.google.com/u/2/issues/534817001
	...
	// Device containerz service presents a self-signed TLS certificate that
	// cannot be verified against a trusted CA. When true, dialContainer uses
	// TLS with InsecureSkipVerify instead of plaintext transport.
	...
	// Arista:
	// https://partnerissuetracker.corp.google.com/issues/491765154#comment10
	...
	// Devices that donot support AIGP metric increment when IGP metric to
	// original destination is zero
	...
	// Devices that do not support validating that max threshold is strictly greater than min threshold.
	// ARISTA & CISCO: https://partnerissuetracker.corp.google.com/...
	...
	// Devices that do not support percentage-based ECN thresholds (min/max-threshold-percent).
	// ARISTA
...
func (x *Metadata_Deviations) Reset() {
	*x = Metadata_Deviations{}
	mi := &file_third_party_openconfig_featureprofiles_proto_metadata_proto_msgTypes[2]
	ms := protodeps.ProtoImpl_X.MessageStateOf(protodeps.ProtoImpl_Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Metadata_Deviations) ProtoReflect() protodeps.ProtoReflect_Message {
	mi := &file_third_party_openconfig_featureprofiles_proto_metadata_proto_msgTypes[2]
	if x != nil {
		ms := protodeps.ProtoImpl_X.MessageStateOf(protodeps.ProtoImpl_Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *Metadata_Deviations) GetEcnThresholdPercentUnsupported() bool {
	if x != nil {
		return x.EcnThresholdPercentUnsupported
	}
	return false
}
...
func (x *Metadata_PlatformExceptions) Reset() {
	*x = Metadata_PlatformExceptions{}
	mi := &file_third_party_openconfig_featureprofiles_proto_metadata_proto_msgTypes[3]
	ms := protodeps.ProtoImpl_X.MessageStateOf(protodeps.ProtoImpl_Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Metadata_PlatformExceptions) ProtoReflect() protodeps.ProtoReflect_Message {
	mi := &file_third_party_openconfig_featureprofiles_proto_metadata_proto_msgTypes[3]
	if x != nil {
		ms := protodeps.ProtoImpl_X.MessageStateOf(protodeps.ProtoImpl_Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (*Metadata_PlatformExceptions) Descriptor() ([]byte, []int) {
	return file_third_party_openconfig_featureprofiles_proto_metadata_proto_rawDescGZIP(), []int{0, 2}
}
...
var File_third_party_openconfig_featureprofiles_proto_metadata_proto protodeps.ProtoReflect_FileDescriptor

const file_third_party_openconfig_featureprofiles_proto_metadata_proto_rawDesc = "" +
	"\n" +
	";third_party/openconfig/featureprofiles/proto/metadata.proto\x12\x12openconfig.testing\x1a2third_party/openconfig/ondatra/proto/testbed.proto\"\xa0\x85\x02\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x88\xfa\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"!ecn_threshold_percent_unsupported\x18\xcc\x03 \x01(\bR\x1eecnThresholdPercentUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
...
var (
	file_third_party_openconfig_featureprofiles_proto_metadata_proto_rawDescOnce sync.Once
	file_third_party_openconfig_featureprofiles_proto_metadata_proto_rawDescData []byte
)

func file_third_party_openconfig_featureprofiles_proto_metadata_proto_rawDescGZIP() []byte {
	file_third_party_openconfig_featureprofiles_proto_metadata_proto_rawDescOnce.Do(func() {
		file_third_party_openconfig_featureprofiles_proto_metadata_proto_rawDescData = protodeps.ProtoImpl_X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_third_party_openconfig_featureprofiles_proto_metadata_proto_rawDesc), len(file_third_party_openconfig_featureprofiles_proto_metadata_proto_rawDesc)))
	})
	return file_third_party_openconfig_featureprofiles_proto_metadata_proto_rawDescData
}

var file_third_party_openconfig_featureprofiles_proto_metadata_proto_enumTypes = make([]protodeps.ProtoImpl_EnumInfo, 2)
var file_third_party_openconfig_featureprofiles_proto_metadata_proto_msgTypes = make([]protodeps.ProtoImpl_MessageInfo, 4)
var file_third_party_openconfig_featureprofiles_proto_metadata_proto_goTypes = []any{
	...
	(ondatra_go_proto.Device_Vendor)(0), // 6: ondatra.Device.Vendor
}
var file_third_party_openconfig_featureprofiles_proto_metadata_proto_depIdxs = []int32{
...
func init() { file_third_party_openconfig_featureprofiles_proto_metadata_proto_init() }
func file_third_party_openconfig_featureprofiles_proto_metadata_proto_init() {
	if File_third_party_openconfig_featureprofiles_proto_metadata_proto != nil {
		return
	}
	type x struct{}
	out := protodeps.ProtoImpl_TypeBuilder{
		File: protodeps.ProtoImpl_DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_third_party_openconfig_featureprofiles_proto_metadata_proto_rawDesc), len(file_third_party_openconfig_featureprofiles_proto_metadata_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_third_party_openconfig_featureprofiles_proto_metadata_proto_goTypes,
		DependencyIndexes: file_third_party_openconfig_featureprofiles_proto_metadata_proto_depIdxs,
		EnumInfos:         file_third_party_openconfig_featureprofiles_proto_metadata_proto_enumTypes,
		MessageInfos:      file_third_party_openconfig_featureprofiles_proto_metadata_proto_msgTypes,
	}.Build()
	File_third_party_openconfig_featureprofiles_proto_metadata_proto = out.File
	file_third_party_openconfig_featureprofiles_proto_metadata_proto_goTypes = nil
	file_third_party_openconfig_featureprofiles_proto_metadata_proto_depIdxs = nil
}
