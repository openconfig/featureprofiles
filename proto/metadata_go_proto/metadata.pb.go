...
type Metadata_Deviations struct {
	...
	SoftLoopbackOcUnsupported bool `protobuf:"varint,453,opt,name=soft_loopback_oc_unsupported,json=softLoopbackOcUnsupported,proto3" json:"soft_loopback_oc_unsupported,omitempty"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xf0\x80\x02\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xf8\xf5\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x1csoft_loopback_oc_unsupported\x18\xc5\x03 \x01(\bR\x19softLoopbackOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
