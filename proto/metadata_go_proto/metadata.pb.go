...
type Metadata_Deviations struct {
	...
	NonStandardGrpcPort bool `protobuf:"varint,365,opt,name=non_standard_grpc_port,json=nonStandardGrpcPort,proto3" json:"non_standard_grpc_port,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xe5\xc9\x01\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xfb\xc9\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xee\xbf\x01\n" +
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x84\xc0\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x1fibgp_multipath_path_unsupported\x18\xec\x02 \x01(\bR\x1cibgpMultipathPathUnsupported\x124\n" +
	"\x16non_standard_grpc_port\x18\xed\x02 \x01(\bR\x13nonStandardGrpcPortJ\x04\bT\x10UJ\x04\b\t\x10\n" +
	"\x1fibgp_multipath_path_unsupported\x18\xec\x02 \x01(\bR\x1cibgpMultipathPathUnsupported\x12J\n" +
	"!containerz_plugin_rpc_unsupported\x18\xed\x02 \x01(\bR\x1econtainerzPluginRpcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
