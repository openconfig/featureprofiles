...
type Metadata_Deviations struct {
	...
	SwitchoverStabilizeDelayM uint32 `protobuf:"varint,454,opt,name=switchover_stabilize_delay_m,json=switchoverStabilizeDelayM,proto3" json:"switchover_stabilize_delay_m,omitempty"`
	...
	GnoiRequiresFreshDialAfterSwitchover bool `protobuf:"varint,455,opt,name=gnoi_requires_fresh_dial_after_switchover,json=gnoiRequiresFreshDialAfterSwitchover,proto3" json:"gnoi_requires_fresh_dial_after_switchover,omitempty"`
	...
	ContainerzRequireExplicitConfigSave bool `protobuf:"varint,456,opt,name=containerz_require_explicit_config_save,json=containerzRequireExplicitConfigSave,proto3" json:"containerz_require_explicit_config_save,omitempty"`
	unknownFields                       protoimpl.UnknownFields
	sizeCache                           protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xef\x82\x02\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xf7\xf7\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\"route_reflector_client_unsupported\x18\xc5\x03 \x01(\bR\x1frouteReflectorClientUnsupported\x12@\n" +
	"\x1cswitchover_stabilize_delay_m\x18\xc6\x03 \x01(\rR\x19switchoverStabilizeDelayM\x12X\n" +
	")gnoi_requires_fresh_dial_after_switchover\x18\xc7\x03 \x01(\bR$gnoiRequiresFreshDialAfterSwitchover\x12U\n" +
	"'containerz_require_explicit_config_save\x18\xc8\x03 \x01(\bR#containerzRequireExplicitConfigSaveJ\x04\bT\x10UJ\x04\b\t\x10\n" +
