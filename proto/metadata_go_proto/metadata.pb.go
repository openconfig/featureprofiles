...
type Metadata_Deviations struct {
	...
	UseBgpSetCommunityOptionTypeReplace bool `protobuf:"varint,292,opt,name=use_bgp_set_community_option_type_replace,json=useBgpSetCommunityOptionTypeReplace,proto3" json:"use_bgp_set_community_option_type_replace,omitempty"`
	unknownFields                       protoimpl.UnknownFields
	sizeCache                           protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\x96\x9f\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xea\x95\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x1bconfig_leaf_create_required\x18\xa3\x02 \x01(\bR\x18configLeafCreateRequired\x12W\n" +
	")use_bgp_set_community_option_type_replace\x18\xa4\x02 \x01(\bR#useBgpSetCommunityOptionTypeReplaceJ\x04\bT\x10UJ\x04\b\t\x10\n" +
