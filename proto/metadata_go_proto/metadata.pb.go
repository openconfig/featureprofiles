...
type Metadata_Deviations struct {
	...
	EcnMinGreaterMaxThresholdUnsupported bool `protobuf:"varint,491,opt,name=ecn_min_greater_max_threshold_unsupported,json=ecnMinGreaterMaxThresholdUnsupported,proto3" json:"ecn_min_greater_max_threshold_unsupported,omitempty"`
	EcnThresholdPercentUnsupported bool `protobuf:"varint,492,opt,name=ecn_threshold_percent_unsupported,json=ecnThresholdPercentUnsupported,proto3" json:"ecn_threshold_percent_unsupported,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
