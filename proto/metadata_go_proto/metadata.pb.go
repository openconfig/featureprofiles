...
type Metadata_Deviations struct {
	...
	DecapsulateGueOcUnsupported bool `protobuf:"varint,313,opt,name=decapsulate_gue_oc_unsupported,json=decapsulateGueOcUnsupported,proto3" json:"decapsulate_gue_oc_unsupported,omitempty"`
	// policy rule based counters unsupported
	PolicyRuleCountersOcUnsupported bool `protobuf:"varint,314,opt,name=policy_rule_counters_oc_unsupported,json=policyRuleCountersOcUnsupported,proto3" json:"policy_rule_counters_oc_unsupported,omitempty"`
	unknownFields                   protoimpl.UnknownFields
	sizeCache                       protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xf9\xab\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a͢\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	",policy_forwarding_to_next_hop_oc_unsupported\x18\xb8\x02 \x01(\bR&policyForwardingToNextHopOcUnsupported\x12D\n" +
	"\x1edecapsulate_gue_oc_unsupported\x18\xb9\x02 \x01(\bR\x1bdecapsulateGueOcUnsupported\x12M\n" +
	"#policy_rule_counters_oc_unsupported\x18\xba\x02 \x01(\bR\x1fpolicyRuleCountersOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
