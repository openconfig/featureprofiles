...
type Metadata_Deviations struct {
	...
	IsisSrgbSrlbUnsupported bool `protobuf:"varint,302,opt,name=isis_srgb_srlb_unsupported,json=isisSrgbSrlbUnsupported,proto3" json:"isis_srgb_srlb_unsupported,omitempty"`
	// Prefix segment configuration not supported
	IsisSrPrefixSegmentConfigUnsupported bool `protobuf:"varint,303,opt,name=isis_sr_prefix_segment_config_unsupported,json=isisSrPrefixSegmentConfigUnsupported,proto3" json:"isis_sr_prefix_segment_config_unsupported,omitempty"`
	// node segment configuration not supported
	IsisSrNodeSegmentConfigUnsupported bool `protobuf:"varint,304,opt,name=isis_sr_node_segment_config_unsupported,json=isisSrNodeSegmentConfigUnsupported,proto3" json:"isis_sr_node_segment_config_unsupported,omitempty"`
	// DUT not returning value for sid counters
	SkipVerifySidCounters bool `protobuf:"varint,305,opt,name=skip_verify_sid_counters,json=skipVerifySidCounters,proto3" json:"skip_verify_sid_counters,omitempty"`
	// DUT not supporting with anycast SID configuration
	SkipVerifyAnycastSid bool `protobuf:"varint,306,opt,name=skip_verify_anycast_sid,json=skipVerifyAnycastSid,proto3" json:"skip_verify_anycast_sid,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xaa\xa7\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xfe\x9d\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"2explicit_swap_src_dst_mac_needed_for_loopback_mode\x18\xad\x02 \x01(\bR*explicitSwapSrcDstMacNeededForLoopbackMode\x12<\n" +
	"\x1aisis_srgb_srlb_unsupported\x18\xae\x02 \x01(\bR\x17isisSrgbSrlbUnsupported\x12X\n" +
	")isis_sr_prefix_segment_config_unsupported\x18\xaf\x02 \x01(\bR$isisSrPrefixSegmentConfigUnsupported\x12T\n" +
	"'isis_sr_node_segment_config_unsupported\x18\xb0\x02 \x01(\bR\"isisSrNodeSegmentConfigUnsupported\x128\n" +
	"\x18skip_verify_sid_counters\x18\xb1\x02 \x01(\bR\x15skipVerifySidCounters\x126\n" +
	"\x17skip_verify_anycast_sid\x18\xb2\x02 \x01(\bR\x14skipVerifyAnycastSidJ\x04\bT\x10UJ\x04\b\t\x10\n" +
