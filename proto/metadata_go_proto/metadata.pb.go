...
type Metadata_Deviations struct {
	...
	// will be coerced to 0.2.
	FrrWeightResolutionTolerance float64 `protobuf:"fixed64,447,opt,name=frr_weight_resolution_tolerance,json=frrWeightResolutionTolerance,proto3" json:"frr_weight_resolution_tolerance,omitempty"`
	unknownFields                protoimpl.UnknownFields
	sizeCache                    protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xbc\xfc\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xc4\xf1\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"(afts_global_filter_policy_oc_unsupported\x18\xbe\x03 \x01(\bR#aftsGlobalFilterPolicyOcUnsupported\x12F\n" +
	"\x1ffrr_weight_resolution_tolerance\x18\xbf\x03 \x01(\x01R\x1cfrrWeightResolutionToleranceJ\x04\bT\x10UJ\x04\b\t\x10\n" +
