...
type Metadata_Deviations struct {
	...
	// Juniper: b/310698466
	SkipBgpSessionCheckWithoutAfisafi bool `protobuf:"varint,124,opt,name=skip_bgp_session_check_without_afisafi,json=skipBgpSessionCheckWithoutAfisafi,proto3" json:"skip_bgp_session_check_without_afisafi,omitempty"`
}
