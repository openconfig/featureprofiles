...
type Metadata_Deviations struct {
	...
	AcctzRecordFailCommandUnsupported bool `protobuf:"varint,402,opt,name=acctz_record_fail_command_unsupported,json=acctzRecordFailCommandUnsupported,proto3" json:"acctz_record_fail_command_unsupported,omitempty"`
	// Device that do not support acctz record for fail user cases
	// Juniper: https://partnerissuetracker.corp.google.com/issues/494474526
	AcctzRecordFailGrpcUnsupported bool `protobuf:"varint,403,opt,name=acctz_record_fail_grpc_unsupported,json=acctzRecordFailGrpcUnsupported,proto3" json:"acctz_record_fail_grpc_unsupported,omitempty"`
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xd4\xe0\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xa0\xd6\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"%acctz_record_fail_command_unsupported\x18\x92\x03 \x01(\bR!acctzRecordFailCommandUnsupported\x12K\n" +
	"\"acctz_record_fail_grpc_unsupported\x18\x93\x03 \x01(\bR\x1eacctzRecordFailGrpcUnsupported\x12\\\n" +
	...
	"\"static_route_to_nhg_oc_unsupported\x18\x92\x03 \x01(\bR\x1dstaticRouteToNhgOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
