...
type Metadata_Deviations struct {
	...
	BgpDynamicNeighborPrefixUnsupported bool `protobuf:"varint,442,opt,name=bgp_dynamic_neighbor_prefix_unsupported,json=bgpDynamicNeighborPrefixUnsupported,proto3" json:"bgp_dynamic_neighbor_prefix_unsupported,omitempty"`
	unknownFields                       protoimpl.UnknownFields
	sizeCache                           protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xb3\xf9\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xff\xee\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x17max_out_fib_route_count\x18\xb9\x03 \x01(\rR\x13maxOutFibRouteCount\x12U\n" +
	"'bgp_dynamic_neighbor_prefix_unsupported\x18\xba\x03 \x01(\bR#bgpDynamicNeighborPrefixUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
