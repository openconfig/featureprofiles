...
func (Metadata_Testbed) EnumDescriptor() ([]byte, []int) {
	return file_proto_metadata_proto_rawDescGZIP(), []int{0, 0}
}
...
func (Metadata_Tags) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_metadata_proto_enumTypes[1].Descriptor()
}

func (Metadata_Tags) Type() protoreflect.EnumType {
	return &file_proto_metadata_proto_enumTypes[1]
}
...
func (Metadata_Tags) EnumDescriptor() ([]byte, []int) {
	return file_proto_metadata_proto_rawDescGZIP(), []int{0, 1}
}
...
type Metadata_Deviations struct {
	...
	// b/448173472
	LocalhostForContainerz bool `protobuf:"varint,340,opt,name=localhost_for_containerz,json=localhostForContainerz,proto3" json:"localhost_for_containerz,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (*Metadata_PlatformExceptions) Descriptor() ([]byte, []int) {
	return file_proto_metadata_proto_rawDescGZIP(), []int{0, 2}
}
...
const file_proto_metadata_proto_rawDesc = "" +
	"\n" +
	"\x14proto/metadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"ٺ\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xe2\xb0\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"!isis_adjacency_stream_unsupported\x18\xd3\x02 \x01(\bR\x1eisisAdjacencyStreamUnsupported\x129\n" +
	"\x18localhost_for_containerz\x18\xd4\x02 \x01(\bR\x16localhostForContainerzJ\x04\bT\x10UJ\x04\b\t\x10\n" +
...
var file_proto_metadata_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
