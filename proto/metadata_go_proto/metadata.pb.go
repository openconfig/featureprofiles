...
type Metadata_Deviations struct {
	...
	PolicyForwardingToNextHopUnsupported bool `protobuf:"varint,267,opt,name=policy_forwarding_to_next_hop_unsupported,json=policyForwardingToNextHopUnsupported,proto3" json:"policy_forwarding_to_next_hop_unsupported,omitempty"`
	// Devices that do not support policy forwarding encapsulate gre action
	PolicyForwardingGreEncapsulationUnsupported bool `protobuf:"varint,268,opt,name=policy_forwarding_gre_encapsulation_unsupported,json=policyForwardingGreEncapsulationUnsupported,proto3" json:"policy_forwarding_gre_encapsulation_unsupported,omitempty"`
	// Devices that do not support qos classifier dscp remark action
	QosClassifierDscpRemarkUnsupported bool `protobuf:"varint,269,opt,name=qos_classifier_dscp_remark_unsupported,json=qosClassifierDscpRemarkUnsupported,proto3" json:"qos_classifier_dscp_remark_unsupported,omitempty"`
	// Cisco: b/404301960
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xfa\x94\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x19sr_igp_config_unsupported\x18\x84\x02 \x01(\bR\x16srIgpConfigUnsupported\x12X\n" +
	")policy_forwarding_to_next_hop_unsupported\x18\x8b\x02 \x01(\bR$policyForwardingToNextHopUnsupported\x12e\n" +
	"/policy_forwarding_gre_encapsulation_unsupported\x18\x8c\x02 \x01(\bR+policyForwardingGreEncapsulationUnsupported\x12S\n" +
	"&qos_classifier_dscp_remark_unsupported\x18\x8d\x02 \x01(\bR\"qosClassifierDscpRemarkUnsupported\x12o\n" +
	...
	"\x19containerz_oc_unsupported\x18\x8a\x02 \x01(\bR\x17containerzOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
