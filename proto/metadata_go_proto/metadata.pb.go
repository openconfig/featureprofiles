...
type Metadata_Deviations struct {
	...
	// Traffic validation upon OOR (Out Of Resource) is unsupported.
	TrafficValidationUponOorUnsupported bool `protobuf:"varint,447,opt,name=traffic_validation_upon_oor_unsupported,json=trafficValidationUponOorUnsupported,proto3" json:"traffic_validation_upon_oor_unsupported,omitempty"`
	unknownFields                       protoimpl.UnknownFields
	sizeCache                           protoimpl.SizeCache
}
...
func (x *Metadata_Deviations) GetTrafficValidationUponOorUnsupported() bool {
	if x != nil {
		return x.TrafficValidationUponOorUnsupported
	}
	return false
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xcb\xfc\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xd3\xf1\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"'traffic_validation_upon_oor_unsupported\x18\xbf\x03 \x01(\bR#trafficValidationUponOorUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
