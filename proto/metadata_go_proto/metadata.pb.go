...
type Metadata_Deviations struct {
	...
	// Device requires ON_CHANGE subscription mode for frequently updated OC leaf
	// nodes instead of TARGET_DEFINED. With TARGET_DEFINED, some devices defer
	// SAMPLE updates for significant time, causing timing failures when a test
	// checks such a value with a timeout lesser than the SAMPLE rate.
	StreamSubscriptionModeOnChangeRequired bool `protobuf:"varint,442,opt,name=stream_subscription_mode_on_change_required,json=streamSubscriptionModeOnChangeRequired,proto3" json:"stream_subscription_mode_on_change_required,omitempty"`
	unknownFields                          protoimpl.UnknownFields
	sizeCache                              protoimpl.SizeCache
}
...
func (x *Metadata_Deviations) GetStreamSubscriptionModeOnChangeRequired() bool {
	if x != nil {
		return x.StreamSubscriptionModeOnChangeRequired
	}
	return false
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xba\xf9\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x86\xef\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x17max_out_fib_route_count\x18\xb9\x03 \x01(\rR\x13maxOutFibRouteCount\x12\\\n" +
	"+stream_subscription_mode_on_change_required\x18\xba\x03 \x01(\bR&streamSubscriptionModeOnChangeRequiredJ\x04\bT\x10UJ\x04\b\t\x10\n" +
