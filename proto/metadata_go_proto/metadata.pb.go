...
type Metadata_Deviations struct {
	...
	StaticMplsLspOcUnsupported bool `protobuf:"varint,300,opt,name=static_mpls_lsp_oc_unsupported,json=staticMplsLspOcUnsupported,proto3" json:"static_mpls_lsp_oc_unsupported,omitempty"`
	// Device doesnot support decapsulation group
	DecapsulateGueOcUnsupported bool `protobuf:"varint,301,opt,name=decapsulate_gue_oc_unsupported,json=decapsulateGueOcUnsupported,proto3" json:"decapsulate_gue_oc_unsupported,omitempty"`
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xa0\xa4\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xf4\x9a\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"'skip_bgp_peer_group_send_community_type\x18\xab\x02 \x01(\bR!skipBgpPeerGroupSendCommunityType\x12C\n" +
	"\x1estatic_mpls_lsp_oc_unsupported\x18\xac\x02 \x01(\bR\x1astaticMplsLspOcUnsupported\x12D\n" +
	"\x1edecapsulate_gue_oc_unsupported\x18\xad\x02 \x01(\bR\x1bdecapsulateGueOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
