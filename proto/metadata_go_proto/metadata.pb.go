...
type Metadata_Deviations struct {
	...
	// Device does not support generating ICMP TTL Exceeded messages for decapsulated packets.
	DecapIcmpTtlExceededUnsupported bool `protobuf:"varint,460,opt,name=decap_icmp_ttl_exceeded_unsupported,json=decapIcmpTtlExceededUnsupported,proto3" json:"decap_icmp_ttl_exceeded_unsupported,omitempty"`
	unknownFields                   protoimpl.UnknownFields
	sizeCache                       protoimpl.SizeCache
}
...
func (x *Metadata_Deviations) GetDecapIcmpTtlExceededUnsupported() bool {
	if x != nil {
		return x.DecapIcmpTtlExceededUnsupported
	}
	return false
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\x97\x85\x02\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xff\xf9\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\"power_supply_telemetry_unsupported\x18\xcb\x03 \x01(\bR\x1fpowerSupplyTelemetryUnsupported\x12M\n" +
	"#decap_icmp_ttl_exceeded_unsupported\x18\xcc\x03 \x01(\bR\x1fdecapIcmpTtlExceededUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
