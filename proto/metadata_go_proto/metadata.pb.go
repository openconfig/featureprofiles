...
type Metadata_Deviations struct {
	...
	// Nokia b/414842051
	TransceiverConfigEnableUnsupported bool `protobuf:"varint,267,opt,name=transceiver_config_enable_unsupported,json=transceiverConfigEnableUnsupported,proto3" json:"transceiver_config_enable_unsupported,omitempty"`
	unknownFields                      protoimpl.UnknownFields
	sizeCache                          protoimpl.SizeCache
}
