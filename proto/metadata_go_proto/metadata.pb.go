...
type Metadata_Deviations struct {
	...
	SkipContainerOp bool `protobuf:"varint,139,opt,name=skip_container_op,json=skipContainerOp,proto3" json:"skip_container_op,omitempty"`
	// Set ethernet from state.
	DontSetEthernetFromState bool `protobuf:"varint,140,opt,name=dont_set_ethernet_from_state,json=dontSetEthernetFromState,proto3" json:"dont_set_ethernet_from_state,omitempty"`
	// Set subinterface to nil.
	SetSubinterfaceNil bool `protobuf:"varint,141,opt,name=set_subinterface_nil,json=setSubinterfaceNil,proto3" json:"set_subinterface_nil,omitempty"`
	// Reorder calls for vendor compatibility.
	ReorderCallsForVendorCompatibilty bool `protobuf:"varint,142,opt,name=reorder_calls_for_vendor_compatibilty,json=reorderCallsForVendorCompatibilty,proto3" json:"reorder_calls_for_vendor_compatibilty,omitempty"`
	// Add missing base config using cli.
	AddMissingBaseConfigViaCli bool `protobuf:"varint,143,opt,name=add_missing_base_config_via_cli,json=addMissingBaseConfigViaCli,proto3" json:"add_missing_base_config_via_cli,omitempty"`
	// skip_macaddress_check returns true if mac address for an interface via gNMI needs to be skipped.
	SkipMacaddressCheck bool `protobuf:"varint,144,opt,name=skip_macaddress_check,json=skipMacaddressCheck,proto3" json:"skip_macaddress_check,omitempty"`
	// skip_breakout returns true if breakout via gNMI needs to be skipped.
	SkipBreakout bool `protobuf:"varint,145,opt,name=skip_breakout,json=skipBreakout,proto3" json:"skip_breakout,omitempty"`
	// skip main interface dot zero naming call, example: HunderedGigE0/0/0/1.0
	SkipMainInterfaceDotZero bool `protobuf:"varint,146,opt,name=skip_main_interface_dot_zero,json=skipMainInterfaceDotZero,proto3" json:"skip_main_interface_dot_zero,omitempty"`
}
...
func (x *Metadata_Deviations) GetSkipMainInterfaceDotZero() bool {
	if x != nil {
		return x.SkipMainInterfaceDotZero
	}
	return false
}
...
var file_metadata_proto_rawDesc = []byte{
	...
	0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9c, 0x50, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x61,
	...
	0x65, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x1a, 0xd0, 0x48, 0x0a, 0x0a, 0x44, 0x65, 0x76, 0x69,
	...
	,
	...
	,
