...
type Metadata_Deviations struct {
	...
	ConfigAclWithPrefixlistUnsupported bool `protobuf:"varint,313,opt,name=config_acl_with_prefixlist_unsupported,json=configAclWithPrefixlistUnsupported,proto3" json:"config_acl_with_prefixlist_unsupported,omitempty"`
	// Arista b/434815087
	// Device doesnot support configuring source/destination address as ANY inside ACL
	ConfigAclValueAnyOcUnsupported bool `protobuf:"varint,314,opt,name=config_acl_value_any_oc_unsupported,json=configAclValueAnyOcUnsupported,proto3" json:"config_acl_value_any_oc_unsupported,omitempty"`
	unknownFields                  protoimpl.UnknownFields
	sizeCache                      protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\x87\xac\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1aۢ\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	",policy_forwarding_to_next_hop_oc_unsupported\x18\xb8\x02 \x01(\bR&policyForwardingToNextHopOcUnsupported\x12S\n" +
	"&config_acl_with_prefixlist_unsupported\x18\xb9\x02 \x01(\bR\"configAclWithPrefixlistUnsupported\x12L\n" +
	"#config_acl_value_any_oc_unsupported\x18\xba\x02 \x01(\bR\x1econfigAclValueAnyOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
