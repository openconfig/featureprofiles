...
type Metadata_Deviations struct {
	...
	// deviation to skip authz verification of gnoi ping rpc
	SkipGnoiPingRpcAuthzVerification bool `protobuf:"varint,437,opt,name=skip_gnoi_ping_rpc_authz_verification,json=skipGnoiPingRpcAuthzVerification,proto3" json:"skip_gnoi_ping_rpc_authz_verification,omitempty"`
	unknownFields                    protoimpl.UnknownFields
	sizeCache                        protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xf6\xf5\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xc2\xeb\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"$unreferenced_aft_fib_ack_unsupported\x18\xb4\x03 \x01(\bR unreferencedAftFibAckUnsupported\x12P\n" +
	"%skip_gnoi_ping_rpc_authz_verification\x18\xb5\x03 \x01(\bR skipGnoiPingRpcAuthzVerificationJ\x04\bT\x10UJ\x04\b\t\x10\n" +
