...
type Metadata_Deviations struct {
	...
	ExtendedRouteRetentionOcUnsupported bool `protobuf:"varint,328,opt,name=extended_route_retention_oc_unsupported,json=extendedRouteRetentionOcUnsupported,proto3" json:"extended_route_retention_oc_unsupported,omitempty"`
	// https://partnerissuetracker.corp.google.com/issues/439825838
	ExrrStaleRouteTimeUnsupported bool `protobuf:"varint,329,opt,name=exrr_stale_route_time_unsupported,json=exrrStaleRouteTimeUnsupported,proto3" json:"exrr_stale_route_time_unsupported,omitempty"`
	// https://partnerissuetracker.corp.google.com/issues/446376446
	GnoiBgpGracefulRestartUnsupported bool `protobuf:"varint,330,opt,name=gnoi_bgp_graceful_restart_unsupported,json=gnoiBgpGracefulRestartUnsupported,proto3" json:"gnoi_bgp_graceful_restart_unsupported,omitempty"`
	unknownFields                     protoimpl.UnknownFields
	sizeCache                         protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\x94\xb5\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xb5\xab\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x19gribi_records_unsupported\x18\xc7\x02 \x01(\bR\x17gribiRecordsUnsupported\x12U\n" +
	"'extended_route_retention_oc_unsupported\x18\xc8\x02 \x01(\bR#extendedRouteRetentionOcUnsupported\x12I\n" +
	"!exrr_stale_route_time_unsupported\x18\xc9\x02 \x01(\bR\x1dexrrStaleRouteTimeUnsupported\x12Q\n" +
	"%gnoi_bgp_graceful_restart_unsupported\x18\xca\x02 \x01(\bR!gnoiBgpGracefulRestartUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
