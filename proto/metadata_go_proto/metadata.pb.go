...
type Metadata_Deviations struct {
	...
	AclDescriptionUnsupported bool `protobuf:"varint,391,opt,name=acl_description_unsupported,json=aclDescriptionUnsupported,proto3" json:"acl_description_unsupported,omitempty"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xb8\xda\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x84\xd0\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x1bacl_description_unsupported\x18\x87\x03 \x01(\bR\x19aclDescriptionUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
