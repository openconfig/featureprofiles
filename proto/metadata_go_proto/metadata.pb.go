...
type Metadata_Deviations struct {
	...
	// Devices does not support public key and certificate in credz artifacts list
	// Cisco b/445304668
	RotateAuthenticationArtifactsListUnsupported bool `protobuf:"varint,327,opt,name=rotate_authentication_artifacts_list_unsupported,json=rotateAuthenticationArtifactsListUnsupported,proto3" json:"rotate_authentication_artifacts_list_unsupported,omitempty"`
	// Devices support seconds for host certificate created on and not nano seconds as per proto
	// Cisco https://partnerissuetracker.corp.google.com/issues/442291970
	HostCertificateCreatedOnInSeconds bool `protobuf:"varint,328,opt,name=host_certificate_created_on_in_seconds,json=hostCertificateCreatedOnInSeconds,proto3" json:"host_certificate_created_on_in_seconds,omitempty"`
	unknownFields                     protoimpl.UnknownFields
	sizeCache                         protoimpl.SizeCache
}
...
func (x *Metadata_Deviations) GetRotateAuthenticationArtifactsListUnsupported() bool {
	if x != nil {
		return x.RotateAuthenticationArtifactsListUnsupported
	}
	return false
}

func (x *Metadata_Deviations) GetHostCertificateCreatedOnInSeconds() bool {
	if x != nil {
		return x.HostCertificateCreatedOnInSeconds
	}
	return false
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\x9f\xb4\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xc0\xaa\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\"load_balance_policy_oc_unsupported\x18\xc6\x02 \x01(\bR\x1eloadBalancePolicyOcUnsupported\x12g\n" +
	"0rotate_authentication_artifacts_list_unsupported\x18\xc7\x02 \x01(\bR,rotateAuthenticationArtifactsListUnsupported\x12R\n" +
	"&host_certificate_created_on_in_seconds\x18\xc8\x02 \x01(\bR!hostCertificateCreatedOnInSecondsJ\x04\bT\x10UJ\x04\b\t\x10\n" +
