...
type Metadata_Deviations struct {
	...
	DefaultPolicyRequiresBgpMatch bool `protobuf:"varint,294,opt,name=default_policy_requires_bgp_match,json=defaultPolicyRequiresBgpMatch,proto3" json:"default_policy_requires_bgp_match,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xed\x9f\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xc1\x96\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x0ffr_breakout_fix\x18\xa5\x02 \x01(\bR\rfrBreakoutFix\x12I\n" +
	"!default_policy_requires_bgp_match\x18\xa6\x02 \x01(\bR\x1ddefaultPolicyRequiresBgpMatchJ\x04\bT\x10UJ\x04\b\t\x10\n" +
