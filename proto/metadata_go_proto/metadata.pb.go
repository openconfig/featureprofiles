...
type Metadata_Deviations struct {
	...
	// Device does not support bmp_oc_unsupported
	// Arista https://partnerissuetracker.corp.google.com/issues/452484903
	BmpOcUnsupported bool `protobuf:"varint,341,opt,name=bmp_oc_unsupported,json=bmpOcUnsupported,proto3" json:"bmp_oc_unsupported,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xa0\xbb\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xa9\xb1\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"%sid_per_interface_counter_unsupported\x18\xd4\x02 \x01(\bR!sidPerInterfaceCounterUnsupported\x12-\n" +
	"\x12bmp_oc_unsupported\x18\xd5\x02 \x01(\bR\x10bmpOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
