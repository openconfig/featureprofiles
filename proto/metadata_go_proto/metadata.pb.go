...
type Metadata_Deviations struct {
	...
	SwitchoverStabilizeDelayM uint32 `protobuf:"varint,434,opt,name=switchover_stabilize_delay_m,json=switchoverStabilizeDelayM,proto3" json:"switchover_stabilize_delay_m,omitempty"`
	...
	GnoiRequiresFreshDialAfterSwitchover bool `protobuf:"varint,435,opt,name=gnoi_requires_fresh_dial_after_switchover,json=gnoiRequiresFreshDialAfterSwitchover,proto3" json:"gnoi_requires_fresh_dial_after_switchover,omitempty"`
	...
	ContainerzRequireExplicitConfigSave bool `protobuf:"varint,436,opt,name=containerz_require_explicit_config_save,json=containerzRequireExplicitConfigSave,proto3" json:"containerz_require_explicit_config_save,omitempty"`
	unknownFields                       protoimpl.UnknownFields
	sizeCache                           protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xd7\xf4\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xa3\xea\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x1cswitchover_stabilize_delay_m\x18\xb2\x03 \x01(\rR\x19switchoverStabilizeDelayM\x12X\n" +
	")gnoi_requires_fresh_dial_after_switchover\x18\xb3\x03 \x01(\bR$gnoiRequiresFreshDialAfterSwitchover\x12U\n" +
	"'containerz_require_explicit_config_save\x18\xb4\x03 \x01(\bR#containerzRequireExplicitConfigSaveJ\x04\bT\x10UJ\x04\b\t\x10\n" +
