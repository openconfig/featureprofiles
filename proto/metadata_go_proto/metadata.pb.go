...
type Metadata_Deviations struct {
	...
	// Arista https://partnerissuetracker.corp.google.com/issues/489304077
	KillProcessDifferentYangName bool `protobuf:"varint,395,opt,name=kill_process_different_yang_name,json=killProcessDifferentYangName,proto3" json:"kill_process_different_yang_name,omitempty"`
	unknownFields                protoimpl.UnknownFields
	sizeCache                    protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	...
	"1ssh_server_host_certificate_telemetry_unsupported\x18\x8a\x03 \x01(\bR,sshServerHostCertificateTelemetryUnsupported\x12G\n" +
	" kill_process_different_yang_name\x18\x8b\x03 \x01(\bR\x1ckillProcessDifferentYangNameJ\x04\bT\x10UJ\x04\b\t\x10\n" +
