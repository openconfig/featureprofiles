...
type Metadata_Deviations struct {
	...
	// Pattern to identify temperature sensors by name.
	TempSensorNamePattern string `protobuf:"bytes,460,opt,name=temp_sensor_name_pattern,json=tempSensorNamePattern,proto3" json:"temp_sensor_name_pattern,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *Metadata_Deviations) GetTempSensorNamePattern() string {
	if x != nil {
		return x.TempSensorNamePattern
	}
	return ""
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\x82\x85\x02\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xea\xf9\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x18temp_sensor_name_pattern\x18\xcc\x03 \x01(\tR\x15tempSensorNamePatternJ\x04\bT\x10UJ\x04\b\t\x10\n" +
