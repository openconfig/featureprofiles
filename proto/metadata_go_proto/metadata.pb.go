...
type Metadata_Deviations struct {
	...
	SkipOrigin    bool `protobuf:"varint,318,opt,name=skip_origin,json=skipOrigin,proto3" json:"skip_origin,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xab\xae\x01\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xf6\xae\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a̤\x01\n" +
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x97\xa5\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x15otn_to_eth_assignment\x18\xbd\x02 \x01(\bR\x12otnToEthAssignment\x12 \n" +
	"\vskip_origin\x18\xbe\x02 \x01(\bR\n" +
	"skipOriginJ\x04\bT\x10UJ\x04\b\t\x10\n" +
	"\x15otn_to_eth_assignment\x18\xbd\x02 \x01(\bR\x12otnToEthAssignment\x12k\n" +
	"3network_instance_import_export_policy_oc_unsuppored\x18\xbe\x02 \x01(\bR-networkInstanceImportExportPolicyOcUnsupporedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
