...
type Metadata_Deviations struct {
	...
	// Juniper b/427524884
	ComponentPowerdownDelay bool `protobuf:"varint,300,opt,name=component_powerdown_delay,json=componentPowerdownDelay,proto3" json:"component_powerdown_delay,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *Metadata_Deviations) GetComponentPowerdownDelay() bool {
	if x != nil {
		return x.ComponentPowerdownDelay
	}
	return false
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"ң\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xa6\x9a\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x19component_powerdown_delay\x18\xac\x02 \x01(\bR\x17componentPowerdownDelayJ\x04\bT\x10UJ\x04\b\t\x10\n" +
