...
type Metadata_Deviations struct {
	...
	QosRemarkOcUnsupported bool `protobuf:"varint,313,opt,name=qos_remark_oc_unsupported,json=qosRemarkOcUnsupported,proto3" json:"qos_remark_oc_unsupported,omitempty"`
	// DUT not returning value for classifier matched packets
	SkipVerifyClassifierMatchedpackets bool `protobuf:"varint,314,opt,name=skip_verify_classifier_matchedpackets,json=skipVerifyClassifierMatchedpackets,proto3" json:"skip_verify_classifier_matchedpackets,omitempty"`
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xe0\xac\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xb4\xa3\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x19qos_remark_oc_unsupported\x18\xb9\x02 \x01(\bR\x16qosRemarkOcUnsupported\x12R\n" +
	"%skip_verify_classifier_matchedpackets\x18\xba\x02 \x01(\bR\"skipVerifyClassifierMatchedpackets\x12j\n" +
