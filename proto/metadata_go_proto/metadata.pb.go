...
type Metadata_Deviations struct {
	...
	UseBgpSetCommunityOptionTypeReplace bool `protobuf:"varint,298,opt,name=use_bgp_set_community_option_type_replace,json=useBgpSetCommunityOptionTypeReplace,proto3" json:"use_bgp_set_community_option_type_replace,omitempty"`
	unknownFields                       protoimpl.UnknownFields
	sizeCache                           protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xa2\x99\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"*mpls_exp_ingress_classifier_oc_unsupported\x18\xa9\x02 \x01(\bR%mplsExpIngressClassifierOcUnsupported\x12W\n" +
	")use_bgp_set_community_option_type_replace\x18\xaa\x02 \x01(\bR#useBgpSetCommunityOptionTypeReplaceJ\x04\bT\x10UJ\x04\b\t\x10\n" +
