...
type Metadata_Deviations struct {
	...
	SubnetMaskChangeRequired bool `protobuf:"varint,373,opt,name=subnet_mask_change_required,json=subnetMaskChangeRequired,proto3" json:"subnet_mask_change_required,omitempty"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\x98\xcf\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x84\xc5\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x1cretain_gnmi_cfg_after_reboot\x18\xf4\x02 \x01(\bR\x18retainGnmiCfgAfterReboot\x12>\n" +
	"\x1bsubnet_mask_change_required\x18\xf5\x02 \x01(\bR\x18subnetMaskChangeRequiredJ\x04\bT\x10UJ\x04\b\t\x10\n" +
