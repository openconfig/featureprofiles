...
type Metadata_Deviations struct {
	...
	// Device requires BGP AddPath negotiation to be scoped to only the
	// client-facing peer instead of all BGP peers. All BGP sessions still
	// come up; only the AddPath capability negotiation is narrowed.
	BgpAddpathClientOnly bool `protobuf:"varint,442,opt,name=bgp_addpath_client_only,json=bgpAddpathClientOnly,proto3" json:"bgp_addpath_client_only,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *Metadata_Deviations) GetBgpAddpathClientOnly() bool {
	if x != nil {
		return x.BgpAddpathClientOnly
	}
	return false
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xb2\xf9\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xe0\xee\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x17max_out_fib_route_count\x18\xb9\x03 \x01(\rR\x13maxOutFibRouteCount\x126\n" +
	"\x17bgp_addpath_client_only\x18\xba\x03 \x01(\bR\x14bgpAddpathClientOnlyJ\x04\bT\x10UJ\x04\b\t\x10\n" +
