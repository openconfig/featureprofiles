...
type Metadata_Deviations struct {
	...
	PolicyForwardingToNextHopOcUnsupported bool `protobuf:"varint,292,opt,name=policy_forwarding_to_next_hop_oc_unsupported,json=policyForwardingToNextHopOcUnsupported,proto3" json:"policy_forwarding_to_next_hop_oc_unsupported,omitempty"`
	// Devices that do not support policy forwarding encapsulate gre action
	PolicyForwardingGreEncapsulationOcUnsupported bool `protobuf:"varint,293,opt,name=policy_forwarding_gre_encapsulation_oc_unsupported,json=policyForwardingGreEncapsulationOcUnsupported,proto3" json:"policy_forwarding_gre_encapsulation_oc_unsupported,omitempty"`
	// Devices that do not support qos classifier dscp remark action
	QosClassifierDscpRemarkOcUnsupported bool `protobuf:"varint,294,opt,name=qos_classifier_dscp_remark_oc_unsupported,json=qosClassifierDscpRemarkOcUnsupported,proto3" json:"qos_classifier_dscp_remark_oc_unsupported,omitempty"`
	unknownFields                        protoimpl.UnknownFields
	sizeCache                            protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xe2\xa0\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xb6\x97\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	",policy_forwarding_to_next_hop_oc_unsupported\x18\xa4\x02 \x01(\bR&policyForwardingToNextHopOcUnsupported\x12j\n" +
	"2policy_forwarding_gre_encapsulation_oc_unsupported\x18\xa5\x02 \x01(\bR-policyForwardingGreEncapsulationOcUnsupported\x12X\n" +
	")qos_classifier_dscp_remark_oc_unsupported\x18\xa6\x02 \x01(\bR$qosClassifierDscpRemarkOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
