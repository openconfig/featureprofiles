...
type Metadata_Deviations struct {
	...
	TemperatureSensorCheck bool `protobuf:"varint,365,opt,name=temperature_sensor_check,json=temperatureSensorCheck,proto3" json:"temperature_sensor_check,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xea\xc9\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xf3\xbf\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x1fibgp_multipath_path_unsupported\x18\xec\x02 \x01(\bR\x1cibgpMultipathPathUnsupported\x129\n" +
	"\x18temperature_sensor_check\x18\xed\x02 \x01(\bR\x16temperatureSensorCheckJ\x04\bT\x10UJ\x04\b\t\x10\n" +
