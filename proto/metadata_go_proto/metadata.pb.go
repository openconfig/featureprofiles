...
type Metadata_Deviations struct {
	...
	// Device doesnot support non standard grpc port
	NonStandardGrpcPort bool `protobuf:"varint,359,opt,name=non_standard_grpc_port,json=nonStandardGrpcPort,proto3" json:"non_standard_grpc_port,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xa7\xc5\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xb0\xbb\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x19config_acl_oc_unsupported\x18\xe5\x02 \x01(\bR\x16configAclOcUnsupported\x124\n" +
	"\x16non_standard_grpc_port\x18\xe7\x02 \x01(\bR\x13nonStandardGrpcPortJ\x04\bT\x10UJ\x04\b\t\x10\n" +
