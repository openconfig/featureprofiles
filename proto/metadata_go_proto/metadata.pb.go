...
type Metadata_Deviations struct {
	...
	// Nokia: b/445494680
	P4RtExplicitTableEntryPerController bool `protobuf:"varint,325,opt,name=p4rt_explicit_table_entry_per_controller,json=p4rtExplicitTableEntryPerController,proto3" json:"p4rt_explicit_table_entry_per_controller,omitempty"`
	unknownFields                       protoimpl.UnknownFields
	sizeCache                           protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	...
	"!global_max_ecmp_paths_unsupported\x18\xc4\x02 \x01(\bR\x1dglobalMaxEcmpPathsUnsupported\x12V\n" +
	"(p4rt_explicit_table_entry_per_controller\x18\xc5\x02 \x01(\bR#p4rtExplicitTableEntryPerControllerJ\x04\bT\x10UJ\x04\b\t\x10\n" +
