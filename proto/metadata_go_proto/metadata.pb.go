...
type Metadata_Deviations struct {
	...
	FabricFt      string `protobuf:"bytes,402,opt,name=fabric_ft,json=fabricFt,proto3" json:"fabric_ft,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xa6\xe0\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xf2\xd5\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	" grpc_server_services_unsupported\x18\x91\x03 \x01(\bR\x1dgrpcServerServicesUnsupported\x12\x1c\n" +
	"\tfabric_ft\x18\x92\x03 \x01(\tR\bfabricFtJ\x04\bT\x10UJ\x04\b\t\x10\n" +
