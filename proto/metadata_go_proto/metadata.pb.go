...
type Metadata_Deviations struct {
	...
	// qos_queue_index_required specifies if device requires queue-index.
	QosQueueIndexRequired bool `protobuf:"varint,460,opt,name=qos_queue_index_required,json=qosQueueIndexRequired,proto3" json:"qos_queue_index_required,omitempty"`
	// qos_max_burst_size_required specifies if device requires
	// maximum-burst-size.
	QosMaxBurstSizeRequired bool `protobuf:"varint,461,opt,name=qos_max_burst_size_required,json=qosMaxBurstSizeRequired,proto3" json:"qos_max_burst_size_required,omitempty"`
	// qos_red_unsupported specifies if device does not support RED under
	// queue-management-profiles.
	QosRedUnsupported bool `protobuf:"varint,462,opt,name=qos_red_unsupported,json=qosRedUnsupported,proto3" json:"qos_red_unsupported,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *Metadata_Deviations) GetQosQueueIndexRequired() bool {
	if x != nil {
		return x.QosQueueIndexRequired
	}
	return false
}

func (x *Metadata_Deviations) GetQosMaxBurstSizeRequired() bool {
	if x != nil {
		return x.QosMaxBurstSizeRequired
	}
	return false
}

func (x *Metadata_Deviations) GetQosRedUnsupported() bool {
	if x != nil {
		return x.QosRedUnsupported
	}
	return false
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xf2\x85\x02\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xda\xfa\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\"power_supply_telemetry_unsupported\x18\xcb\x03 \x01(\bR\x1fpowerSupplyTelemetryUnsupported\x128\n" +
	"\x18qos_queue_index_required\x18\xcc\x03 \x01(\bR\x15qosQueueIndexRequired\x12=\n" +
	"\x1bqos_max_burst_size_required\x18\xcd\x03 \x01(\bR\x17qosMaxBurstSizeRequired\x12/\n" +
	"\x13qos_red_unsupported\x18\xce\x03 \x01(\bR\x11qosRedUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
