...
type Metadata_Deviations struct {
	...
	UnsupportedQosOutputServicePolicy bool `protobuf:"varint,291,opt,name=unsupported_qos_output_service_policy,json=unsupportedQosOutputServicePolicy,proto3" json:"unsupported_qos_output_service_policy,omitempty"`
	// InterfaceOutputQueueNonStandardName for devices with non-standard output queue names
	InterfaceOutputQueueNonStandardName bool `protobuf:"varint,292,opt,name=interface_output_queue_non_standard_name,json=interfaceOutputQueueNonStandardName,proto3" json:"interface_output_queue_non_standard_name,omitempty"`
	// MplsExpIngressClassifierUnsupported for devices that do not support ingress mpls exp field classification
	MplsExpIngressClassifierUnsupported bool `protobuf:"varint,293,opt,name=mpls_exp_ingress_classifier_unsupported,json=mplsExpIngressClassifierUnsupported,proto3" json:"mpls_exp_ingress_classifier_unsupported,omitempty"`
	unknownFields                       protoimpl.UnknownFields
	sizeCache                           protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xff\x9f\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1aӖ\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x1duse_old_oc_path_static_lsp_nh\x18\xa2\x02 \x01(\bR\x17useOldOcPathStaticLspNh\x12Q\n" +
	"%unsupported_qos_output_service_policy\x18\xa3\x02 \x01(\bR!unsupportedQosOutputServicePolicy\x12V\n" +
	"(interface_output_queue_non_standard_name\x18\xa4\x02 \x01(\bR#interfaceOutputQueueNonStandardName\x12U\n" +
	"'mpls_exp_ingress_classifier_unsupported\x18\xa5\x02 \x01(\bR#mplsExpIngressClassifierUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
