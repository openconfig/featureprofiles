...
type Metadata_Deviations struct {
	...
	AftsGlobalFilterPolicyOcUnsupported bool `protobuf:"varint,435,opt,name=afts_global_filter_policy_oc_unsupported,json=aftsGlobalFilterPolicyOcUnsupported,proto3" json:"afts_global_filter_policy_oc_unsupported,omitempty"`
	unknownFields                       protoimpl.UnknownFields
	sizeCache                           protoimpl.SizeCache
}
