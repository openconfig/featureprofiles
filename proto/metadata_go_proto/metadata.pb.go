...
type Metadata_Deviations struct {
	...
	TableConnectionsUnsupported bool `protobuf:"varint,169,opt,name=table_connections_unsupported,json=tableConnectionsUnsupported,proto3" json:"table_connections_unsupported,omitempty"`
