...
type Metadata_Deviations struct {
	...
	ConfigAclWithPrefixlistUnsupported bool `protobuf:"varint,353,opt,name=config_acl_with_prefixlist_unsupported,json=configAclWithPrefixlistUnsupported,proto3" json:"config_acl_with_prefixlist_unsupported,omitempty"`
	// Device doesnot support configuring source/destination address as ANY inside ACL
	ConfigAclValueAnyOcUnsupported bool `protobuf:"varint,354,opt,name=config_acl_value_any_oc_unsupported,json=configAclValueAnyOcUnsupported,proto3" json:"config_acl_value_any_oc_unsupported,omitempty"`
	unknownFields                  protoimpl.UnknownFields
	sizeCache                      protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xae\xc3\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xb7\xb9\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x1askip_sampling_qos_counters\x18\xe0\x02 \x01(\bR\x17skipSamplingQosCounters\x12S\n" +
	"&config_acl_with_prefixlist_unsupported\x18\xe1\x02 \x01(\bR\"configAclWithPrefixlistUnsupported\x12L\n" +
	"#config_acl_value_any_oc_unsupported\x18\xe2\x02 \x01(\bR\x1econfigAclValueAnyOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
