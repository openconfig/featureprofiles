...
type Metadata_Deviations struct {
	...
	PolicyForwardingToNextHopOcUnsupported bool `protobuf:"varint,301,opt,name=policy_forwarding_to_next_hop_oc_unsupported,json=policyForwardingToNextHopOcUnsupported,proto3" json:"policy_forwarding_to_next_hop_oc_unsupported,omitempty"`
	// Devices that do not support creating nexthop encap headers
	NextHopEncapHeaderOcUnsupported bool `protobuf:"varint,302,opt,name=next_hop_encap_header_oc_unsupported,json=nextHopEncapHeaderOcUnsupported,proto3" json:"next_hop_encap_header_oc_unsupported,omitempty"`
	unknownFields                   protoimpl.UnknownFields
	sizeCache                       protoimpl.SizeCache
}
...
func (x *Metadata_Deviations) GetNextHopEncapHeaderOcUnsupported() bool {
	if x != nil {
		return x.NextHopEncapHeaderOcUnsupported
	}
	return false
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\x90\xa5\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xe4\x9b\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\"bgp_as_path_prepend_order_mismtach\x18\xac\x02 \x01(\bR\x1dbgpAsPathPrependOrderMismtach\x12]\n" +
	",policy_forwarding_to_next_hop_oc_unsupported\x18\xad\x02 \x01(\bR&policyForwardingToNextHopOcUnsupported\x12N\n" +
	"$next_hop_encap_header_oc_unsupported\x18\xae\x02 \x01(\bR\x1fnextHopEncapHeaderOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
