...
type Metadata_Deviations struct {
	...
	SkipContainerOp bool `protobuf:"varint,144,opt,name=skip_container_op,json=skipContainerOp,proto3" json:"skip_container_op,omitempty"`
	// Reorder calls for vendor compatibility.
	// Cisco: https://partnerissuetracker.corp.google.com/issues/322291556
	ReorderCallsForVendorCompatibilty bool `protobuf:"varint,145,opt,name=reorder_calls_for_vendor_compatibilty,json=reorderCallsForVendorCompatibilty,proto3" json:"reorder_calls_for_vendor_compatibilty,omitempty"`
	// Add missing base config using cli.
	// Cisco: https://partnerissuetracker.corp.google.com/issues/322291556
	AddMissingBaseConfigViaCli bool `protobuf:"varint,146,opt,name=add_missing_base_config_via_cli,json=addMissingBaseConfigViaCli,proto3" json:"add_missing_base_config_via_cli,omitempty"`
	// skip_macaddress_check returns true if mac address for an interface via gNMI needs to be skipped.
	// Cisco: https://partnerissuetracker.corp.google.com/issues/322291556
	SkipMacaddressCheck bool `protobuf:"varint,147,opt,name=skip_macaddress_check,json=skipMacaddressCheck,proto3" json:"skip_macaddress_check,omitempty"`
}
...
var file_metadata_proto_rawDesc = []byte{
	...
	0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc3, 0x51, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x61,
	...
	0x65, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x1a, 0xdb, 0x49, 0x0a, 0x0a, 0x44, 0x65, 0x76, 0x69,
	...
	0x72, 0x74, 0x65, 0x64, 0x12, 0x2b, 0x0a, 0x11, 0x73, 0x6b, 0x69, 0x70, 0x5f, 0x63, 0x6f, 0x6e,
	0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x5f, 0x6f, 0x70, 0x18, 0x90, 0x01, 0x20, 0x01, 0x28, 0x08,
	...
	0x6d, 0x70, 0x61, 0x74, 0x69, 0x62, 0x69, 0x6c, 0x74, 0x79, 0x18, 0x91, 0x01, 0x20, 0x01, 0x28,
	...
	0x76, 0x69, 0x61, 0x5f, 0x63, 0x6c, 0x69, 0x18, 0x92, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x1a,
	...
	0x65, 0x63, 0x6b, 0x18, 0x93, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x13, 0x73, 0x6b, 0x69, 0x70,
	0x4d, 0x61, 0x63, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x4a,
