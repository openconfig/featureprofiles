...
type Metadata_Deviations struct {
	...
	SkipContainerOp bool `protobuf:"varint,150,opt,name=skip_container_op,json=skipContainerOp,proto3" json:"skip_container_op,omitempty"`
	// Reorder calls for vendor compatibility.
	// Cisco: https://partnerissuetracker.corp.google.com/issues/322291556
	ReorderCallsForVendorCompatibilty bool `protobuf:"varint,151,opt,name=reorder_calls_for_vendor_compatibilty,json=reorderCallsForVendorCompatibilty,proto3" json:"reorder_calls_for_vendor_compatibilty,omitempty"`
	// Add missing base config using cli.
	// Cisco: https://partnerissuetracker.corp.google.com/issues/322291556
	AddMissingBaseConfigViaCli bool `protobuf:"varint,152,opt,name=add_missing_base_config_via_cli,json=addMissingBaseConfigViaCli,proto3" json:"add_missing_base_config_via_cli,omitempty"`
	// skip_macaddress_check returns true if mac address for an interface via gNMI needs to be skipped.
	// Cisco: https://partnerissuetracker.corp.google.com/issues/322291556
	SkipMacaddressCheck bool `protobuf:"varint,153,opt,name=skip_macaddress_check,json=skipMacaddressCheck,proto3" json:"skip_macaddress_check,omitempty"`
}
...
var file_metadata_proto_rawDesc = []byte{
	...
	0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x90, 0x55, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x61,
	...
	0x65, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x1a, 0x91, 0x4d, 0x0a, 0x0a, 0x44, 0x65, 0x76, 0x69,
	...
	0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x52, 0x75, 0x6c, 0x65, 0x12, 0x2b, 0x0a, 0x11, 0x73, 0x6b,
	0x69, 0x70, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x5f, 0x6f, 0x70, 0x18,
	0x96, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0f, 0x73, 0x6b, 0x69, 0x70, 0x43, 0x6f, 0x6e, 0x74,
	...
	0x18, 0x97, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x21, 0x72, 0x65, 0x6f, 0x72, 0x64, 0x65, 0x72,
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x5f, 0x76, 0x69, 0x61, 0x5f, 0x63, 0x6c, 0x69, 0x18, 0x98, 0x01,
	...
	0x65, 0x73, 0x73, 0x5f, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x18, 0x99, 0x01, 0x20, 0x01, 0x28, 0x08,
