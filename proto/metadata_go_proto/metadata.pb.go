...
type Metadata_Deviations struct {
	...
	DefaultNiGnmiServerName string `protobuf:"bytes,352,opt,name=default_ni_gnmi_server_name,json=defaultNiGnmiServerName,proto3" json:"default_ni_gnmi_server_name,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\x8c\xc2\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x95\xb8\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x1bdefault_ni_gnmi_server_name\x18\xe0\x02 \x01(\tR\x17defaultNiGnmiServerNameJ\x04\bT\x10UJ\x04\b\t\x10\n" +
