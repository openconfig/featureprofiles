...
type Metadata_Deviations struct {
	...
	StaticRouteToNhgOcUnsupported bool `protobuf:"varint,352,opt,name=static_route_to_nhg_oc_unsupported,json=staticRouteToNhgOcUnsupported,proto3" json:"static_route_to_nhg_oc_unsupported,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	...
	"\"static_route_to_nhg_oc_unsupported\x18\xe0\x02 \x01(\bR\x1dstaticRouteToNhgOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
