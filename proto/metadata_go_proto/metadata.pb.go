...
type Metadata_Deviations struct {
	...
	GnoiFabricComponentRebootUnsupported bool `protobuf:"varint,49,opt,name=gnoi_fabric_component_reboot_unsupported,json=gnoiFabricComponentRebootUnsupported,proto3" json:"gnoi_fabric_component_reboot_unsupported,omitempty"`
	// Device does not support the ntp nondefault vrf case.
	NtpNonDefaultVrfUnsupported bool `protobuf:"varint,50,opt,name=ntp_non_default_vrf_unsupported,json=ntpNonDefaultVrfUnsupported,proto3" json:"ntp_non_default_vrf_unsupported,omitempty"`
	// Devices where the CPU components do not map to a FRU parent component in the OC tree.
	CpuMissingAncestor bool `protobuf:"varint,51,opt,name=cpu_missing_ancestor,json=cpuMissingAncestor,proto3" json:"cpu_missing_ancestor,omitempty"`
}
...
var file_metadata_proto_rawDesc = []byte{
	...
	0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa4, 0x21, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x61,
	...
	0x61, 0x72, 0x65, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x1a, 0xf6, 0x1b, 0x0a, 0x0a, 0x44, 0x65, 0x76,
	...
	0x74, 0x5f, 0x75, 0x6e, 0x73, 0x75, 0x70, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x64, 0x18, 0x31, 0x20,
	...
	0x5f, 0x75, 0x6e, 0x73, 0x75, 0x70, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x64, 0x18, 0x32, 0x20, 0x01,
	...
	0x6e, 0x63, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x18, 0x33, 0x20, 0x01, 0x28, 0x08, 0x52, 0x12, 0x63,
