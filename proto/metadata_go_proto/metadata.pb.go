...
type Metadata_Deviations struct {
	...
	BgpAdjRibOcUnsupported bool `protobuf:"varint,451,opt,name=bgp_adj_rib_oc_unsupported,json=bgpAdjRibOcUnsupported,proto3" json:"bgp_adj_rib_oc_unsupported,omitempty"`
	// Devices that donot support AIGP metric increment when IGP metric to original destination is zero
	AigpMetricIncrement bool `protobuf:"varint,452,opt,name=aigp_metric_increment,json=aigpMetricIncrement,proto3" json:"aigp_metric_increment,omitempty"`
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xea\xff\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xf2\xf4\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x1abgp_adj_rib_oc_unsupported\x18\xc3\x03 \x01(\bR\x16bgpAdjRibOcUnsupported\x123\n" +
	"\x15aigp_metric_increment\x18\xc4\x03 \x01(\bR\x13aigpMetricIncrement\x12M\n" +
