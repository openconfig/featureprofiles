...
type Metadata_Deviations struct {
	...
	DecapIcmpTtlExceededUnsupported bool `protobuf:"varint,459,opt,name=decap_icmp_ttl_exceeded_unsupported,json=decapIcmpTtlExceededUnsupported,proto3" json:"decap_icmp_ttl_exceeded_unsupported,omitempty"`
	unknownFields                   protoimpl.UnknownFields
	sizeCache                       protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xa9\x84\x02\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xb1\xf9\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x15aigp_metric_increment\x18\xca\x03 \x01(\bR\x13aigpMetricIncrement\x12M\n" +
	"#decap_icmp_ttl_exceeded_unsupported\x18\xcb\x03 \x01(\bR\x1fdecapIcmpTtlExceededUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
