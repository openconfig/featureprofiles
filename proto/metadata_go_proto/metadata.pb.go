...
type Metadata_Deviations struct {
	...
	// Device needs LocalAddress that points to an interface name instead of IPv4 address for establishing BGP neighborship
	// Cisco: TODO add issue ID here
	UseInterfaceNameForIbgpNeighborTransportIpv4LocalAddress bool `protobuf:"varint,400,opt,name=use_interface_name_for_ibgp_neighbor_transport_ipv4_local_address,json=useInterfaceNameForIbgpNeighborTransportIpv4LocalAddress,proto3" json:"use_interface_name_for_ibgp_neighbor_transport_ipv4_local_address,omitempty"`
	unknownFields                                            protoimpl.UnknownFields
	sizeCache                                                protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xe7\xdf\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xb3\xd5\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"-oc_aaa_user_role_leaf_string_type_unsupported\x18\x8f\x03 \x01(\bR&ocAaaUserRoleLeafStringTypeUnsupported\x12\x84\x01\n" +
	"Ause_interface_name_for_ibgp_neighbor_transport_ipv4_local_address\x18\x90\x03 \x01(\bR8useInterfaceNameForIbgpNeighborTransportIpv4LocalAddressJ\x04\bT\x10UJ\x04\b\t\x10\n" +
