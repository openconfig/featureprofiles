...
type Metadata_Deviations struct {
	...
	StandbyPowerSupplyReportsDisabled bool `protobuf:"varint,446,opt,name=standby_power_supply_reports_disabled,json=standbyPowerSupplyReportsDisabled,proto3" json:"standby_power_supply_reports_disabled,omitempty"`
	unknownFields                     protoimpl.UnknownFields
	sizeCache                         protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xef\xfb\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xf7\xf0\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x15macsec_oc_unsupported\x18\xbd\x03 \x01(\bR\x13macsecOcUnsupported\x12Q\n" +
	"%standby_power_supply_reports_disabled\x18\xbe\x03 \x01(\bR!standbyPowerSupplyReportsDisabledJ\x04\bT\x10UJ\x04\b\t\x10\n" +
