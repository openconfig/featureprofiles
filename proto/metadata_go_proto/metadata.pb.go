...
type Metadata_Deviations struct {
	...
	// Factor by which to multiply maxDroppedPackets for ACL update tests.
	// Arista: some devices take longer to update ACLs, requiring a higher packet drop tolerance.
	AclUpdateDelayFactor uint32 `protobuf:"varint,427,opt,name=acl_update_delay_factor,json=aclUpdateDelayFactor,proto3" json:"acl_update_delay_factor,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *Metadata_Deviations) GetAclUpdateDelayFactor() uint32 {
	if x != nil {
		return x.AclUpdateDelayFactor
	}
	return 0
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\x85\xef\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xd1\xe4\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"$containerz_retrieve_logs_unsupported\x18\xaa\x03 \x01(\bR!containerzRetrieveLogsUnsupported\x126\n" +
	"\x17acl_update_delay_factor\x18\xab\x03 \x01(\rR\x14aclUpdateDelayFactorJ\x04\bT\x10UJ\x04\b\t\x10\n" +
