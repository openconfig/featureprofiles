...
type Metadata_Deviations struct {
	...
	CiscoxrTransceiverFt string `protobuf:"bytes,363,opt,name=ciscoxr_transceiver_ft,json=ciscoxrTransceiverFt,proto3" json:"ciscoxr_transceiver_ft,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xc2\xc8\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x12bmp_oc_unsupported\x18\xea\x02 \x01(\bR\x10bmpOcUnsupported\x125\n" +
	"\x16ciscoxr_transceiver_ft\x18\xeb\x02 \x01(\tR\x14ciscoxrTransceiverFtJ\x04\bT\x10UJ\x04\b\t\x10\n" +
