...
type Metadata_Deviations struct {
	...
	LacpInterfaceFallbackOcUnsupported bool `protobuf:"varint,394,opt,name=lacp_interface_fallback_oc_unsupported,json=lacpInterfaceFallbackOcUnsupported,proto3" json:"lacp_interface_fallback_oc_unsupported,omitempty"`
	// Device does not support configuring VLAN subinterfaces
	VlanSubinterfaceOcUnsupported bool `protobuf:"varint,395,opt,name=vlan_subinterface_oc_unsupported,json=vlanSubinterfaceOcUnsupported,proto3" json:"vlan_subinterface_oc_unsupported,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xb5\xdc\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x81\xd2\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x1fprefix_limit_config_unsupported\x18\x89\x03 \x01(\bR\x1cprefixLimitConfigUnsupported\x12S\n" +
	"&lacp_interface_fallback_oc_unsupported\x18\x8a\x03 \x01(\bR\"lacpInterfaceFallbackOcUnsupported\x12H\n" +
	" vlan_subinterface_oc_unsupported\x18\x8b\x03 \x01(\bR\x1dvlanSubinterfaceOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
