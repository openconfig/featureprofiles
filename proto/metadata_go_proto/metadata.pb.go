...
type Metadata_Deviations struct {
	...
	NetworkInstanceImportExportPolicyOcUnsuppored bool `protobuf:"varint,305,opt,name=network_instance_import_export_policy_oc_unsuppored,json=networkInstanceImportExportPolicyOcUnsuppored,proto3" json:"network_instance_import_export_policy_oc_unsuppored,omitempty"`
	unknownFields                                 protoimpl.UnknownFields
	sizeCache                                     protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xea\xa6\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xbe\x9d\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"&missing_system_description_config_path\x18\xb0\x02 \x01(\bR\"missingSystemDescriptionConfigPath\x12k\n" +
	"3network_instance_import_export_policy_oc_unsuppored\x18\xb1\x02 \x01(\bR-networkInstanceImportExportPolicyOcUnsupporedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
