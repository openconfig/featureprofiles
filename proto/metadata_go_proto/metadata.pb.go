...
type Metadata_Deviations struct {
	...
	// Nokia: b/445494680
	P4RtExplicitTableEntryPerController bool `protobuf:"varint,345,opt,name=p4rt_explicit_table_entry_per_controller,json=p4rtExplicitTableEntryPerController,proto3" json:"p4rt_explicit_table_entry_per_controller,omitempty"`
	unknownFields                       protoimpl.UnknownFields
	sizeCache                           protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\x88\xbe\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x91\xb4\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"(advertised_cumulative_lbw_oc_unsupported\x18\xd8\x02 \x01(\bR$advertisedCumulativeLbwOcUnsupported\x12V\n" +
	"(p4rt_explicit_table_entry_per_controller\x18\xd9\x02 \x01(\bR#p4rtExplicitTableEntryPerControllerJ\x04\bT\x10UJ\x04\b\t\x10\n" +
