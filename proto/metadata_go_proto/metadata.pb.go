...
type Metadata_Deviations struct {
	...
	BgpRibStreamingConfigRequired bool `protobuf:"varint,363,opt,name=bgp_rib_streaming_config_required,json=bgpRibStreamingConfigRequired,proto3" json:"bgp_rib_streaming_config_required,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xd6\xc8\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x12bmp_oc_unsupported\x18\xea\x02 \x01(\bR\x10bmpOcUnsupported\x12I\n" +
	"!bgp_rib_streaming_config_required\x18\xeb\x02 \x01(\bR\x1dbgpRibStreamingConfigRequiredJ\x04\bT\x10UJ\x04\b\t\x10\n" +
