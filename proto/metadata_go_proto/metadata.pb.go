...
type Metadata_Deviations struct {
	...
	BgpDefaultVrfIpv4UnicastAfiSafiEnabledLeafMissing string `protobuf:"bytes,432,opt,name=bgp_default_vrf_ipv4_unicast_afi_safi_enabled_leaf_missing,json=bgpDefaultVrfIpv4UnicastAfiSafiEnabledLeafMissing,proto3" json:"bgp_default_vrf_ipv4_unicast_afi_safi_enabled_leaf_missing,omitempty"`
	unknownFields                                     protoimpl.UnknownFields
	sizeCache                                         protoimpl.SizeCache
}
...
func (x *Metadata_Deviations) GetBgpDefaultVrfIpv4UnicastAfiSafiEnabledLeafMissing() string {
	if x != nil {
		return x.BgpDefaultVrfIpv4UnicastAfiSafiEnabledLeafMissing
	}
	return ""
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xb5\xf2\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x81\xe8\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	":bgp_default_vrf_ipv4_unicast_afi_safi_enabled_leaf_missing\x18\xb0\x03 \x01(\tR1bgpDefaultVrfIpv4UnicastAfiSafiEnabledLeafMissingJ\x04\bT\x10UJ\x04\b\t\x10\n" +
