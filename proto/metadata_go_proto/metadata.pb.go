...
type Metadata_Deviations struct {
	...
	UnreferencedAftFibAckUnsupported bool `protobuf:"varint,268,opt,name=unreferenced_aft_fib_ack_unsupported,json=unreferencedAftFibAckUnsupported,proto3" json:"unreferenced_aft_fib_ack_unsupported,omitempty"`
	unknownFields                    protoimpl.UnknownFields
	sizeCache                        protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xfe\x93\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1aҊ\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	" bgp_distance_oc_path_unsupported\x18\x8b\x02 \x01(\bR\x1cbgpDistanceOcPathUnsupported\x12O\n" +
	"$unreferenced_aft_fib_ack_unsupported\x18\x8c\x02 \x01(\bR unreferencedAftFibAckUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
