...
type Metadata_Deviations struct {
	...
	// b/443044887
	ExtendedRouteRetentionOcUnsupported bool `protobuf:"varint,323,opt,name=extended_route_retention_oc_unsupported,json=extendedRouteRetentionOcUnsupported,proto3" json:"extended_route_retention_oc_unsupported,omitempty"`
	// b/439825838
	ExrrStaleRouteTimeUnsupported bool `protobuf:"varint,324,opt,name=exrr_stale_route_time_unsupported,json=exrrStaleRouteTimeUnsupported,proto3" json:"exrr_stale_route_time_unsupported,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xf1\xb1\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x92\xa8\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x15line_port_unsupported\x18\xc2\x02 \x01(\bR\x13linePortUnsupported\x12U\n" +
	"'extended_route_retention_oc_unsupported\x18\xc3\x02 \x01(\bR#extendedRouteRetentionOcUnsupported\x12I\n" +
	"!exrr_stale_route_time_unsupported\x18\xc4\x02 \x01(\bR\x1dexrrStaleRouteTimeUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
