...
type Metadata_Deviations struct {
	...
	AftsGlobalFilterPolicyOcUnsupported bool `protobuf:"varint,437,opt,name=afts_global_filter_policy_oc_unsupported,json=aftsGlobalFilterPolicyOcUnsupported,proto3" json:"afts_global_filter_policy_oc_unsupported,omitempty"`
	unknownFields                       protoimpl.UnknownFields
	sizeCache                           protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xfc\xf5\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xc8\xeb\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"$unreferenced_aft_fib_ack_unsupported\x18\xb4\x03 \x01(\bR unreferencedAftFibAckUnsupported\x12V\n" +
	"(afts_global_filter_policy_oc_unsupported\x18\xb5\x03 \x01(\bR#aftsGlobalFilterPolicyOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
