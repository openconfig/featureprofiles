...
type Metadata_Deviations struct {
	...
	GnoiBackToBackSwitchoverDelayS uint32 `protobuf:"varint,459,opt,name=gnoi_back_to_back_switchover_delay_s,json=gnoiBackToBackSwitchoverDelayS,proto3" json:"gnoi_back_to_back_switchover_delay_s,omitempty"`
	// Device accepts back-to-back switchover request without error, instead of gracefully rejecting it.
	BackToBackSwitchoverRequestAccepted bool `protobuf:"varint,460,opt,name=back_to_back_switchover_request_accepted,json=backToBackSwitchoverRequestAccepted,proto3" json:"back_to_back_switchover_request_accepted,omitempty"`
	// Device does not support gNMI Subscribe during switchover recovery and requires gNMI Get polling instead.
...
func (x *Metadata_Deviations) GetBackToBackSwitchoverRequestAccepted() bool {
	if x != nil {
		return x.BackToBackSwitchoverRequestAccepted
	}
	return false
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xec\x85\x02\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xd4\xfa\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"$gnoi_back_to_back_switchover_delay_s\x18\xcb\x03 \x01(\rR\x1egnoiBackToBackSwitchoverDelayS\x12V\n" +
	"(back_to_back_switchover_request_accepted\x18\xcc\x03 \x01(\bR#backToBackSwitchoverRequestAccepted\x12I\n" +
