...
type Metadata_Deviations struct {
	...
	// Device does not support sampling QoS counters below 30 seconds cadence for sample stream subscriptions
	// Cisco: https://partnerissuetracker.corp.google.com/u/0/issues/508074229
	SamplingQosCountersBelow30SecondsCadenceUnsupported bool `protobuf:"varint,413,opt,name=sampling_qos_counters_below30_seconds_cadence_unsupported,json=samplingQosCountersBelow30SecondsCadenceUnsupported,proto3" json:"sampling_qos_counters_below30_seconds_cadence_unsupported,omitempty"`
	unknownFields                                       protoimpl.UnknownFields
	sizeCache                                           protoimpl.SizeCache
}
...
func (x *Metadata_Deviations) GetSamplingQosCountersBelow30SecondsCadenceUnsupported() bool {
	if x != nil {
		return x.SamplingQosCountersBelow30SecondsCadenceUnsupported
	}
	return false
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xe4\xe5\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xb0\xdb\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\tfabric_ft\x18\x9c\x03 \x01(\tR\bfabricFt\x12w\n" +
	"9sampling_qos_counters_below30_seconds_cadence_unsupported\x18\x9d\x03 \x01(\bR3samplingQosCountersBelow30SecondsCadenceUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
