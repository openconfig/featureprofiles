...
type Metadata_Deviations struct {
	...
	// Arista: b/496260572
	RoutingPolicyAsPathSetEnableRegexMode bool `protobuf:"varint,411,opt,name=routing_policy_as_path_set_enable_regex_mode,json=routingPolicyAsPathSetEnableRegexMode,proto3" json:"routing_policy_as_path_set_enable_regex_mode,omitempty"`
	unknownFields                         protoimpl.UnknownFields
	sizeCache                             protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\x89\xe6\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xd5\xdb\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"+acctz_record_session_channel_id_unsupported\x18\x9a\x03 \x01(\bR&acctzRecordSessionChannelIdUnsupported\x12\\\n" +
	",routing_policy_as_path_set_enable_regex_mode\x18\x9b\x03 \x01(\bR%routingPolicyAsPathSetEnableRegexModeJ\x04\bT\x10UJ\x04\b\t\x10\n" +
