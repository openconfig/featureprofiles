...
type Metadata_Deviations struct {
	...
	DhcpRelayOcUnsupported bool `protobuf:"varint,425,opt,name=dhcp_relay_oc_unsupported,json=dhcpRelayOcUnsupported,proto3" json:"dhcp_relay_oc_unsupported,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xcd\xed\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x99\xe3\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x15ciscoxr_vendordrop_ft\x18\xa8\x03 \x01(\tR\x13ciscoxrVendordropFt\x12:\n" +
	"\x19dhcp_relay_oc_unsupported\x18\xa9\x03 \x01(\bR\x16dhcpRelayOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
