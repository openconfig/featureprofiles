...
type Metadata_Deviations struct {
	...
	QosTwoRateThreeColorPolicerOcUnsupported bool `protobuf:"varint,321,opt,name=qos_two_rate_three_color_policer_oc_unsupported,json=qosTwoRateThreeColorPolicerOcUnsupported,proto3" json:"qos_two_rate_three_color_policer_oc_unsupported,omitempty"`
	unknownFields                            protoimpl.UnknownFields
	sizeCache                                protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xb8\xb0\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a٦\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"skipOrigin\x12:\n" +
	"\x19predefined_max_ecmp_paths\x18\xc0\x02 \x01(\bR\x16predefinedMaxEcmpPaths\x12b\n" +
	"/qos_two_rate_three_color_policer_oc_unsupported\x18\xc1\x02 \x01(\bR(qosTwoRateThreeColorPolicerOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
