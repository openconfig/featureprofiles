...
type Metadata_Deviations struct {
	...
	MplsStaticPseudowireOcUnsupported bool `protobuf:"varint,355,opt,name=mpls_static_pseudowire_oc_unsupported,json=mplsStaticPseudowireOcUnsupported,proto3" json:"mpls_static_pseudowire_oc_unsupported,omitempty"`
	// Devices that do not support vlan client encapsulation OC
	VlanClientEncapsulationOcUnsupported bool `protobuf:"varint,356,opt,name=vlan_client_encapsulation_oc_unsupported,json=vlanClientEncapsulationOcUnsupported,proto3" json:"vlan_client_encapsulation_oc_unsupported,omitempty"`
	unknownFields                        protoimpl.UnknownFields
	sizeCache                            protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xbe\xc4\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1aǺ\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x1fbgp_local_aggregate_unsupported\x18\xe2\x02 \x01(\bR\x1cbgpLocalAggregateUnsupported\x12Q\n" +
	"%mpls_static_pseudowire_oc_unsupported\x18\xe3\x02 \x01(\bR!mplsStaticPseudowireOcUnsupported\x12W\n" +
	"(vlan_client_encapsulation_oc_unsupported\x18\xe4\x02 \x01(\bR$vlanClientEncapsulationOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
