...
type Metadata_Deviations struct {
	...
	// gNOI KillProcess RPC expects a name which differs from the name in /system/processes/process list
	// Arista https://partnerissuetracker.corp.google.com/issues/489304077
	KillProcessDifferentYangName bool `protobuf:"varint,456,opt,name=kill_process_different_yang_name,json=killProcessDifferentYangName,proto3" json:"kill_process_different_yang_name,omitempty"`
	unknownFields                protoimpl.UnknownFields
	sizeCache                    protoimpl.SizeCache
}
...
func (x *Metadata_Deviations) GetKillProcessDifferentYangName() bool {
	if x != nil {
		return x.KillProcessDifferentYangName
	}
	return false
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xea\x82\x02\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xf2\xf7\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"'containerz_require_explicit_config_save\x18\xc7\x03 \x01(\bR#containerzRequireExplicitConfigSave\x12G\n" +
	" kill_process_different_yang_name\x18\xc8\x03 \x01(\bR\x1ckillProcessDifferentYangNameJ\x04\bT\x10UJ\x04\b\t\x10\n" +
