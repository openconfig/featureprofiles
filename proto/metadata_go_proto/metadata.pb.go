...
type Metadata_Deviations struct {
	...
	MissingSflowGnpsiExport bool `protobuf:"varint,432,opt,name=missing_sflow_gnpsi_export,json=missingSflowGnpsiExport,proto3" json:"missing_sflow_gnpsi_export,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xfb\xf1\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xc7\xe7\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x19dhcp_relay_oc_unsupported\x18\xaf\x03 \x01(\bR\x16dhcpRelayOcUnsupported\x12<\n" +
	"\x1amissing_sflow_gnpsi_export\x18\xb0\x03 \x01(\bR\x17missingSflowGnpsiExportJ\x04\bT\x10UJ\x04\b\t\x10\n" +
