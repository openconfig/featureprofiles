...
type Metadata_Deviations struct {
	...
	ExplicitlyApplyAllowAllImportPolicy bool `protobuf:"varint,375,opt,name=explicitly_apply_allow_all_import_policy,json=explicitlyApplyAllowAllImportPolicy,proto3" json:"explicitly_apply_allow_all_import_policy,omitempty"`
	unknownFields                       protoimpl.UnknownFields
	sizeCache                           protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xac\xd0\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x98\xc6\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x1dtransceiver_state_unsupported\x18\xf6\x02 \x01(\bR\x1btransceiverStateUnsupported\x12V\n" +
	"(explicitly_apply_allow_all_import_policy\x18\xf7\x02 \x01(\bR#explicitlyApplyAllowAllImportPolicyJ\x04\bT\x10UJ\x04\b\t\x10\n" +
