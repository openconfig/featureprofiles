...
type Metadata_Deviations struct {
	...
	DhcpRelayOcUnsupported bool `protobuf:"varint,427,opt,name=dhcp_relay_oc_unsupported,json=dhcpRelayOcUnsupported,proto3" json:"dhcp_relay_oc_unsupported,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\x89\xef\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xd5\xe4\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x19dhcp_relay_oc_unsupported\x18\xab\x03 \x01(\bR\x16dhcpRelayOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
