...
type Metadata_Deviations struct {
	...
	// Arista b/434583178
	MatchAsPathSetUnsupported bool `protobuf:"varint,328,opt,name=match_as_path_set_unsupported,json=matchAsPathSetUnsupported,proto3" json:"match_as_path_set_unsupported,omitempty"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xfa\xb3\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x83\xaa\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x1dmatch_as_path_set_unsupported\x18\xc8\x02 \x01(\bR\x19matchAsPathSetUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
