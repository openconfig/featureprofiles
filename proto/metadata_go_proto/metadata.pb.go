...
type Metadata_Deviations struct {
	...
	NextHopEncapHeaderOcUnsupported bool `protobuf:"varint,306,opt,name=next_hop_encap_header_oc_unsupported,json=nextHopEncapHeaderOcUnsupported,proto3" json:"next_hop_encap_header_oc_unsupported,omitempty"`
	unknownFields                   protoimpl.UnknownFields
	sizeCache                       protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xac\xa7\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x80\x9e\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	",policy_forwarding_to_next_hop_oc_unsupported\x18\xb1\x02 \x01(\bR&policyForwardingToNextHopOcUnsupported\x12N\n" +
	"$next_hop_encap_header_oc_unsupported\x18\xb2\x02 \x01(\bR\x1fnextHopEncapHeaderOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
