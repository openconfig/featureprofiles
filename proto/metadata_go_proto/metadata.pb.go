...
type Metadata_Deviations struct {
	...
	MplsStaticPseudowireOcUnsupported bool `protobuf:"varint,333,opt,name=mpls_static_pseudowire_oc_unsupported,json=mplsStaticPseudowireOcUnsupported,proto3" json:"mpls_static_pseudowire_oc_unsupported,omitempty"`
	// Devices that do not support vlan client encapsulation OC
	VlanClientEncapsulationOcUnsupported bool `protobuf:"varint,334,opt,name=vlan_client_encapsulation_oc_unsupported,json=vlanClientEncapsulationOcUnsupported,proto3" json:"vlan_client_encapsulation_oc_unsupported,omitempty"`
	unknownFields                        protoimpl.UnknownFields
	sizeCache                            protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"̷\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1aխ\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"+telemetry_not_supported_for_low_priority_nh\x18\xcc\x02 \x01(\bR%telemetryNotSupportedForLowPriorityNh\x12Q\n" +
	"%mpls_static_pseudowire_oc_unsupported\x18\xcd\x02 \x01(\bR!mplsStaticPseudowireOcUnsupported\x12W\n" +
	"(vlan_client_encapsulation_oc_unsupported\x18\xce\x02 \x01(\bR$vlanClientEncapsulationOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
