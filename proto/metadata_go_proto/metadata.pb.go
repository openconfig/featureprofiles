...
type Metadata_Deviations struct {
	...
	PolicyForwardingToNextHopUnsupported bool `protobuf:"varint,291,opt,name=policy_forwarding_to_next_hop_unsupported,json=policyForwardingToNextHopUnsupported,proto3" json:"policy_forwarding_to_next_hop_unsupported,omitempty"`
	// Devices that do not support policy forwarding encapsulate gre action
	PolicyForwardingGreEncapsulationUnsupported bool `protobuf:"varint,292,opt,name=policy_forwarding_gre_encapsulation_unsupported,json=policyForwardingGreEncapsulationUnsupported,proto3" json:"policy_forwarding_gre_encapsulation_unsupported,omitempty"`
	// Devices that do not support qos classifier dscp remark action
	QosClassifierDscpRemarkUnsupported bool `protobuf:"varint,293,opt,name=qos_classifier_dscp_remark_unsupported,json=qosClassifierDscpRemarkUnsupported,proto3" json:"qos_classifier_dscp_remark_unsupported,omitempty"`
	unknownFields                      protoimpl.UnknownFields
	sizeCache                          protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\x93\xa0\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xe7\x96\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x1duse_old_oc_path_static_lsp_nh\x18\xa2\x02 \x01(\bR\x17useOldOcPathStaticLspNh\x12X\n" +
	")policy_forwarding_to_next_hop_unsupported\x18\xa3\x02 \x01(\bR$policyForwardingToNextHopUnsupported\x12e\n" +
	"/policy_forwarding_gre_encapsulation_unsupported\x18\xa4\x02 \x01(\bR+policyForwardingGreEncapsulationUnsupported\x12S\n" +
	"&qos_classifier_dscp_remark_unsupported\x18\xa5\x02 \x01(\bR\"qosClassifierDscpRemarkUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
