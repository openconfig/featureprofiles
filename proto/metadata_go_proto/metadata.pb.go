...
type Metadata_Deviations struct {
	...
	BgpGrHelperDisableUnsupported bool `protobuf:"varint,335,opt,name=bgp_gr_helper_disable_unsupported,json=bgpGrHelperDisableUnsupported,proto3" json:"bgp_gr_helper_disable_unsupported,omitempty"`
	// Device does not support bgp GR-RESTART under AFI/SAFI.
	BgpGracefulRestartUnderAfiSafiUnsupported bool `protobuf:"varint,336,opt,name=bgp_graceful_restart_under_afi_safi_unsupported,json=bgpGracefulRestartUnderAfiSafiUnsupported,proto3" json:"bgp_graceful_restart_under_afi_safi_unsupported,omitempty"`
	unknownFields                             protoimpl.UnknownFields
	sizeCache                                 protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"ȸ\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1aѮ\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x15syslog_oc_unsupported\x18\xce\x02 \x01(\bR\x13syslogOcUnsupported\x12I\n" +
	"!bgp_gr_helper_disable_unsupported\x18\xcf\x02 \x01(\bR\x1dbgpGrHelperDisableUnsupported\x12c\n" +
	"/bgp_graceful_restart_under_afi_safi_unsupported\x18\xd0\x02 \x01(\bR)bgpGracefulRestartUnderAfiSafiUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
