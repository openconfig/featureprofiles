...
type Metadata_Deviations struct {
	...
	SyslogNonDefaultVrfUnsupported bool `protobuf:"varint,349,opt,name=syslog_non_default_vrf_unsupported,json=syslogNonDefaultVrfUnsupported,proto3" json:"syslog_non_default_vrf_unsupported,omitempty"`
	unknownFields                  protoimpl.UnknownFields
	sizeCache                      protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\x9d\xc0\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xa6\xb6\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x14gnpsi_oc_unsupported\x18\xdc\x02 \x01(\bR\x12gnpsiOcUnsupported\x12K\n" +
	"\"syslog_non_default_vrf_unsupported\x18\xdd\x02 \x01(\bR\x1esyslogNonDefaultVrfUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
