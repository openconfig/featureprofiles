...
type Metadata_Deviations struct {
	...
	DefaultPolicyRequiresBgpMatch bool `protobuf:"varint,348,opt,name=default_policy_requires_bgp_match,json=defaultPolicyRequiresBgpMatch,proto3" json:"default_policy_requires_bgp_match,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xe8\xbf\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xf1\xb5\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"1static_route_next_network_instance_oc_unsupported\x18\xdb\x02 \x01(\bR+staticRouteNextNetworkInstanceOcUnsupported\x12I\n" +
	"!default_policy_requires_bgp_match\x18\xdc\x02 \x01(\bR\x1ddefaultPolicyRequiresBgpMatchJ\x04\bT\x10UJ\x04\b\t\x10\n" +
