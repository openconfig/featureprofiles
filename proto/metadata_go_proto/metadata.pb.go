...
type Metadata_Deviations struct {
	...
	BgpRibStreamingConfigRequired bool `protobuf:"varint,352,opt,name=bgp_rib_streaming_config_required,json=bgpRibStreamingConfigRequired,proto3" json:"bgp_rib_streaming_config_required,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\x98\xc2\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xa1\xb8\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\"syslog_non_default_vrf_unsupported\x18\xdf\x02 \x01(\bR\x1esyslogNonDefaultVrfUnsupported\x12I\n" +
	"!bgp_rib_streaming_config_required\x18\xe0\x02 \x01(\bR\x1dbgpRibStreamingConfigRequiredJ\x04\bT\x10UJ\x04\b\t\x10\n" +
